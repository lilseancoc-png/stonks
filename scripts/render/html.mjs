...
function buildTimelineSection() {
  return `<section class="card refresh-schedule" id="refresh-schedule-section">
    ...
    <div class="refresh-schedule-grid">
      ...
      <article class="refresh-schedule-card"><span>09:30, hourly 10:00&ndash;14:00, 15:30 &amp; 16:00 ET</span><h3>Full market build</h3><p>Refreshes ticker chains and daily/intraday bars, grades, technicals, narratives, calendars, earnings, Market Analysis, most Owner desks, Quant Lab and the in-session Brief.</p><em>Publishes only after decision-grade freshness checks pass</em></article>
      <article class="refresh-schedule-card"><span>11:00 &amp; 15:30 ET</span><h3>Top Picks</h3><p>Runs the final decision roster, web research, contract selection, churn, roster and track-record mark. Other full builds carry the last coherent Top Picks snapshot unchanged.</p><em>Twice per market day &middot; cost-controlled</em></article>
