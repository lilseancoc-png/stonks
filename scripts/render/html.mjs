  ...
  return `<section class="card" id="picks-section">
    ...
    <details class="picks-howto">
      ...
      <div class="picks-howto-body">
        <p><b>Fundamentals (9 signals).</b> Earnings surprise (beat/miss &gt;25% &plusmn;2, 1-24% &plusmn;1), EPS growth YoY +1 / -2, revenue growth YoY +1 / -2, analyst price target &plusmn;1, P/E vs sector median &plusmn;1, guidance (raised +3, in line +2, soft cut -2, lowered -3), major contract +2 / -3, free cash flow TTM &plusmn;1 (positive / negative), net margin growth &plusmn;1 (expanding / contracting QoQ).</p>
