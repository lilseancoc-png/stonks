...
function oiTrackerSection() {
  ...
  return `<section class="card oi-card" id="oi-section">
    ...
    <div id="oi-body" class="oi-body">
      ${infoNote('How the OI ladder & squeeze score work', `<p>Start with the <strong>positioning desk</strong>: it identifies the strongest current squeeze candidate, distinguishes a 4–5/5 setup from a watch-only concentration, and states the price/flow evidence that must confirm or invalidate it. The ladder shows the top 12 highest-OI strikes across this week's and next week's expirations. The <strong>Gamma Squeeze Score</strong> (0–5) awards heavy calls within 10% of spot · C/P ratio ≥ 2:1 · call-wall Vol/OI ≥ 1.5× · an overhead call wall within 7.5% · material ask-side call flow aligned to that wall's strike and expiration. A score of <strong>4–5</strong> is a potential setup, not an entry. Strikes with <strong>OI &gt; 1000</strong> get a chip; ΔOI chips fire at <strong>+30%</strong> and <strong>+100%</strong>. OI is lagged: price must still break and hold the wall with live share volume, and a pre-market or prior-session snapshot must not be mistaken for live order flow. Twice-daily scan: pre-market and EOD.</p>`)}
