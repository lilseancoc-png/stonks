...
function trackRecordSection() {
  ...
  return `<section class="card" id="accuracy-section">
    ...
    <p class="hint">Modeled Black-Scholes marks at constant entry IV from the enrollment snapshot — not live chain fills. Start with the sample size and results below; use the other views to inspect the ledger, cohorts and simulations.</p>
