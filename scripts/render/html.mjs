  ...
  return `<section class="card" id="picks-section">
    ...
    <details class="picks-howto">
      ...
      <div class="picks-howto-body">
        <p><b>Fundamentals (10 signals).</b> Earnings surprise (beat/miss &gt;25% &plusmn;2, 1-24% &plusmn;1), EPS growth YoY +1 / -2, revenue growth YoY +1 / -2, analyst price target &plusmn;1, analyst rating changes &plusmn;2 (net of recent upgrades vs downgrades over ~90 days &mdash; &ge;3 net upgrades +2, 1-2 +1, symmetric for downgrades), P/E vs sector median &plusmn;1, guidance (raised +3, in line +2, lowered -3), major contract / deal +2 / -3 (incl. a bank&rsquo;s lead-underwriter or advisory mandate on a marquee IPO/M&amp;A, e.g. leading the SpaceX IPO), free cash flow TTM &plusmn;1 (positive / negative), net margin growth &plusmn;1 (expanding / contracting).</p>
        <p><b>Technicals (13 signals).</b> RSI 14 movement &plusmn;1 (above 50 &amp; rising +1 / below 50 &amp; falling -1), RSI 14 reading &plusmn;3 (contrarian &mdash; 75+ overbought -3 / 25 or below oversold +3, otherwise 0), MACD &plusmn;1, current streak &plusmn;1, broke 20d support/resistance &plusmn;1, broke 50d S/R &plusmn;1, broke 100d S/R &plusmn;2, 52-week proximity (high -1 / low +1, contrarian read), volume confirmation &plusmn;1 (relative volume &ge;1.3x the 20d average = +1, low volume &lt;0.8x = -1), the moving-average stack &mdash; price above/below the 20d SMA &plusmn;1, 50d SMA &plusmn;1, 100d SMA &plusmn;2 &mdash; and an AI-identified chart pattern &mdash; a <b>confirmed</b> bullish formation +1 / bearish -1, while a still-<b>forming</b> (early-warning) pattern is surfaced with its neckline and what would confirm/invalidate it but scores 0 until price actually breaks &mdash; one of 7 classic formations (Cup and Handle, Head and Shoulders, Inverse Head and Shoulders, Bull Flag, Ascending Triangle, Descending Triangle, Double Bottom) read off the <b>1-month intraday (30-minute) chart</b> &mdash; the timeframe where short-horizon reversals actually show up.</p>
        ...
        <p><b>Narrative (8 signals).</b> Positive catalyst +3 / 0, sector tailwind/headwind &plusmn;2 (faded by the narrative&rsquo;s lifecycle stage &mdash; peak halves it, challenges/collapse flip it toward a fade &mdash; and discounted when the story is hype-driven), social sentiment &plusmn;1, media coverage surge &plusmn;1, negative catalyst 0 / -3, macro tail/headwinds +1 / -2 (tariffs, regulation, war, Fed, trade policy), DXY 1-day move (&ge;0.9%: strong dollar -2 / weak dollar +1), 10-year yield 1-day move (&ge;13 bps: rising -2 / falling +1).</p>
