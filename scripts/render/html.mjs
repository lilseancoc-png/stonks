  ...
  return `<section class="card" id="picks-section">
    ...
    <details class="picks-howto">
      ...
      <div class="picks-howto-body">
        ...
        <p><b>Suggested contract.</b> A near-the-money option &mdash; delta 0.45-0.65 (target ~0.55), which carries far less theta and IV-crush fragility than a cheap far-OTM lottery ticket &mdash; with IV &lt;200%, &ge;21 days to expiry (roster picks &ge;30), standard monthly expirations, a tight spread, real open interest, and premium capped at the greater of $35/share or 12% of spot. The &ldquo;In plain English&rdquo; panel translates the bet into beginner terms.</p>
...
function volumeFlagsSection() {
  ...
  return `<section class="card vol-card" id="vol-section">
    ...
    <p class="hint">Looking for the live pace leaderboard? It moved to the <strong>Hot stocks</strong> tab — the top names trading the heaviest <em>right now</em>, with dealer gamma and a buy-calls / buy-puts / wait verdict per name.</p>
