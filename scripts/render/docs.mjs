...
// privacy.html, terms.html). They are now mounted into a Shadow
...
export const DOC_ORDER = ["cheatsheet","chart-patterns","privacy","terms"];
  ...
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  <main>
    ...
    <section id="ai-content">
      ...
      <p>Scores, grades, rankings, picks, narratives, summaries, scenario risk scores, probabilities, modeled prices, backtests, and track records are machine outputs, estimates, or simulations&mdash;not statements of fact, guarantees, personalized recommendations, fiduciary advice, or a substitute for original source material. Backtested, hypothetical, and modeled results have inherent limitations and may not reflect trading costs, liquidity, slippage, taxes, execution, or future market conditions.</p>
