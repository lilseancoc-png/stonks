...
export const DOC_PAGES = {
  ...
  <main>
    ...
    <section id="good">
      ...
      <ul class="plain">
        ...
        <li><strong>AI and automation.</strong> All analytical and editorial content is generated by AI or automated systems from third-party source data. It can be wrong, stale, incomplete, or misleading and may not receive human review before publication. Verify it independently.</li>
        <li><strong>Sources.</strong> Quotes and chains come from Yahoo Finance; macro from the Fed, BLS, Treasury, and SEC; sentiment from CNN's Fear &amp; Greed index. Source data remains subject to provider delays, errors, and revisions.</li>
  ...
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  <header>
    ...
    <div class="dates">
      ...
      <span>Last Updated: <b>August 2, 2026</b></span>
    </div>
  ...
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  <header>
    <div class="kicker">ming street &middot; legal</div>
    <h1>stonks Terms of Use <em>&amp; Conditions</em></h1>
    <div class="dates">
      <span>Effective Date: <b>June 14, 2026</b></span>
      <span>Last Updated: <b>August 2, 2026</b></span>
    </div>
    <p class="intro">These Terms of Use and Conditions govern your access to and use of the stonks service operated by Ming Street. Please read them carefully &mdash; by using the Site or Service you agree to be bound by them.</p>
  </header>
  ...
  <main>
    <section id="disclaimers">
      ...
      <p>The information, tools, features, custom formulas, analysis, data visualizations, and other content available on <a href="https://mingstreet.app">mingstreet.app</a> (collectively, the &ldquo;Site,&rdquo; the &ldquo;Service,&rdquo; or &ldquo;Content&rdquo;) are provided for informational and educational purposes only. They should not be construed as investment, financial, tax, legal, or trading advice.</p>
      ...
      <p>The Service is operated by Ming Street (&ldquo;the Company,&rdquo; &ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;our&rdquo;). We are not registered investment advisers, broker-dealers, or financial professionals. Nothing on the Site constitutes a solicitation or recommendation to buy, sell, or hold any security.</p>
      <div class="callout">
    ...
    <section id="ai-content">
      <h2><span class="snum">02</span>AI and Automated Content</h2>
      <div class="callout">
        <p><strong>All analytical and editorial Content on the Service is generated, assembled, scored, ranked, summarized, or otherwise produced by artificial-intelligence models and/or automated algorithms.</strong> Raw quotes, option chains, filings, economic releases, news, and other source material may originate with independent third parties; our selection, transformation, presentation, and analysis of that material is automated.</p>
      </div>
      <p>Unless the Service expressly states otherwise, you should assume that Content has not been reviewed, approved, or verified by a human before publication. AI and automated systems can hallucinate, omit material facts, misunderstand or misattribute sources, use stale or incomplete inputs, make calculation or classification errors, and produce outputs that are biased, inconsistent, or unsuitable for your circumstances.</p>
      <p>Scores, grades, rankings, picks, narratives, summaries, scenarios, probabilities, modeled prices, backtests, and track records are machine outputs, estimates, or simulations&mdash;not statements of fact, guarantees, personalized recommendations, fiduciary advice, or a substitute for original source material. Backtested, hypothetical, and modeled results have inherent limitations and may not reflect trading costs, liquidity, slippage, taxes, execution, or future market conditions.</p>
      <p>You are solely responsible for independently checking all Content against current primary sources and for obtaining advice from appropriately licensed professionals. Do not use the Service as the sole or primary basis for an investment, trading, tax, legal, medical, employment, credit, or other consequential decision. Your use of or reliance on AI and automated Content is at your own risk, subject to rights and remedies that cannot lawfully be excluded.</p>
    </section>
    ...
    <section id="ip">
      <h2><span class="snum">06</span>Intellectual Property and Ownership</h2>
      <p>As between you and the Company, the Service&rsquo;s software, custom formulas, selection and arrangement, branding, design, graphics, and data visualizations are owned by the Company or its licensors and are protected to the extent provided by copyright, trademark, trade-secret, contract, and other applicable laws. Third-party data and materials remain the property of their respective owners. No ownership is claimed in purely AI-generated material to the extent it is not protectable under applicable law.</p>
    ...
    <section id="conduct">
      <h2><span class="snum">07</span>User Conduct</h2>
    ...
    <section id="ugc">
      <h2><span class="snum">08</span>User-Submitted Content</h2>
    ...
    <section id="thirdparty">
      <h2><span class="snum">09</span>Third-Party Links and Data</h2>
    ...
    <section id="changes">
      <h2><span class="snum">10</span>Changes to These Terms</h2>
    ...
    <section id="law">
      <h2><span class="snum">11</span>Governing Law and Disputes</h2>
    ...
    <section id="indemnification">
      <h2><span class="snum">12</span>Indemnification</h2>
    ...
    <section id="entire">
      <h2><span class="snum">13</span>Entire Agreement</h2>
    ...
    <section id="severability">
      <h2><span class="snum">14</span>Severability</h2>
    ...
    <section id="waiver">
      <h2><span class="snum">15</span>No Waiver</h2>
    ...
    <section id="assignment">
      <h2><span class="snum">16</span>Assignment</h2>
    ...
    <section id="contact">
      <h2><span class="snum">17</span>Contact Us</h2>
