...
.rp-desk-badge { flex: 0 0 auto; padding: 5px 9px; border: 1px solid var(--border-strong); border-radius: var(--r-pill); background: var(--surface); color: var(--warn); font: 750 10px/1 var(--font-mono); letter-spacing: .06em; text-transform: uppercase; }
.rp-desk-up .rp-desk-badge { color: var(--neg); }
.rp-desk-down .rp-desk-badge { color: var(--pos); }
.rp-signal-grid { display: grid; grid-template-columns: repeat(3, minmax(0, 1fr)); gap: 8px; }
...
.rp-equity-lens > div { display: flex; align-items: center; gap: 8px; min-width: 0; padding: 8px 10px; border: 1px solid var(--hairline); border-radius: var(--r-2); background: var(--surface); }
.rp-equity-lens > div > span { flex: 1 1 auto; color: var(--muted); font: 650 10px/1.2 var(--font-sans); }
.rp-equity-lens b { display: flex; flex-wrap: wrap; justify-content: flex-end; gap: 4px; }
