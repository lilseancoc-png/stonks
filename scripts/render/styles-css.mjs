...
.news-feed-summary > div {
  display: flex; align-items: baseline; gap: 7px;
  min-width: 0; padding: 9px 12px;
  background: var(--surface-2);
}
.news-feed-summary b { font: 700 1rem/1 var(--font-mono); color: var(--text-strong); font-variant-numeric: tabular-nums; }
.news-feed-summary span { font: 700 0.62rem/1.2 var(--font-mono); color: var(--muted); text-transform: uppercase; letter-spacing: .06em; }
.news-feed-summary p {
  grid-column: 1 / -1;
  margin: 0; padding: 6px 12px;
  background: var(--surface);
  font: 600 0.66rem/1.2 var(--font-mono); color: var(--muted);
}
.news-feed-toolbar {
  display: grid;
...
@media (max-width: 480px) {
  ...
  .news-feed-summary p { grid-column: auto; }
