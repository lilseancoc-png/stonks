...
:root[data-theme="light"] {
  /* Light theme — a cool slate-gray trading canvas. It avoids the glare of
...
/* === Sidebar navigation ===
   Every destination lives in a collapsible left sidebar, grouped by trader
   task inside native disclosure sections. Desk + Ideas start open. Desktop
...
.side-nav-group[hidden] { display: none; }
.side-nav-group + .side-nav-group {
  margin-top: 6px;
}
/* Collapsible group label — the chevron makes the hierarchy explicit while
   the ledger rule preserves the printed-index character of the rail. */
...
.side-nav-group-label::-webkit-details-marker { display: none; }
.side-nav-group-label:hover { color: var(--text); background: color-mix(in srgb, var(--text-strong) 4%, transparent); }
.side-nav-group-label:focus-visible { outline: none; box-shadow: var(--focus-ring); }
.side-nav-group-label::before {
  content: "›";
  flex: 0 0 auto;
  color: var(--muted);
  font-size: 14px;
...
.side-nav-group[open] > .side-nav-group-label { color: var(--muted-strong); }
.side-nav-group[open] > .side-nav-group-label::before { transform: rotate(90deg); color: var(--accent); }
...
.landing-hero-main {
  display: grid;
  grid-template-columns: minmax(250px, .82fr) minmax(460px, 1.18fr);
  align-items: end;
...
.landing-quick-card {
  ...
  font: inherit;
  cursor: pointer;
  transition: border-color .15s var(--ease-out), background .15s var(--ease-out), transform .2s var(--ease-out);
}
.landing-quick-card:hover { border-color: color-mix(in srgb, var(--accent) 45%, var(--border)); background: var(--surface-2); transform: translateY(-1px); }
.landing-quick-card:focus-visible { outline: none; border-color: var(--accent); box-shadow: var(--elev-focus); }
.landing-quick-card > span { grid-column: 1; color: var(--accent); font: 700 8.5px/1.1 var(--font-sans); letter-spacing: .08em; text-transform: uppercase; }
.landing-quick-card > b { grid-column: 1; color: var(--text-strong); font: 700 12.5px/1.2 var(--font-sans); }
.landing-quick-card > small { grid-column: 1; color: var(--muted); font: 400 9.5px/1.3 var(--font-sans); }
.landing-quick-card > em { position: absolute; top: 50%; right: 12px; color: var(--muted); font: 500 15px/1 var(--font-sans); font-style: normal; transform: translateY(-50%); transition: color .15s var(--ease-out), transform .2s var(--ease-out); }
.landing-quick-card:hover > em { color: var(--accent); transform: translate(3px, -50%); }
...
@media (max-width: 640px) {
  .landing-hero-main { grid-template-columns: minmax(0, 1fr); align-items: stretch; gap: var(--s-4); }
  .landing-grid { grid-template-columns: repeat(2, minmax(0, 1fr)); gap: var(--s-3); }
...
.narr-posture b { display: block; color: var(--text-strong); font-size: 13px; line-height: 1.35; }
.narr-posture p { margin: 3px 0 0; color: var(--text); font-size: 12.5px; line-height: 1.45; }
.narr-posture small { display: block; margin-top: 5px; color: var(--muted); font-size: 11.5px; line-height: 1.4; }
.narr-posture small strong { color: var(--text); }
.narr-posture-ready { border-left-color: var(--pos); background: color-mix(in srgb, var(--pos-soft) 52%, var(--surface-2)); }
.narr-posture-watch { border-left-color: var(--accent); }
.narr-posture-caution,
.narr-posture-late { border-left-color: var(--warn); background: color-mix(in srgb, var(--warn-soft) 42%, var(--surface-2)); }
.narr-posture-pass { border-left-color: var(--neg); background: color-mix(in srgb, var(--neg-soft) 48%, var(--surface-2)); }
.narr-research,
.narr-sector-detail {
  margin-top: var(--s-2);
  border: 1px solid var(--border);
...
.narr-research > summary,
.narr-sector-detail > summary {
  display: flex;
  align-items: center;
  justify-content: space-between;
  gap: var(--s-3);
...
.narr-research > summary::-webkit-details-marker,
.narr-sector-detail > summary::-webkit-details-marker { display: none; }
.narr-research > summary > span,
.narr-sector-detail > summary > span { display: flex; min-width: 0; flex-direction: column; gap: 2px; }
.narr-research > summary b,
.narr-sector-detail > summary b { color: var(--text-strong); font-size: 12px; line-height: 1.3; }
.narr-research > summary small,
.narr-sector-detail > summary small { color: var(--muted); font-size: 10.5px; line-height: 1.35; }
.narr-research > summary em,
.narr-sector-detail > summary em {
  flex: 0 0 auto;
  color: var(--accent-strong);
  font-size: 0;
  font-style: normal;
...
.narr-research > summary em::after,
.narr-sector-detail > summary em::after { content: 'Open'; font-size: 11px; }
.narr-research[open] > summary em::after,
.narr-sector-detail[open] > summary em::after { content: 'Close'; }
.narr-research[open] > summary,
.narr-sector-detail[open] > summary { background: var(--surface-2); }
.narr-research-body,
.narr-sector-detail-body { padding: 10px; border-top: 1px solid var(--border); }
...
.narr-analytics .narr-lifecycle { margin-top: 0; }
.narr-hype-badge {
  display: inline-flex;
  align-items: center;
  min-height: 24px;
...
.narr-hype-badge.is-fundamentals { color: var(--pos); border-color: color-mix(in srgb, var(--pos) 35%, transparent); background: var(--pos-soft); }
.narr-hype-badge.is-balanced { color: var(--accent-strong); border-color: color-mix(in srgb, var(--accent) 35%, transparent); background: var(--accent-soft); }
.narr-hype-badge.is-hype { color: var(--neg); border-color: color-mix(in srgb, var(--neg) 35%, transparent); background: var(--neg-soft); }
.narr-side-row {
...
.opt-workflow-step > small {
  min-width: 0;
  color: var(--muted);
  font: 400 10.5px/1.25 var(--font-sans);
}
.opt-direction {
  display: flex;
  align-items: center;
...
.opt-direction-copy { display: flex; flex-direction: column; gap: 2px; min-width: 0; }
.opt-direction-copy > span { color: var(--text-strong); font: 700 11px/1.2 var(--font-sans); text-transform: uppercase; letter-spacing: .06em; }
.opt-direction-copy > small { color: var(--muted); font: 400 10.5px/1.3 var(--font-sans); }
.opt-direction .segmented { flex: 0 0 auto; }
@media (max-width: 560px) {
  .opt-workflow { gap: 6px; }
  .opt-workflow-step {
    grid-template-columns: 20px minmax(0, 1fr);
    padding: 8px 6px;
    gap: 4px;
  }
  .opt-workflow-step > span { width: 20px; height: 20px; font-size: 10px; }
  .opt-workflow-step > b { font-size: 10.5px; }
  .opt-workflow-step > small { display: none; }
  .opt-direction { align-items: stretch; }
  .opt-direction-copy > small { max-width: 23ch; }
}
...
.cmp-series-0 { --cmp-series: #e3ad36; }
.cmp-series-1 { --cmp-series: #57b9d9; }
.cmp-series-2 { --cmp-series: #a78bfa; }
.cmp-series-3 { --cmp-series: #f07f67; }
.cmp-chip-swatch {
  flex: 0 0 auto; width: 8px; height: 8px; border-radius: 999px;
  background: var(--cmp-series);
  box-shadow: 0 0 0 2px color-mix(in srgb, var(--cmp-series) 16%, transparent);
}
.cmp-legend-swatch {
  flex: 0 0 auto; width: 22px; height: 3px; border-radius: 999px;
  background: var(--cmp-series);
}
.cmp-legend-item.cmp-series-1 .cmp-legend-swatch { background: repeating-linear-gradient(90deg, var(--cmp-series) 0 8px, transparent 8px 11px); }
.cmp-legend-item.cmp-series-2 .cmp-legend-swatch { background: repeating-linear-gradient(90deg, var(--cmp-series) 0 2px, transparent 2px 5px); }
.cmp-legend-item.cmp-series-3 .cmp-legend-swatch { background: repeating-linear-gradient(90deg, var(--cmp-series) 0 9px, transparent 9px 12px, var(--cmp-series) 12px 14px, transparent 14px 17px); }
.cmp-chart-card {
...
.cmp-chart-head { display: flex; align-items: flex-start; justify-content: space-between; gap: 14px; margin-bottom: 10px; }
.cmp-chart-eyebrow { font: 700 9.5px/1 var(--font-mono); text-transform: uppercase; letter-spacing: .08em; color: var(--accent); margin-bottom: 4px; }
.cmp-chart-title { margin: 0; font: 700 16px/1.2 var(--font-sans); color: var(--text-strong); }
.cmp-chart-sub { margin: 4px 0 0; font: 400 11.5px/1.4 var(--font-sans); color: var(--muted); }
.cmp-range {
...
.cmp-range-btn {
  appearance: none; border: 0; border-radius: var(--r-pill); background: transparent;
  color: var(--muted); min-width: 42px; padding: 6px 9px;
  font: 700 11px/1 var(--font-mono); cursor: pointer;
}
.cmp-range-btn:hover { color: var(--text-strong); }
.cmp-range-btn.is-active { color: var(--text-strong); background: var(--surface-3); box-shadow: var(--shadow-sm); }
.cmp-range-btn:focus-visible { box-shadow: var(--focus-ring); }
.cmp-chart-legend {
  display: grid; grid-template-columns: repeat(4, minmax(0, 1fr));
  gap: 6px; margin-bottom: 8px;
}
.cmp-legend-item {
  display: grid; grid-template-columns: auto auto 1fr; align-items: center; gap: 6px;
  min-width: 0; padding: 7px 8px; border: 1px solid var(--border);
  border-radius: var(--r-1); background: var(--surface);
}
.cmp-legend-sym { font: 750 12px/1 var(--font-sans); color: var(--text-strong); }
.cmp-legend-last { min-width: 0; text-align: right; }
.cmp-legend-return { display: block; font: 750 12px/1.1 var(--font-mono); font-variant-numeric: tabular-nums; }
.cmp-legend-price { display: block; margin-top: 2px; font: 500 9.5px/1 var(--font-mono); color: var(--muted); font-variant-numeric: tabular-nums; }
.cmp-ret-pos { color: var(--pos); }
.cmp-ret-neg { color: var(--neg); }
.cmp-ret-flat { color: var(--muted); }
.cmp-chart-stage {
  display: grid; grid-template-columns: 48px minmax(0, 1fr);
  grid-template-rows: clamp(250px, 34vw, 340px) 22px;
  column-gap: 7px; row-gap: 2px;
}
.cmp-y-axis { position: relative; grid-column: 1; grid-row: 1; }
.cmp-y-label {
  position: absolute; right: 0; transform: translateY(-50%);
  font: 600 9.5px/1 var(--font-mono); color: var(--muted);
  font-variant-numeric: tabular-nums; white-space: nowrap;
}
.cmp-y-label.is-zero { color: var(--text-strong); }
.cmp-y-label:first-child { transform: none; }
.cmp-y-label:last-child { transform: translateY(-100%); }
.cmp-plot {
  position: relative; grid-column: 2; grid-row: 1; min-width: 0;
  border-left: 1px solid var(--border); border-bottom: 1px solid var(--border);
  outline: none; touch-action: pan-y;
}
.cmp-plot:focus-visible { box-shadow: var(--focus-ring); }
.cmp-chart-svg { display: block; width: 100%; height: 100%; overflow: visible; }
.cmp-chart-grid { stroke: var(--hairline); stroke-width: 1; vector-effect: non-scaling-stroke; }
.cmp-chart-zero { stroke: color-mix(in srgb, var(--text-strong) 36%, transparent); stroke-width: 1.2; vector-effect: non-scaling-stroke; }
.cmp-chart-line {
  fill: none; stroke: var(--cmp-series); stroke-width: 2.25;
  vector-effect: non-scaling-stroke; stroke-linejoin: round; stroke-linecap: round;
}
.cmp-chart-line.cmp-series-1 { stroke-dasharray: 9 3; }
.cmp-chart-line.cmp-series-2 { stroke-dasharray: 2 3; }
.cmp-chart-line.cmp-series-3 { stroke-dasharray: 11 3 2 3; }
.cmp-x-axis {
  grid-column: 2; grid-row: 2; display: flex; align-items: flex-end;
  justify-content: space-between; min-width: 0;
  font: 600 9.5px/1 var(--font-mono); color: var(--muted);
}
.cmp-chart-cross {
  position: absolute; inset-block: 0; width: 1px; display: none;
  background: color-mix(in srgb, var(--text-strong) 48%, transparent);
  pointer-events: none; transform: translateX(-.5px);
}
.cmp-chart-dot {
  position: absolute; width: 9px; height: 9px; display: none;
  border: 2px solid var(--surface); border-radius: 999px;
  background: var(--cmp-series); pointer-events: none;
  transform: translate(-50%, -50%); box-shadow: 0 0 0 1px var(--cmp-series);
}
.cmp-chart-tip {
  position: absolute; z-index: 3; display: none; min-width: 150px;
  padding: 8px 9px; border: 1px solid var(--border-strong); border-radius: var(--r-1);
  background: color-mix(in srgb, var(--surface) 94%, transparent);
  box-shadow: var(--shadow-md); pointer-events: none;
}
.cmp-chart-tip-floating { z-index: 970; }
.cmp-tip-date { margin-bottom: 6px; font: 700 10px/1 var(--font-mono); color: var(--muted); }
.cmp-tip-row { display: grid; grid-template-columns: auto 1fr auto; align-items: center; gap: 6px; margin-top: 4px; }
.cmp-tip-sym { font: 700 11px/1 var(--font-sans); color: var(--text-strong); }
.cmp-tip-val { text-align: right; font: 700 11px/1 var(--font-mono); font-variant-numeric: tabular-nums; }
.cmp-tip-price { color: var(--muted); font: 500 9.5px/1 var(--font-mono); }
.cmp-chart-read {
  margin-top: 8px; min-height: 18px; padding-top: 8px; border-top: 1px solid var(--border);
  font: 500 11.5px/1.45 var(--font-sans); color: var(--muted);
}
.cmp-chart-read b { color: var(--text-strong); }
.cmp-chart-empty { display: grid; place-items: center; min-height: 190px; text-align: center; color: var(--muted); font: 500 12px/1.5 var(--font-sans); }
@media (max-width: 640px) {
  .cmp-controls .combo { flex-basis: 100%; min-width: 0; }
  .cmp-btn { min-height: 40px; }
  .cmp-chip-name { max-width: 105px; }
  .cmp-chart-card { padding: 11px; }
  .cmp-chart-head { flex-direction: column; align-items: stretch; gap: 9px; }
  .cmp-range { width: 100%; }
  .cmp-range-btn { flex: 1 1 0; min-height: 38px; }
  .cmp-chart-legend { grid-template-columns: repeat(2, minmax(0, 1fr)); }
  .cmp-chart-stage { grid-template-columns: 40px minmax(0, 1fr); grid-template-rows: 235px 20px; column-gap: 5px; }
  .cmp-y-label, .cmp-x-axis { font-size: 9px; }
  .cmp-chart-line { stroke-width: 2.4; }
  .cmp-chart-tip { position: fixed; left: 8px !important; right: 8px; top: auto !important; bottom: 64px; width: auto; }
}
.cmp-summary {
...
.ers-posture-watch { border-left-color: var(--warn); }
.ers-posture-risk { border-left-color: var(--neg); }
.ers-posture-constructive { border-left-color: var(--pos); }
.ers-posture-head { display: flex; align-items: center; justify-content: space-between; gap: 10px; }
.ers-posture-kicker,
.ers-posture-state {
  color: var(--muted); font: 700 9px/1 var(--font-mono);
  text-transform: uppercase; letter-spacing: .08em;
}
.ers-posture-state { padding: 4px 7px; border-radius: var(--r-pill); background: var(--surface-3); }
.ers-posture-watch .ers-posture-state { color: var(--warn); background: color-mix(in srgb, var(--warn) 12%, transparent); }
.ers-posture-risk .ers-posture-state { color: var(--neg); background: color-mix(in srgb, var(--neg) 12%, transparent); }
.ers-posture-constructive .ers-posture-state { color: var(--pos); background: color-mix(in srgb, var(--pos) 12%, transparent); }
.ers-posture h3 { margin: 8px 0 5px; color: var(--text-strong); font: 750 1.08rem/1.25 var(--font-sans); }
.ers-posture > p { max-width: 900px; margin: 0; color: var(--text); font: 400 12.5px/1.5 var(--font-sans); }
.ers-posture-metrics {
  display: grid; grid-template-columns: repeat(4, minmax(0, 1fr));
  gap: 1px; margin-top: 13px; overflow: hidden;
  border: 1px solid var(--border); border-radius: var(--r-2); background: var(--border);
}
.ers-posture-metrics > div { min-width: 0; padding: 10px 11px; background: var(--surface); }
.ers-posture-metrics b { display: block; color: var(--text-strong); font: 700 1rem/1 var(--font-mono); font-variant-numeric: tabular-nums; }
.ers-posture-metrics span,
.ers-posture-metrics small { display: block; margin-top: 5px; color: var(--muted); font: 700 8.5px/1.2 var(--font-mono); text-transform: uppercase; letter-spacing: .055em; }
.ers-posture-metrics small { margin-top: 3px; font-weight: 500; text-transform: none; letter-spacing: 0; }
.ers-posture-triggers { display: grid; grid-template-columns: 1fr 1fr; gap: 8px; margin-top: 9px; }
.ers-posture-triggers > div { padding: 9px 10px; border: 1px solid var(--border); border-radius: var(--r-1); background: color-mix(in srgb, var(--surface-2) 78%, transparent); }
.ers-posture-triggers span { display: block; margin-bottom: 4px; color: var(--muted); font: 700 8.5px/1 var(--font-mono); text-transform: uppercase; letter-spacing: .07em; }
.ers-posture-triggers b { color: var(--text); font: 600 11px/1.4 var(--font-sans); }
.ers-posture-action {
  display: flex; align-items: flex-end; justify-content: space-between; gap: 12px;
  margin-top: 10px; padding-top: 11px; border-top: 1px solid var(--border);
}
.ers-posture-action > div:first-child { max-width: 650px; }
.ers-posture-action span { display: block; margin-bottom: 4px; color: var(--accent); font: 700 8.5px/1 var(--font-mono); text-transform: uppercase; letter-spacing: .07em; }
.ers-posture-action b { color: var(--text-strong); font: 600 11.5px/1.45 var(--font-sans); }
.ers-posture-buttons { display: flex; flex-wrap: wrap; justify-content: flex-end; gap: 6px; flex: 0 0 auto; }
.ers-action-primary, .ers-action-secondary {
  min-height: 34px; padding: 7px 10px; border-radius: var(--r-2);
  cursor: pointer; font: 650 10.5px/1 var(--font-sans);
}
.ers-action-primary { border: 1px solid var(--accent); background: var(--accent); color: var(--accent-fg); }
.ers-action-secondary { border: 1px solid var(--border); background: var(--surface); color: var(--text); }
.ers-action-primary:hover { filter: brightness(1.08); }
.ers-action-secondary:hover { border-color: color-mix(in srgb, var(--accent) 40%, var(--border)); background: var(--surface-2); }
.ers-action-primary:focus-visible, .ers-action-secondary:focus-visible { outline: none; box-shadow: var(--focus-ring); }
...
.ers-ai-toggle::-webkit-details-marker { display: none; }
.ers-ai-toggle::after {
  content: '›';
  color: var(--accent);
...
.ers-ai[open] > .ers-ai-toggle::after { transform: rotate(90deg); }
.ers-ai-toggle .ers-ai-headline { flex: 1 1 300px; margin: 0; }
.ers-ai-toggle .ers-ai-date { margin-left: 0; }
.ers-ai-body { padding: 12px 16px 14px; border-top: 1px solid var(--border); }
.ers-ai-fallback { padding: 14px 16px; }
...
.ers-upcoming-head h3 { margin: 0; color: var(--text-strong); font: 700 1rem/1.15 var(--font-sans); }
.ers-up-showing { color: var(--muted); font: 600 10px/1.2 var(--font-mono); white-space: nowrap; }
.ers-up-controls {
  display: flex;
  flex-wrap: wrap;
  align-items: center;
...
.ers-up-window-group { display: inline-flex; gap: 4px; }
.ers-up-window,
.ers-up-sort-chip {
  display: inline-flex;
  align-items: center;
...
.ers-up-window span { color: var(--muted); font: 700 9px/1 var(--font-mono); }
.ers-up-window:hover,
.ers-up-window:focus-visible,
.ers-up-sort-chip:hover,
.ers-up-sort-chip:focus-visible { border-color: var(--muted); color: var(--text-strong); }
.ers-up-window[aria-pressed="true"],
...
/* Upcoming-reporters strip: the full-span header stops auto-fit from collapsing
   ...
   The value track is fixed too: each row is its own grid, so max-content would
   resize per row and shift the chip / plan anchors when percentages differ. */
.ers-up-ldrs { grid-template-columns: 1fr; margin-bottom: 0; }
.ers-up-ldrs.ers-up-two { grid-template-columns: 1fr 1fr; }
.ers-up-row {
  display: grid;
  grid-template-columns: 52px minmax(0, 1fr) 94px 76px;
  grid-template-areas:
    "sym name chip value"
    "date date plan plan";
  align-items: center; gap: 5px 8px; padding: 7px 0;
}
.ers-up-row > .ers-sym { grid-area: sym; }
.ers-up-row > .ers-ldr-name { grid-area: name; }
.ers-up-row > :nth-child(3) { grid-area: chip; justify-self: start; }
.ers-up-date { font: 400 11px/1 var(--font-sans); white-space: nowrap; }
.ers-up-row > .ers-up-date { grid-area: date; }
.ers-up-row > .ers-ldr-val { grid-area: value; width: 100%; justify-self: stretch; }
.ers-up-plan {
  grid-area: plan; display: inline-flex; align-items: baseline; justify-content: flex-end;
  gap: 6px; min-width: 0; padding: 4px 7px; border-radius: var(--r-1);
  background: color-mix(in srgb, var(--muted) 7%, transparent);
}
.ers-up-plan b { color: var(--text); font: 700 9.5px/1.2 var(--font-sans); white-space: nowrap; }
.ers-up-plan small { color: var(--muted); font: 600 9px/1.2 var(--font-mono); white-space: nowrap; }
.ers-up-plan-risk { background: color-mix(in srgb, var(--neg) 9%, transparent); }
.ers-up-plan-risk b { color: var(--neg); }
.ers-up-plan-warn { background: color-mix(in srgb, var(--warn) 9%, transparent); }
.ers-up-plan-warn b { color: var(--warn); }
.ers-up-more {
  width: 100%; min-height: 38px; margin-top: 10px;
  border: 1px solid var(--border); border-radius: var(--r-2);
  background: var(--surface); color: var(--text);
  cursor: pointer; font: 700 10.5px/1 var(--font-mono);
}
.ers-up-more:hover, .ers-up-more:focus-visible { border-color: var(--accent); outline: none; }
@media (max-width: 700px) {
  .ers-up-ldrs.ers-up-two { grid-template-columns: 1fr; }
  .ers-posture { padding: 13px 12px; }
  .ers-posture-metrics { grid-template-columns: 1fr 1fr; }
  .ers-posture-triggers { grid-template-columns: 1fr; }
  .ers-posture-action { align-items: stretch; flex-direction: column; }
  .ers-posture-buttons { display: grid; grid-template-columns: minmax(0, 1fr); width: 100%; }
  .ers-action-primary, .ers-action-secondary { width: 100%; min-height: 40px; }
  .ers-ai-toggle .ers-ai-headline { order: 3; flex-basis: calc(100% - 28px); }
  .ers-ai-toggle .ers-ai-date { margin-left: auto; }
  .ers-upcoming { padding: 12px; }
  .ers-upcoming-head { align-items: flex-start; }
  .ers-up-controls { align-items: stretch; }
  .ers-up-window-group { width: 100%; }
  .ers-up-window { flex: 1 1 0; justify-content: center; }
  .ers-up-sort { width: 100%; flex-wrap: nowrap; overflow-x: auto; padding-bottom: 2px; }
  .ers-up-row {
  ...
  .ers-up-row > .ers-sym { grid-area: sym; }
  .ers-up-row > .ers-ldr-name { grid-area: name; }
  .ers-up-row > :nth-child(3) { grid-area: chip; justify-self: end; }
  .ers-up-row > .ers-up-date { grid-area: date; white-space: normal; }
  .ers-up-row > .ers-ldr-val { grid-area: value; }
  .ers-up-plan { justify-content: space-between; width: 100%; margin-top: 2px; }
  .ers-table-details > summary small { font-size: 8px; }
}
.ers-sym {
...
.ers-table-details > summary::-webkit-details-marker { display: none; }
.ers-table-details > summary::before {
  content: '›'; color: var(--accent); font: 700 1rem/1 var(--font-mono);
  transition: transform .15s ease;
}
.ers-table-details[open] > summary::before { transform: rotate(90deg); }
.ers-table-details > summary:hover { background: var(--surface-2); }
.ers-table-details > summary small {
  margin-left: auto; color: var(--muted);
  font: 600 9px/1 var(--font-mono); text-transform: uppercase; letter-spacing: .06em;
}
...
/* Earnings-call decision queue + progressive research detail. */
.ecl-queue {
  display: grid; grid-template-columns: minmax(0, 1.35fr) minmax(420px, 1fr); gap: 18px;
  padding: 16px; margin: 2px 0 14px; border: 1px solid color-mix(in srgb, var(--accent) 32%, var(--border));
  border-top: 3px solid var(--accent); border-radius: var(--r-3);
  background: linear-gradient(135deg, color-mix(in srgb, var(--accent) 7%, var(--surface)), var(--surface) 62%);
}
.ecl-queue-head > span, .ecl-decision-head > span {
...
.ecl-queue-head h3, .ecl-decision-head h3 { margin: 0; font: 700 18px/1.2 var(--font-sans); color: var(--text-strong); }
.ecl-queue-head p, .ecl-decision-head p { margin: 6px 0 0; max-width: 70ch; font: 400 12.5px/1.5 var(--font-sans); color: var(--muted); }
.ecl-queue-grid { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 8px; }
.ecl-queue-grid > span, .ecl-decision-grid > span {
...
.ecl-queue-grid small, .ecl-decision-grid small { font: 700 9px/1.2 var(--font-sans); letter-spacing: .06em; text-transform: uppercase; color: var(--muted); }
.ecl-queue-grid b, .ecl-decision-grid b { font: 700 14px/1.25 var(--font-mono); color: var(--text-strong); overflow-wrap: anywhere; }
.ecl-filters { display: flex; flex-wrap: wrap; gap: 6px; margin: -2px 0 12px; }
.ecl-filter, .ecl-more {
  border: 1px solid var(--border); border-radius: 999px; background: var(--surface); color: var(--muted);
  padding: 6px 10px; font: 650 11px/1 var(--font-sans); cursor: pointer;
}
.ecl-filter:hover, .ecl-more:hover { color: var(--text-strong); border-color: color-mix(in srgb, var(--accent) 52%, var(--border)); }
.ecl-filter.is-on { color: var(--accent); border-color: color-mix(in srgb, var(--accent) 62%, var(--border)); background: color-mix(in srgb, var(--accent) 10%, var(--surface)); }
.ecl-card { position: relative; overflow: hidden; }
.ecl-card::before { content: ''; position: absolute; inset: 0 auto 0 0; width: 3px; background: var(--border); }
.ecl-card-positive::before { background: var(--pos); }
.ecl-card-caution::before { background: var(--neg); }
.ecl-card-watch::before { background: var(--warn); }
.ecl-card-action {
  width: fit-content; padding: 3px 7px; border-radius: 999px; font: 750 10px/1 var(--font-sans); letter-spacing: .03em; text-transform: uppercase;
}
.ecl-card-action-positive { color: var(--pos); background: color-mix(in srgb, var(--pos) 13%, transparent); }
.ecl-card-action-caution { color: var(--neg); background: color-mix(in srgb, var(--neg) 13%, transparent); }
.ecl-card-action-watch { color: var(--warn); background: color-mix(in srgb, var(--warn) 13%, transparent); }
.ecl-card-why { margin: 0; font: 400 11.5px/1.42 var(--font-sans); color: var(--muted); }
.ecl-more { display: block; margin: 14px auto 0; padding: 8px 14px; }
.ecl-decision {
  margin: 12px 0 14px; padding: 16px; border: 1px solid var(--border); border-top: 3px solid var(--warn);
  border-radius: var(--r-3); background: linear-gradient(145deg, color-mix(in srgb, var(--warn) 6%, var(--surface)), var(--surface) 58%);
}
.ecl-decision-positive { border-top-color: var(--pos); background: linear-gradient(145deg, color-mix(in srgb, var(--pos) 6%, var(--surface)), var(--surface) 58%); }
.ecl-decision-caution { border-top-color: var(--neg); background: linear-gradient(145deg, color-mix(in srgb, var(--neg) 6%, var(--surface)), var(--surface) 58%); }
.ecl-decision-grid { display: grid; grid-template-columns: repeat(4, minmax(0, 1fr)); gap: 8px; margin-top: 12px; }
.ecl-decision-columns { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 10px; margin-top: 10px; }
.ecl-decision-columns > div { min-width: 0; padding: 11px 12px; border: 1px solid color-mix(in srgb, var(--border) 76%, transparent); border-radius: var(--r-2); background: color-mix(in srgb, var(--surface-2) 72%, transparent); }
.ecl-decision-columns h4 { margin: 0 0 7px; font: 700 10px/1 var(--font-sans); letter-spacing: .06em; text-transform: uppercase; color: var(--text-strong); }
.ecl-decision-columns .ecl-bullets { gap: 4px; }
.ecl-decision-columns .ecl-bullets li { font-size: 12px; line-height: 1.42; }
.ecl-decision-plan {
  display: grid; grid-template-columns: repeat(3, minmax(0, 1fr)); gap: 8px; margin-top: 10px;
}
.ecl-decision-plan > div {
  min-width: 0; padding: 11px 12px; border: 1px solid color-mix(in srgb, var(--border) 76%, transparent);
  border-radius: var(--r-2); background: color-mix(in srgb, var(--surface) 76%, transparent);
}
.ecl-decision-plan .ecl-plan-posture {
  grid-column: 1 / -1; display: grid; grid-template-columns: minmax(120px, .45fr) minmax(0, 1fr); align-items: center; gap: 4px 14px;
  border-color: color-mix(in srgb, var(--accent) 34%, var(--border)); background: color-mix(in srgb, var(--accent) 7%, var(--surface));
}
.ecl-decision-plan span { display: block; margin-bottom: 6px; font: 700 9px/1.2 var(--font-sans); letter-spacing: .07em; text-transform: uppercase; color: var(--muted); }
.ecl-decision-plan b { display: block; font: 700 12.5px/1.4 var(--font-sans); color: var(--text-strong); }
.ecl-decision-plan .ecl-plan-posture span { margin: 0; color: var(--accent); }
.ecl-decision-plan .ecl-plan-posture b { font-size: 14px; }
.ecl-decision-plan .ecl-plan-posture p { grid-column: 2; margin: 1px 0 0; font: 400 11px/1.4 var(--font-sans); color: var(--muted); }
.ecl-decision-actions { display: flex; flex-wrap: wrap; gap: 7px; margin-top: 10px; }
.ecl-decision-actions .ecl-action-primary, .ecl-decision-actions .ecl-action-secondary {
  display: inline-flex; align-items: center; justify-content: center; min-height: 36px; box-sizing: border-box; padding: 7px 11px;
  border: 1px solid var(--border); border-radius: 8px; font: 700 11px/1.15 var(--font-sans); text-decoration: none; cursor: pointer;
}
.ecl-decision-actions .ecl-action-primary { border-color: var(--accent); background: var(--accent); color: var(--surface); }
.ecl-decision-actions .ecl-action-secondary { background: var(--surface); color: var(--text); }
.ecl-decision-actions .ecl-action-primary:hover, .ecl-decision-actions .ecl-action-primary:focus-visible { filter: brightness(1.06); }
.ecl-decision-actions .ecl-action-secondary:hover, .ecl-decision-actions .ecl-action-secondary:focus-visible { border-color: var(--accent); color: var(--accent); background: var(--accent-soft); }
.ecl-decision-note { margin: 10px 0 0; padding-top: 9px; border-top: 1px solid color-mix(in srgb, var(--border) 70%, transparent); font: 400 11.5px/1.45 var(--font-sans); color: var(--muted); }
.ecl-research-stack { display: flex; flex-direction: column; gap: 8px; }
.ecl-disclosure { border: 1px solid var(--border); border-radius: var(--r-2); background: var(--surface); overflow: clip; }
.ecl-disclosure summary { display: flex; align-items: center; justify-content: space-between; gap: 14px; padding: 11px 13px; cursor: pointer; list-style: none; }
.ecl-disclosure summary::-webkit-details-marker { display: none; }
.ecl-disclosure summary > span { display: flex; flex-direction: column; gap: 3px; min-width: 0; }
.ecl-disclosure summary b { font: 700 12.5px/1.2 var(--font-sans); color: var(--text-strong); }
.ecl-disclosure summary small { font: 400 11px/1.35 var(--font-sans); color: var(--muted); }
.ecl-disclosure summary em { flex: 0 0 auto; font: 650 10px/1 var(--font-sans); color: var(--muted); font-style: normal; text-transform: uppercase; letter-spacing: .05em; }
.ecl-disclosure[open] summary { border-bottom: 1px solid var(--border); background: color-mix(in srgb, var(--accent) 4%, var(--surface)); }
.ecl-disclosure[open] summary em { color: var(--accent); }
.ecl-disclosure-body { padding: 2px 14px 14px; }

@media (max-width: 720px) {
  .ecl-queue { grid-template-columns: 1fr; min-width: 0; gap: 12px; padding: 13px; }
  .ecl-queue-grid, .ecl-decision-grid { grid-template-columns: repeat(2, minmax(0, 1fr)); }
  .ecl-toolbar { align-items: stretch; flex-direction: column; }
  .ecl-search { flex-basis: auto; width: 100%; box-sizing: border-box; }
  .ecl-filters { flex-wrap: nowrap; overflow-x: auto; padding-bottom: 4px; scrollbar-width: thin; }
  .ecl-filter { flex: 0 0 auto; }
  .ecl-cards { grid-template-columns: 1fr; }
  .ecl-card-top { flex-wrap: wrap; }
  .ecl-card-date { width: 100%; }
  .ecl-decision { padding: 13px; }
  .ecl-decision-columns { grid-template-columns: 1fr; }
  .ecl-decision-plan { grid-template-columns: 1fr; }
  .ecl-decision-plan .ecl-plan-posture { grid-column: auto; grid-template-columns: 1fr; }
  .ecl-decision-plan .ecl-plan-posture p { grid-column: auto; }
  .ecl-decision-actions { display: grid; grid-template-columns: 1fr; }
  .ecl-decision-actions .ecl-action-primary, .ecl-decision-actions .ecl-action-secondary { min-height: 42px; width: 100%; }
  .ecl-disclosure summary { align-items: flex-start; }
  .ecl-disclosure summary em { margin-top: 2px; }
  .ecl-row { align-items: flex-start; }
  .ecl-row-label, .ecl-row-val, .ecl-row-ctx { flex-basis: 100%; }
...
.cx-desk {
  ...
  border-radius: var(--r-3); background: linear-gradient(135deg, color-mix(in srgb, var(--accent) 6%, var(--surface)), var(--surface) 64%);
}
.cx-desk-hot { border-top-color: var(--warn); }
.cx-desk-cool { border-top-color: var(--muted); }
.cx-desk-reference {
  border-color: var(--border); border-top-color: var(--muted);
  background: linear-gradient(135deg, color-mix(in srgb, var(--muted) 5%, var(--surface)), var(--surface) 64%);
}
.cx-desk-head { display: flex; align-items: flex-start; justify-content: space-between; gap: 14px; }
.cx-desk-head > div { min-width: 0; }
.cx-desk-kicker { color: var(--accent); font: 700 10px/1 var(--font-mono); letter-spacing: .09em; text-transform: uppercase; }
.cx-desk-head h3 { margin: 4px 0 3px; color: var(--text-strong); font: 750 18px/1.2 var(--font-sans); }
.cx-desk-head p { margin: 0; max-width: 760px; color: var(--muted); font: 500 12px/1.45 var(--font-sans); }
.cx-desk-badge { flex: 0 0 auto; padding: 5px 9px; border: 1px solid color-mix(in srgb, var(--accent) 45%, var(--border)); border-radius: var(--r-pill); background: var(--surface); color: var(--accent); font: 750 10px/1 var(--font-mono); letter-spacing: .06em; text-transform: uppercase; }
.cx-desk-hot .cx-desk-badge { color: var(--warn); border-color: color-mix(in srgb, var(--warn) 45%, var(--border)); }
.cx-desk-reference .cx-desk-badge { color: var(--muted-strong); border-color: var(--border-strong); }
.cx-desk-source {
  display: flex; align-items: center; gap: 8px 12px; padding: 7px 9px;
  border: 1px solid var(--hairline); border-radius: var(--r-2); background: color-mix(in srgb, var(--surface-2) 84%, transparent);
}
.cx-desk-source > span { flex: 0 0 auto; color: var(--text-strong); font: 750 9.5px/1 var(--font-mono); letter-spacing: .06em; text-transform: uppercase; }
.cx-desk-source > p { margin: 0; color: var(--muted); font: 500 10.5px/1.35 var(--font-sans); }
.cx-guide {
  display: grid; grid-template-columns: minmax(0, 1fr) minmax(0, 1fr); gap: 8px;
  padding: 10px; border: 1px solid color-mix(in srgb, var(--accent) 32%, var(--border));
  border-radius: var(--r-2); background: color-mix(in srgb, var(--accent) 7%, var(--surface));
}
.cx-guide > div { min-width: 0; display: flex; flex-direction: column; gap: 3px; }
.cx-guide span { color: var(--muted); font: 750 9px/1 var(--font-mono); letter-spacing: .07em; text-transform: uppercase; }
.cx-guide b { color: var(--text-strong); font: 750 19px/1.15 var(--font-mono); }
.cx-guide small { color: var(--muted-strong); font: 500 10.5px/1.35 var(--font-sans); }
.cx-guide p { grid-column: 1 / -1; margin: 1px 0 0; color: var(--muted); font: 500 10px/1.35 var(--font-sans); }
.cx-guide a, .cx-guide-link { color: var(--accent); text-decoration: underline; text-underline-offset: 2px; }
.cx-desk-grid { display: grid; grid-template-columns: repeat(4, minmax(0, 1fr)); gap: 8px; }
.cx-desk-stat { min-width: 0; display: flex; flex-direction: column; gap: 3px; padding: 10px; border: 1px solid var(--border); border-radius: var(--r-2); background: var(--surface-2); }
.cx-desk-stat > span { color: var(--muted); font: 700 9px/1 var(--font-mono); letter-spacing: .07em; text-transform: uppercase; }
.cx-desk-stat > b { overflow: hidden; text-overflow: ellipsis; white-space: nowrap; color: var(--text-strong); font: 750 18px/1.15 var(--font-mono); }
.cx-desk-stat > small { color: var(--muted-strong); font: 500 10.5px/1.3 var(--font-sans); }
.cx-posture {
  display: grid;
  grid-template-columns: 104px minmax(0, 1fr);
  gap: var(--s-3);
...
.cx-posture b { display: block; color: var(--text-strong); font-size: 13.5px; line-height: 1.35; }
.cx-posture p { margin: 3px 0 0; color: var(--text); font-size: 12.5px; line-height: 1.45; }
.cx-posture small { display: block; margin-top: 5px; color: var(--muted); font-size: 11.5px; line-height: 1.4; }
.cx-posture-watch { border-left-color: var(--accent); }
.cx-posture-caution { border-left-color: var(--warn); background: color-mix(in srgb, var(--warn-soft) 46%, var(--surface-2)); }
.cx-posture-pass { border-left-color: var(--neg); background: color-mix(in srgb, var(--neg-soft) 42%, var(--surface-2)); }
.cx-rules { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 8px; }
.cx-rule { min-width: 0; padding: 9px 10px; border: 1px solid var(--hairline); border-radius: var(--r-2); background: var(--surface); }
.cx-rule > span { display: block; margin-bottom: 4px; font: 750 9.5px/1 var(--font-mono); letter-spacing: .07em; text-transform: uppercase; }
.cx-rule > p { margin: 0; color: var(--text); font: 500 11.5px/1.4 var(--font-sans); }
.cx-rule-confirm { border-left: 3px solid var(--pos); }
.cx-rule-confirm > span { color: var(--pos); }
.cx-rule-invalidate { border-left: 3px solid var(--neg); }
.cx-rule-invalidate > span { color: var(--neg); }
.cx-desk-lens { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 8px; }
.cx-desk-lens > div { min-width: 0; display: flex; align-items: center; gap: 10px; padding: 9px 10px; border: 1px solid var(--hairline); border-radius: var(--r-2); background: var(--surface); }
.cx-lens-copy { min-width: 0; flex: 1 1 auto; }
.cx-lens-copy > b { display: block; color: var(--text-strong); font: 700 11.5px/1.25 var(--font-sans); }
.cx-lens-copy > small { display: block; margin-top: 3px; color: var(--muted); font: 500 10.5px/1.3 var(--font-sans); }
.cx-lens-links { flex: 0 0 auto; display: flex; flex-wrap: wrap; justify-content: flex-end; gap: 4px; max-width: 46%; }
.cx-desk-lens a { padding: 3px 7px; border: 1px solid var(--border-strong); border-radius: var(--r-pill); color: var(--text-strong); font: 750 10px/1 var(--font-mono); }
.cx-desk-lens a span { color: var(--muted); font-weight: 650; }
.cx-desk-lens a:hover, .cx-desk-lens a:focus-visible, a.cx-tkr:hover, a.cx-tkr:focus-visible { border-color: var(--accent); color: var(--accent); }
.cx-actions { display: flex; flex-wrap: wrap; gap: 7px; }
.cx-action {
  min-height: 36px; padding: 8px 12px; border: 1px solid var(--border-strong); border-radius: var(--r-pill);
  background: var(--surface); color: var(--text-strong); font: 700 11px/1 var(--font-sans); cursor: pointer;
}
.cx-action:hover, .cx-action:focus-visible { border-color: var(--accent); color: var(--accent); }
.cx-action-primary { border-color: var(--accent); background: var(--accent); color: var(--surface); }
.cx-action-primary:hover, .cx-action-primary:focus-visible { border-color: var(--accent); background: color-mix(in srgb, var(--accent) 86%, var(--text-strong)); color: var(--surface); }
.cx-desk-note { margin: 0; color: var(--muted); font: 500 10.5px/1.4 var(--font-sans); }
.cx-empty-desk {
  display: flex; flex-direction: column; align-items: flex-start; gap: 7px; margin: 10px 0 12px; padding: 16px;
  border: 1px dashed var(--border-strong); border-radius: var(--r-3); background: var(--surface-2);
}
.cx-empty-desk h3 { margin: 0; color: var(--text-strong); font: 750 17px/1.25 var(--font-sans); }
.cx-empty-desk p { margin: 0 0 3px; max-width: 760px; color: var(--muted); font: 500 12px/1.45 var(--font-sans); }
.cx-research { border: 1px solid var(--border); border-radius: var(--r-2); overflow: clip; background: var(--surface-2); }
.cx-research[open] { border-color: color-mix(in srgb, var(--accent) 30%, var(--border)); }
.cx-research > summary { min-height: 62px; display: flex; align-items: center; gap: 10px; padding: 10px 12px; list-style: none; cursor: pointer; }
.cx-research > summary::-webkit-details-marker { display: none; }
.cx-research > summary::before { content: "›"; flex: 0 0 auto; color: var(--accent); font: 750 19px/1 var(--font-mono); transition: transform var(--dur-1); }
.cx-research[open] > summary::before { transform: rotate(90deg); }
.cx-research > summary > span:first-of-type { min-width: 0; display: flex; flex-direction: column; gap: 3px; }
.cx-research > summary > span:first-of-type small { color: var(--muted); font: 700 9px/1 var(--font-mono); letter-spacing: .07em; text-transform: uppercase; }
.cx-research > summary > span:first-of-type b { color: var(--text-strong); font: 750 13px/1.2 var(--font-sans); }
.cx-research-signal { min-width: 0; margin-left: auto; display: flex; flex-direction: column; align-items: flex-end; gap: 3px; text-align: right; }
.cx-research-signal b { color: var(--text-strong); font: 700 11px/1.2 var(--font-mono); }
.cx-research-signal small { color: var(--muted); font: 500 10px/1.2 var(--font-sans); }
.cx-research-body { padding: 12px; border-top: 1px solid var(--hairline); background: var(--surface); }
.cx-hero {
...
a.cx-tkr { border-bottom: 1px solid transparent; }
...
@media (max-width: 820px) {
  .cx-desk-grid { grid-template-columns: repeat(2, minmax(0, 1fr)); }
}
@media (max-width: 640px) {
  .cx-desk { padding: 11px; }
  .cx-desk-head { gap: 8px; }
  .cx-desk-head h3 { font-size: 16px; }
  .cx-desk-badge { padding: 4px 7px; font-size: 9px; }
  .cx-desk-source { align-items: flex-start; flex-direction: column; gap: 4px; }
  .cx-guide { grid-template-columns: minmax(0, 1fr); }
  .cx-guide p { grid-column: 1; }
  .cx-desk-grid { display: flex; overflow-x: auto; scroll-snap-type: x proximity; scrollbar-width: none; padding-bottom: 3px; }
  .cx-desk-grid::-webkit-scrollbar { display: none; }
  .cx-desk-stat { flex: 0 0 min(182px, 61vw); scroll-snap-align: start; }
  .cx-posture { grid-template-columns: 1fr; gap: 5px; padding: 9px 10px; }
  .cx-posture-label { padding-top: 0; }
  .cx-rules { grid-template-columns: minmax(0, 1fr); }
  .cx-desk-lens { grid-template-columns: minmax(0, 1fr); }
  .cx-desk-lens > div { align-items: flex-start; flex-direction: column; }
  .cx-lens-links { max-width: none; justify-content: flex-start; }
  .cx-actions { display: grid; grid-template-columns: minmax(0, 1fr); }
  .cx-action { min-height: 42px; width: 100%; }
  .cx-research > summary { align-items: flex-start; gap: 7px; }
  .cx-research-signal { max-width: 48%; }
  .cx-hero { padding: 11px; }
...
.rp-desk-up { border-top-color: var(--neg); }
.rp-desk-down { border-top-color: var(--pos); }
.rp-desk-reference {
  border-color: var(--border); border-top-color: var(--muted);
  background: linear-gradient(135deg, color-mix(in srgb, var(--muted) 5%, var(--surface)), var(--surface) 64%);
}
.rp-desk-head { display: flex; align-items: flex-start; justify-content: space-between; gap: 14px; }
.rp-desk-head > div { min-width: 0; }
.rp-desk-kicker { color: var(--accent); font: 700 10px/1 var(--font-mono); letter-spacing: .09em; text-transform: uppercase; }
.rp-desk-head h3 { margin: 4px 0 3px; color: var(--text-strong); font: 750 18px/1.2 var(--font-sans); }
.rp-desk-head p { margin: 0; max-width: 760px; color: var(--muted); font: 500 12px/1.45 var(--font-sans); }
.rp-desk-badge { flex: 0 0 auto; padding: 5px 9px; border: 1px solid var(--border-strong); border-radius: var(--r-pill); background: var(--surface); color: var(--warn); font: 750 10px/1 var(--font-mono); letter-spacing: .06em; text-transform: uppercase; white-space: nowrap; }
.rp-desk-up .rp-desk-badge { color: var(--neg); }
.rp-desk-down .rp-desk-badge { color: var(--pos); }
.rp-desk-reference .rp-desk-badge { color: var(--muted-strong); }
.rp-desk-source {
  display: flex; align-items: center; gap: 8px 12px; padding: 7px 9px;
  border: 1px solid var(--hairline); border-radius: var(--r-2); background: color-mix(in srgb, var(--surface-2) 84%, transparent);
}
.rp-desk-source > span { flex: 0 0 auto; color: var(--text-strong); font: 750 9.5px/1 var(--font-mono); letter-spacing: .06em; text-transform: uppercase; }
.rp-desk-source > p { margin: 0; color: var(--muted); font: 500 10.5px/1.35 var(--font-sans); }
.rp-signal-grid { display: grid; grid-template-columns: repeat(4, minmax(0, 1fr)); gap: 8px; }
.rp-signal { min-width: 0; display: flex; flex-direction: column; gap: 3px; padding: 10px; border: 1px solid var(--border); border-radius: var(--r-2); background: var(--surface-2); }
.rp-signal > span { color: var(--muted); font: 700 9px/1 var(--font-mono); letter-spacing: .07em; text-transform: uppercase; }
.rp-signal > b { overflow: hidden; text-overflow: ellipsis; white-space: nowrap; color: var(--text-strong); font: 750 18px/1.15 var(--font-mono); }
.rp-signal > small { color: var(--muted-strong); font: 500 10.5px/1.3 var(--font-sans); }
.rp-posture {
  display: grid; grid-template-columns: 104px minmax(0, 1fr); gap: 10px; padding: 10px 11px;
  border: 1px solid var(--hairline); border-left: 3px solid var(--accent); border-radius: var(--r-2); background: var(--surface);
}
.rp-posture-label { padding-top: 2px; color: var(--accent); font: 750 9px/1.2 var(--font-mono); letter-spacing: .08em; text-transform: uppercase; }
.rp-posture b { display: block; color: var(--text-strong); font: 750 12px/1.25 var(--font-sans); }
.rp-posture p { margin: 3px 0 0; color: var(--muted-strong); font: 500 11px/1.4 var(--font-sans); }
.rp-posture small { display: block; margin-top: 4px; color: var(--muted); font: 500 10px/1.35 var(--font-sans); }
.rp-posture-ready { border-left-color: var(--pos); background: color-mix(in srgb, var(--pos) 4%, var(--surface)); }
.rp-posture-ready .rp-posture-label { color: var(--pos); }
.rp-posture-caution { border-left-color: var(--warn); background: color-mix(in srgb, var(--warn) 4%, var(--surface)); }
.rp-posture-caution .rp-posture-label { color: var(--warn); }
.rp-rules { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 8px; }
.rp-rule { min-width: 0; padding: 9px 10px; border: 1px solid var(--hairline); border-radius: var(--r-2); background: var(--surface); }
.rp-rule > span { display: block; margin-bottom: 4px; font: 750 9.5px/1 var(--font-mono); letter-spacing: .07em; text-transform: uppercase; }
.rp-rule > p { margin: 0; color: var(--text); font: 500 11.5px/1.4 var(--font-sans); }
.rp-rule-confirm { border-left: 3px solid var(--pos); }
.rp-rule-confirm > span { color: var(--pos); }
.rp-rule-invalidate { border-left: 3px solid var(--neg); }
.rp-rule-invalidate > span { color: var(--neg); }
.rp-equity-lens { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 8px; }
.rp-equity-lens > div { display: flex; align-items: center; gap: 10px; min-width: 0; padding: 9px 10px; border: 1px solid var(--hairline); border-radius: var(--r-2); background: var(--surface); }
.rp-lens-copy { min-width: 0; flex: 1 1 auto; }
.rp-lens-copy > b { display: block; color: var(--text-strong); font: 700 11.5px/1.25 var(--font-sans); }
.rp-lens-copy > small { display: block; margin-top: 3px; color: var(--muted); font: 500 10.5px/1.3 var(--font-sans); }
.rp-lens-links { flex: 0 0 auto; display: flex; flex-wrap: wrap; justify-content: flex-end; gap: 4px; max-width: 46%; }
.rp-equity-link { padding: 3px 7px; border: 1px solid var(--border-strong); border-radius: var(--r-pill); color: var(--text-strong); font: 750 10px/1 var(--font-mono); }
.rp-equity-link:hover, .rp-equity-link:focus-visible { border-color: var(--accent); color: var(--accent); }
.rp-actions { display: flex; flex-wrap: wrap; gap: 7px; }
.rp-action {
  min-height: 36px; padding: 8px 12px; border: 1px solid var(--border-strong); border-radius: var(--r-pill);
  background: var(--surface); color: var(--text-strong); font: 700 11px/1 var(--font-sans); cursor: pointer;
}
.rp-action:hover, .rp-action:focus-visible { border-color: var(--accent); color: var(--accent); }
.rp-action-primary { border-color: var(--accent); background: var(--accent); color: var(--surface); }
.rp-action-primary:hover, .rp-action-primary:focus-visible { border-color: var(--accent); background: color-mix(in srgb, var(--accent) 86%, var(--text-strong)); color: var(--surface); }
.rp-desk-note { margin: 0; color: var(--muted); font: 500 10.5px/1.4 var(--font-sans); }
.rp-empty-desk {
  display: flex; flex-direction: column; align-items: flex-start; gap: 7px; margin: 10px 0 12px; padding: 16px;
  border: 1px dashed var(--border-strong); border-radius: var(--r-3); background: var(--surface-2);
}
.rp-empty-desk h3 { margin: 0; color: var(--text-strong); font: 750 17px/1.25 var(--font-sans); }
.rp-empty-desk p { margin: 0 0 3px; max-width: 760px; color: var(--muted); font: 500 12px/1.45 var(--font-sans); }
.rp-section { margin-bottom: 8px; border: 1px solid var(--border); border-radius: var(--r-2); overflow: clip; background: var(--surface-2); }
.rp-section[open] { border-color: color-mix(in srgb, var(--accent) 30%, var(--border)); }
.rp-section > summary { min-height: 58px; display: flex; align-items: center; gap: 10px; padding: 10px 12px; list-style: none; cursor: pointer; }
.rp-section > summary::-webkit-details-marker { display: none; }
.rp-section > summary::before { content: "›"; flex: 0 0 auto; color: var(--accent); font: 750 19px/1 var(--font-mono); transition: transform var(--dur-1); }
.rp-section[open] > summary::before { transform: rotate(90deg); }
.rp-section > summary > span:first-of-type { min-width: 0; display: flex; flex-direction: column; gap: 3px; }
.rp-section > summary > span:first-of-type small { color: var(--muted); font: 700 9px/1 var(--font-mono); letter-spacing: .07em; text-transform: uppercase; }
.rp-section > summary > span:first-of-type b { color: var(--text-strong); font: 750 13px/1.2 var(--font-sans); }
.rp-section-signal { min-width: 0; margin-left: auto; display: flex; flex-direction: column; align-items: flex-end; gap: 3px; text-align: right; }
.rp-section-signal b { color: var(--text-strong); font: 700 11px/1.2 var(--font-mono); }
.rp-section-signal small { color: var(--muted); font: 500 10px/1.2 var(--font-sans); }
.rp-section-body { padding: 11px 12px 12px; border-top: 1px solid var(--hairline); background: var(--surface); }
.rp-method-note { margin: 0 0 12px; padding: 8px 9px; border-left: 2px solid var(--accent); background: var(--surface-2); color: var(--muted); font: 500 10.5px/1.4 var(--font-sans); }
...
@media (max-width: 820px) {
  .rp-signal-grid { grid-template-columns: repeat(2, minmax(0, 1fr)); }
}
@media (max-width: 640px) {
  .rp-desk { padding: 11px; }
  .rp-desk-head { gap: 8px; }
  .rp-desk-head h3 { font-size: 16px; }
  .rp-desk-badge { padding: 4px 7px; font-size: 9px; }
  .rp-desk-source { align-items: flex-start; flex-direction: column; gap: 4px; }
  .rp-signal-grid { display: flex; overflow-x: auto; scroll-snap-type: x proximity; scrollbar-width: none; padding-bottom: 3px; }
  .rp-signal-grid::-webkit-scrollbar { display: none; }
  .rp-signal { flex: 0 0 min(180px, 60vw); scroll-snap-align: start; }
  .rp-posture { grid-template-columns: 1fr; gap: 5px; padding: 9px 10px; }
  .rp-posture-label { padding-top: 0; }
  .rp-rules { grid-template-columns: minmax(0, 1fr); }
  .rp-equity-lens { grid-template-columns: minmax(0, 1fr); }
  .rp-equity-lens > div { align-items: flex-start; flex-direction: column; }
  .rp-lens-links { max-width: none; justify-content: flex-start; }
  .rp-actions { display: grid; grid-template-columns: minmax(0, 1fr); }
  .rp-action { min-height: 42px; width: 100%; }
  .rp-section > summary { align-items: flex-start; gap: 7px; }
  .rp-section-signal { max-width: 48%; }
  .rp-section-signal b { font-size: 10px; }
  .rp-row-name { flex-basis: 100%; }
  .rp-row-price { flex: 1 1 auto; }
}

/* --- Search interest (Alt data) ---------------------------------------- */
.si-root { display: flex; flex-direction: column; gap: 12px; }
.si-desk {
  display: flex; flex-direction: column; gap: 11px; margin-top: 10px; padding: 14px;
  border: 1px solid color-mix(in srgb, var(--accent) 30%, var(--border)); border-top: 3px solid var(--accent);
  border-radius: var(--r-3); background: linear-gradient(135deg, color-mix(in srgb, var(--accent) 6%, var(--surface)), var(--surface) 64%);
}
.si-desk-head { display: flex; align-items: flex-start; justify-content: space-between; gap: 14px; }
.si-desk-head > div { min-width: 0; }
.si-kicker { color: var(--accent); font: 750 10px/1 var(--font-mono); letter-spacing: .09em; text-transform: uppercase; }
.si-desk-head h3 { margin: 4px 0 3px; color: var(--text-strong); font: 750 18px/1.2 var(--font-sans); }
.si-desk-head p { margin: 0; max-width: 760px; color: var(--muted); font: 500 11.5px/1.42 var(--font-sans); }
.si-status {
  flex: 0 0 auto; padding: 5px 8px; border: 1px solid color-mix(in srgb, var(--pos) 40%, var(--border));
  border-radius: var(--r-pill); color: var(--pos); background: color-mix(in srgb, var(--pos) 6%, var(--surface));
  font: 750 9px/1 var(--font-mono); letter-spacing: .06em; text-transform: uppercase;
}
.si-status.is-stale { color: var(--warn); border-color: color-mix(in srgb, var(--warn) 42%, var(--border)); }
.si-summary { display: grid; grid-template-columns: repeat(4, minmax(0, 1fr)); gap: 8px; }
.si-summary > div { min-width: 0; padding: 10px; border: 1px solid var(--border); border-radius: var(--r-2); background: var(--surface); }
.si-summary small { display: block; margin-bottom: 6px; color: var(--muted); font: 700 9px/1 var(--font-mono); letter-spacing: .05em; text-transform: uppercase; }
.si-summary b { display: block; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; color: var(--text-strong); font: 750 13px/1.2 var(--font-sans); }
.si-summary strong { display: block; margin-top: 3px; color: var(--muted-strong); font: 750 11px/1 var(--font-mono); }
.si-source { margin: 0; color: var(--muted); font: 500 10.5px/1.4 var(--font-sans); }
.si-source b { color: var(--text-strong); }
.si-toolbar { display: flex; align-items: center; justify-content: space-between; gap: 10px; }
.si-filters { display: flex; flex-wrap: wrap; gap: 6px; }
.si-filters button {
  min-height: 32px; padding: 7px 10px; border: 1px solid var(--border); border-radius: var(--r-pill);
  background: var(--surface); color: var(--muted-strong); cursor: pointer; font: 700 10.5px/1 var(--font-sans);
}
.si-filters button:hover, .si-filters button:focus-visible, .si-filters button.is-on { border-color: var(--accent); color: var(--accent); }
.si-filters button.is-on { background: color-mix(in srgb, var(--accent) 8%, var(--surface)); }
#si-search {
  width: min(310px, 100%); min-height: 36px; padding: 8px 11px; border: 1px solid var(--border);
  border-radius: var(--r-pill); background: var(--surface); color: var(--text); font: 500 11px/1 var(--font-sans);
}
.si-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(315px, 1fr)); gap: 10px; }
.si-card { min-width: 0; border: 1px solid var(--border); border-radius: var(--r-2); overflow: clip; background: var(--surface); }
.si-card.has-breakout { border-color: color-mix(in srgb, var(--warn) 48%, var(--border)); }
...
.si-breakout {
  ...
  color: var(--warn); background: color-mix(in srgb, var(--warn) 7%, var(--surface)); font: 800 8.5px/1 var(--font-mono); letter-spacing: .06em; text-transform: uppercase;
}
.si-metrics { display: grid; grid-template-columns: repeat(3, minmax(0, 1fr)); gap: 6px; grid-column: 1 / -1; }
.si-metrics > span { min-width: 0; padding: 6px 7px; border-radius: var(--r-1); background: var(--surface-2); }
.si-metrics small { display: block; margin-bottom: 3px; color: var(--muted); font: 700 8px/1 var(--font-mono); text-transform: uppercase; letter-spacing: .05em; }
.si-metrics b { color: var(--text-strong); font: 800 12px/1 var(--font-mono); font-variant-numeric: tabular-nums; }
.si-up b, .si-up { color: var(--pos) !important; }
.si-down b, .si-down { color: var(--neg) !important; }
.si-flat b, .si-flat { color: var(--muted-strong) !important; }
.si-spark { grid-column: 1 / -1; width: 100%; height: 30px; }
.si-spark polyline { fill: none; stroke: var(--accent); stroke-width: 1.6; vector-effect: non-scaling-stroke; }
.si-card-body { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 10px; padding: 11px; border-top: 1px solid var(--hairline); background: var(--surface-2); }
.si-card-body h4 { margin: 0 0 6px; color: var(--muted); font: 750 9px/1 var(--font-mono); letter-spacing: .06em; text-transform: uppercase; }
.si-queries { display: flex; flex-direction: column; gap: 4px; }
.si-query { min-width: 0; display: flex; align-items: center; justify-content: space-between; gap: 7px; padding: 5px 6px; border: 1px solid var(--hairline); border-radius: var(--r-1); background: var(--surface); }
.si-query b { min-width: 0; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; color: var(--text); font: 600 10.5px/1.2 var(--font-sans); }
.si-query small { flex: 0 0 auto; color: var(--muted); font: 700 9px/1 var(--font-mono); }
.si-query.is-breakout { border-color: color-mix(in srgb, var(--warn) 36%, var(--border)); }
.si-query.is-breakout small { color: var(--warn); }
.si-query-empty { color: var(--muted); font: 500 10px/1.3 var(--font-sans); }
.si-card-body > p { grid-column: 1 / -1; margin: 0; color: var(--muted); font: 500 9.5px/1.35 var(--font-sans); }
.si-more {
  align-self: center; min-height: 36px; padding: 8px 13px; border: 1px solid var(--accent); border-radius: var(--r-pill);
  background: var(--surface); color: var(--accent); cursor: pointer; font: 700 11px/1 var(--font-sans);
}
.si-no-match { margin: 4px 0; color: var(--muted); font: 500 12px/1.4 var(--font-sans); }
.si-empty-desk { margin-top: 10px; padding: 16px; border: 1px dashed var(--border-strong); border-radius: var(--r-3); background: var(--surface-2); }
.si-empty-desk > span { color: var(--accent); font: 750 9px/1 var(--font-mono); text-transform: uppercase; letter-spacing: .08em; }
.si-empty-desk h3 { margin: 5px 0 4px; color: var(--text-strong); font: 750 17px/1.2 var(--font-sans); }
.si-empty-desk p { margin: 0; color: var(--muted); font: 500 12px/1.4 var(--font-sans); }
@media (max-width: 760px) {
  .si-summary { grid-template-columns: repeat(2, minmax(0, 1fr)); }
  .si-toolbar { align-items: stretch; flex-direction: column; }
  #si-search { width: 100%; }
}
@media (max-width: 480px) {
  .si-desk { padding: 11px; }
  .si-desk-head h3 { font-size: 16px; }
  .si-grid { grid-template-columns: minmax(0, 1fr); }
  .si-card-body { grid-template-columns: minmax(0, 1fr); }
  .si-card-body > p { grid-column: 1; }
}
...
.cmd-desk {
  ...
  border-radius: var(--r-3);
  background: linear-gradient(135deg, color-mix(in srgb, var(--accent) 6%, var(--surface)), var(--surface) 62%);
}
.cmd-desk-reference {
  border-color: var(--border);
  background: linear-gradient(135deg, color-mix(in srgb, var(--muted) 5%, var(--surface)), var(--surface) 62%);
}
.cmd-desk-head { display: flex; align-items: flex-end; justify-content: space-between; gap: 18px; }
.cmd-desk-head > div:first-child { min-width: 0; }
.cmd-desk-kicker {
  color: var(--accent);
...
.cmd-desk-head h3 { margin: 4px 0 3px; color: var(--text-strong); font: 750 17px/1.25 var(--font-sans); }
.cmd-desk-head p { margin: 0; max-width: 720px; color: var(--muted); font: 500 12px/1.45 var(--font-sans); }
.cmd-desk-breadth { flex: 0 0 auto; display: flex; gap: 6px; }
.cmd-desk-breadth span {
  display: inline-flex;
  align-items: baseline;
  gap: 4px;
  padding: 5px 8px;
...
.cmd-desk-breadth b { color: var(--text-strong); font-size: 12px; }
.cmd-desk-source {
  display: flex; align-items: center; gap: 8px 12px; padding: 7px 9px;
  border: 1px solid var(--hairline); border-radius: var(--r-2); background: color-mix(in srgb, var(--surface-2) 84%, transparent);
}
.cmd-desk-source > span { flex: 0 0 auto; color: var(--text-strong); font: 750 9.5px/1 var(--font-mono); letter-spacing: .06em; text-transform: uppercase; }
.cmd-desk-source > p { margin: 0; color: var(--muted); font: 500 10.5px/1.35 var(--font-sans); }
.cmd-posture {
  display: grid; grid-template-columns: 104px minmax(0, 1fr); gap: 10px; padding: 10px 11px;
  border: 1px solid var(--hairline); border-left: 3px solid var(--accent); border-radius: var(--r-2); background: var(--surface);
}
.cmd-posture-label { padding-top: 2px; color: var(--accent); font: 750 9px/1.2 var(--font-mono); letter-spacing: .08em; text-transform: uppercase; }
.cmd-posture b { display: block; color: var(--text-strong); font: 750 12px/1.25 var(--font-sans); }
.cmd-posture p { margin: 3px 0 0; color: var(--muted-strong); font: 500 11px/1.4 var(--font-sans); }
.cmd-posture small { display: block; margin-top: 4px; color: var(--muted); font: 500 10px/1.35 var(--font-sans); }
.cmd-posture-risk { border-left-color: var(--neg); background: color-mix(in srgb, var(--neg) 4%, var(--surface)); }
.cmd-posture-risk .cmd-posture-label { color: var(--neg); }
.cmd-posture-positive { border-left-color: var(--pos); background: color-mix(in srgb, var(--pos) 4%, var(--surface)); }
.cmd-posture-positive .cmd-posture-label { color: var(--pos); }
.cmd-rules { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 8px; }
.cmd-rule { min-width: 0; padding: 9px 10px; border: 1px solid var(--hairline); border-radius: var(--r-2); background: var(--surface); }
.cmd-rule > span { display: block; margin-bottom: 4px; font: 750 9.5px/1 var(--font-mono); letter-spacing: .07em; text-transform: uppercase; }
.cmd-rule > p { margin: 0; color: var(--text); font: 500 11.5px/1.4 var(--font-sans); }
.cmd-rule-confirm { border-left: 3px solid var(--pos); }
.cmd-rule-confirm > span { color: var(--pos); }
.cmd-rule-invalidate { border-left: 3px solid var(--neg); }
.cmd-rule-invalidate > span { color: var(--neg); }
.cmd-driver-grid { display: grid; grid-template-columns: repeat(4, minmax(0, 1fr)); gap: 9px; }
.cmd-driver {
  min-width: 0;
  display: flex;
  flex-direction: column;
...
.cmd-driver-up { border-left-color: var(--pos); }
.cmd-driver-down { border-left-color: var(--neg); }
.cmd-driver-top { display: flex; align-items: center; justify-content: space-between; gap: 8px; color: var(--muted); font: 700 9px/1 var(--font-mono); letter-spacing: .07em; text-transform: uppercase; }
.cmd-driver-top em { color: var(--muted); font-style: normal; opacity: .78; }
.cmd-driver-main { display: flex; align-items: baseline; justify-content: space-between; gap: 8px; }
.cmd-driver-main > div { min-width: 0; display: flex; flex-direction: column; gap: 2px; }
.cmd-driver-main b { overflow: hidden; text-overflow: ellipsis; white-space: nowrap; color: var(--text-strong); font: 750 13px/1.2 var(--font-sans); }
.cmd-driver-main > div small { color: var(--muted); font: 650 11px/1 var(--font-mono); }
.cmd-driver-main strong { flex: 0 0 auto; color: var(--text-strong); font: 800 12px/1 var(--font-mono); font-variant-numeric: tabular-nums; text-align: right; }
.cmd-driver-up .cmd-driver-main strong { color: var(--pos); }
.cmd-driver-down .cmd-driver-main strong { color: var(--neg); }
.cmd-driver-main strong small { display: block; margin-top: 3px; color: var(--muted); font-size: 9px; text-transform: uppercase; }
.cmd-driver-impact { align-self: flex-start; padding: 3px 6px; border: 1px solid var(--border); border-radius: var(--r-pill); color: var(--muted-strong); font: 700 9px/1 var(--font-sans); }
.cmd-impact-up { border-color: color-mix(in srgb, var(--pos) 30%, var(--border)); }
.cmd-impact-down { border-color: color-mix(in srgb, var(--neg) 30%, var(--border)); }
.cmd-driver > p {
  display: -webkit-box;
  -webkit-box-orient: vertical;
  -webkit-line-clamp: 3;
  ...
  margin: 0;
  color: var(--muted-strong);
  font: 500 11px/1.42 var(--font-sans);
}
.cmd-driver-foot { display: flex; align-items: center; justify-content: space-between; gap: 7px; margin-top: auto; padding-top: 7px; border-top: 1px solid var(--hairline); }
.cmd-driver-foot > span { min-width: 0; display: flex; flex-wrap: wrap; gap: 4px; }
.cmd-driver-watch { padding: 2px 6px; border: 1px solid var(--border-strong); border-radius: var(--r-pill); color: var(--text); background: var(--surface); font: 700 9px/1 var(--font-mono); }
.cmd-driver-watch:hover, .cmd-driver-watch:focus-visible { border-color: var(--accent); color: var(--accent); }
.cmd-driver-foot button { appearance: none; flex: 0 0 auto; padding: 3px 0; border: 0; background: none; color: var(--accent); cursor: pointer; font: 700 9px/1 var(--font-mono); text-transform: uppercase; letter-spacing: .04em; }
.cmd-actions { display: flex; flex-wrap: wrap; gap: 7px; }
.cmd-action {
  min-height: 36px; padding: 8px 12px; border: 1px solid var(--border-strong); border-radius: var(--r-pill);
  background: var(--surface); color: var(--text-strong); font: 700 11px/1 var(--font-sans); cursor: pointer;
}
.cmd-action:hover, .cmd-action:focus-visible { border-color: var(--accent); color: var(--accent); }
.cmd-action-primary { border-color: var(--accent); background: var(--accent); color: var(--surface); }
.cmd-action-primary:hover, .cmd-action-primary:focus-visible { border-color: var(--accent); background: color-mix(in srgb, var(--accent) 86%, var(--text-strong)); color: var(--surface); }
.cmd-desk-note { margin: 0; color: var(--muted); font: 500 10.5px/1.4 var(--font-sans); }
.cmd-empty-desk {
  display: flex; flex-direction: column; align-items: flex-start; gap: 7px; margin: 10px 0 12px; padding: 16px;
  border: 1px dashed var(--border-strong); border-radius: var(--r-3); background: var(--surface-2);
}
.cmd-empty-desk h3 { margin: 0; color: var(--text-strong); font: 750 17px/1.25 var(--font-sans); }
.cmd-empty-desk p { margin: 0 0 3px; max-width: 760px; color: var(--muted); font: 500 12px/1.45 var(--font-sans); }
.cmd-group { margin-bottom: 8px; border: 1px solid var(--border); border-radius: var(--r-2); overflow: clip; background: var(--surface-2); }
.cmd-group[open] { border-color: color-mix(in srgb, var(--accent) 28%, var(--border)); }
.cmd-group-summary { display: flex; align-items: center; gap: 10px; min-height: 50px; padding: 9px 12px; list-style: none; cursor: pointer; }
.cmd-group-summary::-webkit-details-marker { display: none; }
.cmd-group-summary::before { content: "›"; flex: 0 0 auto; color: var(--accent); font: 750 18px/1 var(--font-mono); transition: transform var(--dur-1); }
.cmd-group[open] > .cmd-group-summary::before { transform: rotate(90deg); }
.cmd-group-summary > span:first-of-type { min-width: 0; display: flex; flex-direction: column; gap: 2px; }
.cmd-group-summary > span:first-of-type b { color: var(--text-strong); font: 750 12px/1.2 var(--font-sans); text-transform: uppercase; letter-spacing: .05em; }
.cmd-group-summary > span:first-of-type small { color: var(--muted); font: 500 10px/1 var(--font-mono); }
.cmd-group-lead { margin-left: auto; min-width: 0; display: flex; align-items: baseline; justify-content: flex-end; gap: 8px; }
.cmd-group-lead em { max-width: 190px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; color: var(--muted-strong); font: 500 11px/1.2 var(--font-sans); font-style: normal; }
.cmd-group-lead b { flex: 0 0 auto; font: 750 11px/1 var(--font-mono); font-variant-numeric: tabular-nums; }
.cmd-up { color: var(--pos); }
.cmd-down { color: var(--neg); }
.cmd-group-body { padding: 12px; border-top: 1px solid var(--hairline); background: var(--surface); }
.cmd-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(290px, 1fr)); gap: 12px; }
.cmd-card {
  padding: 12px 14px; border: 1px solid var(--border); border-radius: var(--r-2);
  background: var(--surface); min-width: 0;
}
.cmd-card[open] { border-color: color-mix(in srgb, var(--accent) 30%, var(--border)); }
.cmd-card-missing { opacity: 0.75; }
.cmd-card-aged { opacity: 0.78; border-style: dashed; }
.cmd-card-missing .cmd-card-toggle { display: none; }
.cmd-card-summary { display: flex; flex-direction: column; gap: 7px; list-style: none; cursor: pointer; }
.cmd-card-summary::-webkit-details-marker { display: none; }
.cmd-card-body { display: flex; flex-direction: column; gap: 7px; margin-top: 9px; padding-top: 9px; border-top: 1px solid var(--hairline); }
...
.cmd-card-toggle { margin-left: auto; color: var(--accent); font: 700 9px/1 var(--font-mono); letter-spacing: .05em; text-transform: uppercase; }
.cmd-card-toggle::before { content: "+ "; }
.cmd-card[open] .cmd-card-toggle::before { content: "− "; }
.cmd-badge {
...
@media (max-width: 900px) {
  .cmd-driver-grid { grid-template-columns: repeat(2, minmax(0, 1fr)); }
}
@media (max-width: 640px) {
  .cmd-desk { padding: 11px; }
  .cmd-desk-head { align-items: flex-start; }
  .cmd-desk-breadth { flex-direction: column; }
  .cmd-desk-source { align-items: flex-start; flex-direction: column; gap: 4px; }
  .cmd-posture { grid-template-columns: 1fr; gap: 5px; padding: 9px 10px; }
  .cmd-posture-label { padding-top: 0; }
  .cmd-rules { grid-template-columns: minmax(0, 1fr); }
  .cmd-driver-grid { display: flex; overflow-x: auto; scroll-snap-type: x proximity; scrollbar-width: none; padding-bottom: 3px; }
  .cmd-driver-grid::-webkit-scrollbar { display: none; }
  .cmd-driver { flex: 0 0 min(260px, 79vw); scroll-snap-align: start; }
  .cmd-actions { display: grid; grid-template-columns: minmax(0, 1fr); }
  .cmd-action { min-height: 42px; width: 100%; }
  .cmd-group-summary { align-items: flex-start; gap: 7px; }
  .cmd-group-lead { max-width: 48%; flex-direction: column; align-items: flex-end; gap: 3px; }
  .cmd-group-lead em { max-width: 138px; }
  .cmd-group-body { padding: 8px; }
...
.quant-conf-note { border-style: solid; }
.quant-conf-count { font: 700 11px/1 var(--font-mono); color: var(--muted-strong); border: 1px solid var(--border); border-radius: 999px; padding: 3px 7px; white-space: nowrap; }
.quant-conf-count.is-q { color: var(--accent); border-color: color-mix(in srgb, var(--accent) 45%, transparent); }
.quant-conf-q { font: 700 10px/1 var(--font-sans); letter-spacing: .04em; text-transform: uppercase; color: var(--accent); border: 1px solid color-mix(in srgb, var(--accent) 45%, transparent); border-radius: 999px; padding: 3px 8px; white-space: nowrap; }
...
.stk-desk { display: flex; align-items: flex-start; justify-content: space-between; gap: 18px; padding: 14px; border: 1px solid color-mix(in srgb, var(--accent) 30%, var(--border)); border-radius: 12px; background: linear-gradient(135deg, color-mix(in srgb, var(--accent) 5%, var(--surface)), var(--surface) 58%); }
.stk-desk > div:first-child { min-width: 0; max-width: 720px; }
.stk-desk-kicker { display: block; margin-bottom: 5px; color: var(--accent); font: 700 9.5px/1 var(--font-mono); letter-spacing: .09em; text-transform: uppercase; }
.stk-desk h3 { margin: 0; color: var(--text-strong); font: 750 17px/1.3 var(--font-sans); }
.stk-desk p { margin: 6px 0 0; color: var(--muted-strong); font: 400 12px/1.5 var(--font-sans); }
.stk-desk-stats { display: grid; grid-template-columns: repeat(3, minmax(88px, 1fr)); gap: 6px; flex: 0 0 auto; }
.stk-desk-stats > span { display: flex; flex-direction: column; gap: 3px; min-width: 0; padding: 8px 9px; border: 1px solid var(--border); border-radius: 8px; background: var(--surface-2); }
.stk-desk-stats b { color: var(--text-strong); font: 800 18px/1 var(--font-mono); font-variant-numeric: tabular-nums; }
.stk-desk-stats small { color: var(--muted); font: 650 8px/1.2 var(--font-sans); letter-spacing: .04em; text-transform: uppercase; }
.stk-desk-start b { color: var(--pos); }
.stk-desk-wait b { color: var(--warn); }
.stk-desk-research b { color: var(--neg); }
...
.stk-tiers { display: flex; flex-direction: column; gap: 18px; }
.stk-tier { display: flex; flex-direction: column; gap: 13px; padding: 14px; border: 1px solid var(--border); border-radius: 12px; background: color-mix(in srgb, var(--surface) 96%, transparent); }
.stk-tier-buy { border-color: color-mix(in srgb, var(--pos) 30%, var(--border)); background: linear-gradient(135deg, color-mix(in srgb, var(--pos) 4%, var(--surface)), var(--surface) 42%); }
.stk-tier-watch { border-color: color-mix(in srgb, var(--warn) 30%, var(--border)); background: linear-gradient(135deg, color-mix(in srgb, var(--warn) 4%, var(--surface)), var(--surface) 42%); }
.stk-tier-head { display: flex; align-items: flex-start; justify-content: space-between; gap: 14px; padding-bottom: 11px; border-bottom: 1px solid var(--border); }
.stk-tier-head > div:first-child { min-width: 0; }
.stk-tier-kicker { display: block; margin-bottom: 4px; color: var(--muted); font: 700 8.5px/1 var(--font-mono); letter-spacing: .08em; text-transform: uppercase; }
.stk-tier-head h3 { display: flex; align-items: baseline; gap: 7px; margin: 0; color: var(--text-strong); font: 750 18px/1.2 var(--font-sans); }
.stk-tier-buy .stk-tier-head h3 { color: var(--pos); }
.stk-tier-watch .stk-tier-head h3 { color: var(--warn); }
.stk-tier-head h3 b { display: inline-flex; align-items: center; justify-content: center; min-width: 23px; height: 23px; padding: 0 6px; border-radius: 999px; color: var(--text-strong); background: color-mix(in srgb, var(--border) 50%, transparent); font: 750 11px/1 var(--font-mono); font-variant-numeric: tabular-nums; }
.stk-tier-head p { max-width: 700px; margin: 5px 0 0; color: var(--muted-strong); font: 400 11.5px/1.45 var(--font-sans); }
.stk-tier-chips { display: flex; flex-wrap: wrap; justify-content: flex-end; gap: 5px; flex: 0 0 auto; }
.stk-tier-chip { display: inline-flex; align-items: baseline; gap: 5px; padding: 5px 7px; border: 1px solid var(--border); border-radius: 999px; color: var(--muted-strong); background: var(--surface-2); font: 650 9.5px/1 var(--font-sans); white-space: nowrap; }
.stk-tier-chip b { color: var(--text-strong); font: 750 10px/1 var(--font-mono); font-variant-numeric: tabular-nums; }
.stk-tier-chip-starter b { color: var(--pos); }
.stk-tier-chip-wait b { color: var(--warn); }
.stk-tier-chip-research b { color: var(--neg); }
.stk-action-group { display: flex; flex-direction: column; gap: 9px; }
.stk-action-group + .stk-action-group { padding-top: 12px; border-top: 1px solid var(--border); }
.stk-action-head { display: flex; align-items: baseline; justify-content: space-between; gap: 10px; }
.stk-action-head > div { display: flex; flex-direction: column; gap: 3px; }
.stk-action-head small { color: var(--muted); font: 700 8px/1 var(--font-mono); letter-spacing: .07em; text-transform: uppercase; }
.stk-action-head h4 { margin: 0; color: var(--text-strong); font: 700 12.5px/1.2 var(--font-sans); }
.stk-action-starter .stk-action-head h4 { color: var(--pos); }
.stk-action-wait .stk-action-head h4 { color: var(--warn); }
.stk-action-research .stk-action-head h4 { color: var(--neg); }
.stk-action-head span { color: var(--muted); font: 600 9.5px/1.2 var(--font-mono); white-space: nowrap; }
.stk-tier-empty { margin: 0; color: var(--muted); font: 400 12px/1.4 var(--font-sans); font-style: italic; }
...
.stk-zone-buy, .stk-zone-starter { color: var(--pos); background: color-mix(in srgb, var(--pos) 13%, transparent); }
.stk-zone-wait, .stk-zone-flag { color: var(--warn); background: var(--warn-soft); }
.stk-zone-research { color: var(--neg); background: var(--neg-soft); }
...
.stk-plan { display: flex; flex-direction: column; gap: 7px; padding: 9px 10px; border: 1px solid var(--border); border-radius: 9px; background: var(--surface-2); }
.stk-plan-starter { border-color: color-mix(in srgb, var(--pos) 36%, var(--border)); background: color-mix(in srgb, var(--pos) 4%, var(--surface-2)); }
.stk-plan-wait { border-color: color-mix(in srgb, var(--warn) 34%, var(--border)); background: color-mix(in srgb, var(--warn) 4%, var(--surface-2)); }
.stk-plan-research { border-color: color-mix(in srgb, var(--neg) 30%, var(--border)); background: color-mix(in srgb, var(--neg) 3%, var(--surface-2)); }
.stk-plan > header { display: flex; align-items: flex-start; justify-content: space-between; gap: 10px; }
.stk-plan > header > span { display: flex; flex-direction: column; gap: 2px; min-width: 0; }
.stk-plan > header small { color: var(--accent); font: 700 8.5px/1 var(--font-mono); letter-spacing: .07em; text-transform: uppercase; }
.stk-plan > header b { color: var(--text-strong); font: 750 12px/1.25 var(--font-sans); }
.stk-plan-starter > header b { color: var(--pos); }
.stk-plan-wait > header b { color: var(--warn); }
.stk-plan-research > header b { color: var(--neg); }
.stk-plan > header em { flex: 0 0 auto; color: var(--muted); font: 600 8.5px/1 var(--font-sans); font-style: normal; letter-spacing: .04em; text-transform: uppercase; }
.stk-plan-detail { margin: 0; color: var(--muted-strong); font: 400 10.5px/1.45 var(--font-sans); }
.stk-plan-proof { display: flex; flex-wrap: wrap; gap: 5px; }
.stk-plan-proof span { padding: 4px 6px; border-radius: 5px; background: color-mix(in srgb, var(--border) 48%, transparent); color: var(--muted); font: 650 9px/1.2 var(--font-sans); }
.stk-plan-proof span.is-on { color: var(--pos); background: var(--pos-soft); }
.stk-plan-grid { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); border: 1px solid var(--border); border-radius: 8px; overflow: hidden; background: var(--surface); }
.stk-plan-grid > span { display: flex; flex-direction: column; gap: 3px; min-width: 0; padding: 7px 8px; border-right: 1px solid var(--border); }
.stk-plan-grid > span:first-child { grid-column: 1 / -1; border-right: 0; border-bottom: 1px solid var(--border); }
.stk-plan-grid > span:last-child { border-right: 0; }
.stk-plan-grid small { color: var(--muted); font: 700 8px/1 var(--font-mono); letter-spacing: .06em; text-transform: uppercase; }
.stk-plan-grid b { color: var(--text-strong); font: 700 10.5px/1.25 var(--font-sans); overflow-wrap: anywhere; }
.stk-plan-grid > span:nth-child(2) b { color: var(--neg); }
.stk-plan-grid > span:nth-child(3) b { color: var(--pos); }
.stk-plan-grid em { color: var(--muted); font: 500 9px/1.3 var(--font-sans); font-style: normal; overflow-wrap: anywhere; }
.stk-plan-payoff { display: flex; flex-wrap: wrap; gap: 5px 11px; margin: 0; color: var(--muted); font: 550 9.5px/1.25 var(--font-sans); }
.stk-plan-payoff b { color: var(--text-strong); font-family: var(--font-mono); font-variant-numeric: tabular-nums; }
...
@media (max-width: 760px) {
  .stk-desk { flex-direction: column; }
  .stk-desk-stats { width: 100%; }
  .stk-tier { padding: 11px; }
  .stk-tier-head { flex-direction: column; }
  .stk-tier-chips { justify-content: flex-start; }
  .stk-action-head { align-items: flex-start; flex-direction: column; gap: 3px; }
  .stk-grid, .stk-dca-grid { grid-template-columns: minmax(0, 1fr); }
}
@media (max-width: 480px) {
  .stk-desk { padding: 11px; }
  .stk-desk-stats { grid-template-columns: minmax(0, 1fr); }
  .stk-desk-stats > span { flex-direction: row; align-items: baseline; justify-content: space-between; }
  .stk-plan-grid { grid-template-columns: minmax(0, 1fr); }
  .stk-plan-grid > span, .stk-plan-grid > span:first-child { grid-column: auto; border-right: 0; border-bottom: 1px solid var(--border); }
  .stk-plan-grid > span:last-child { border-bottom: 0; }
  .stk-plan > header { align-items: flex-start; }
}
...
.rot-process { display: grid; grid-template-columns: repeat(4, minmax(0, 1fr)); gap: 6px; margin: -4px 0 0; padding: 0; list-style: none; counter-reset: none; }
.rot-process li { display: flex; flex-direction: column; gap: 4px; min-width: 0; padding: 9px 10px; border: 1px solid var(--border); border-radius: 9px; background: var(--surface); }
.rot-process b { display: flex; align-items: center; gap: 6px; color: var(--text-strong); font: 700 10.5px/1.2 var(--font-sans); }
.rot-process b em { display: inline-flex; width: 18px; height: 18px; flex: 0 0 auto; align-items: center; justify-content: center; border-radius: 50%; background: var(--accent-soft); color: var(--accent); font: 800 9px/1 var(--font-mono); font-style: normal; }
...
.rot-record-head .rot-kicker { margin-bottom: 4px; }
.rot-record-head h3 { margin: 0; color: var(--text-strong); font: 750 15px/1.25 var(--font-sans); }
.rot-record-head p { margin: 4px 0 0; color: var(--muted-strong); font: 400 11.5px/1.45 var(--font-sans); }
.rot-record-badge { flex: 0 0 auto; padding: 5px 8px; border: 1px solid color-mix(in srgb, var(--accent) 35%, var(--border)); border-radius: 999px; color: var(--accent); background: var(--accent-soft); font: 700 9px/1 var(--font-sans); letter-spacing: .04em; text-transform: uppercase; }
.rot-record-stats { display: grid; grid-template-columns: repeat(6, minmax(86px, 1fr)); gap: 6px; min-width: 0; }
.rot-record-stat { display: flex; flex-direction: column; gap: 3px; min-width: 0; padding: 7px 8px; border: 1px solid var(--border); border-radius: 8px; background: var(--surface-2); }
.rot-record-stat small { color: var(--muted); font: 650 8px/1.1 var(--font-sans); letter-spacing: .04em; text-transform: uppercase; }
.rot-record-stat b { color: var(--text-strong); font: 750 13px/1.15 var(--font-mono); font-variant-numeric: tabular-nums; overflow-wrap: anywhere; }
.rot-record-stat b em { color: var(--muted); font: 500 9px/1 var(--font-sans); font-style: normal; white-space: nowrap; }
.rot-entry-lab { display: flex; flex-direction: column; gap: 7px; padding: 9px 10px; border: 1px solid color-mix(in srgb, var(--accent) 24%, var(--border)); border-radius: 9px; background: color-mix(in srgb, var(--accent) 4%, var(--surface-2)); }
.rot-entry-lab-actionable { border-color: color-mix(in srgb, var(--pos) 38%, var(--border)); background: color-mix(in srgb, var(--pos) 5%, var(--surface-2)); }
.rot-entry-lab-head { display: flex; align-items: flex-start; justify-content: space-between; gap: 10px; }
.rot-entry-lab-head > span { display: flex; flex-direction: column; gap: 2px; min-width: 0; }
.rot-entry-lab-head small { color: var(--accent); font: 700 8.5px/1 var(--font-mono); letter-spacing: .06em; text-transform: uppercase; }
.rot-entry-lab-head b { color: var(--text-strong); font: 700 11.5px/1.3 var(--font-sans); }
.rot-entry-lab-head > em { flex: 0 0 auto; color: var(--muted); font: 600 9px/1.2 var(--font-mono); font-style: normal; }
.rot-entry-lab > p { margin: 0; color: var(--muted-strong); font: 400 10.5px/1.45 var(--font-sans); }
.rot-entry-facts, .rot-entry-cohorts { display: flex; flex-wrap: wrap; gap: 5px; }
.rot-entry-facts > span { display: flex; flex: 1 1 120px; flex-direction: column; gap: 2px; padding: 6px 7px; border: 1px solid var(--border); border-radius: 7px; background: var(--surface); }
.rot-entry-facts small { color: var(--muted); font: 600 8px/1.1 var(--font-sans); text-transform: uppercase; }
.rot-entry-facts b { color: var(--text-strong); font: 700 10.5px/1.15 var(--font-mono); font-variant-numeric: tabular-nums; }
.rot-entry-cohorts > span { display: inline-flex; align-items: baseline; gap: 6px; padding: 4px 6px; border-radius: 6px; color: var(--muted-strong); background: color-mix(in srgb, var(--border) 45%, transparent); }
.rot-entry-cohorts b { color: var(--text); font: 650 9.5px/1.2 var(--font-sans); }
.rot-entry-cohorts em { color: var(--muted); font: 500 9px/1.2 var(--font-mono); font-style: normal; }
.rot-record-ledger { border: 1px solid var(--border); border-radius: 9px; background: var(--surface); overflow: hidden; }
.rot-record-ledger > summary { min-height: 40px; display: flex; align-items: center; gap: 7px; padding: 0 10px; list-style: none; color: var(--muted-strong); font: 650 10.5px/1.25 var(--font-sans); cursor: pointer; user-select: none; }
.rot-record-ledger > summary::-webkit-details-marker { display: none; }
.rot-record-ledger > summary::before { content: '▸'; flex: 0 0 auto; color: var(--accent); font-size: 12px; line-height: 1; }
.rot-record-ledger[open] > summary::before { content: '▾'; }
.rot-record-rows { display: grid; grid-template-columns: repeat(auto-fit, minmax(275px, 1fr)); gap: 6px; padding: 0 8px 8px; }
.rot-record-row { display: flex; flex-direction: column; gap: 5px; min-width: 0; padding: 8px 9px; border: 1px solid var(--border); border-left-width: 3px; border-radius: 8px; background: var(--surface-2); }
.rot-record-row-open { border-left-color: var(--accent); }
.rot-record-row-win { border-left-color: var(--pos); }
.rot-record-row-loss { border-left-color: var(--neg); }
.rot-record-row-timeout { border-left-color: var(--warn); }
.rot-record-row-top { display: flex; align-items: baseline; gap: 6px; min-width: 0; }
.rot-record-row-top .rot-sym { font-size: 12.5px; }
.rot-record-row-top > span { min-width: 0; color: var(--muted); font: 500 9.5px/1.2 var(--font-sans); overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
.rot-record-outcome { margin-left: auto; flex: 0 0 auto; color: var(--muted-strong); font: 750 8.5px/1 var(--font-sans); letter-spacing: .04em; }
.rot-record-row-win .rot-record-outcome { color: var(--pos); }
.rot-record-row-loss .rot-record-outcome { color: var(--neg); }
.rot-record-row-timeout .rot-record-outcome { color: var(--warn); }
.rot-record-path { display: flex; align-items: baseline; justify-content: space-between; gap: 8px; min-width: 0; }
.rot-record-path > span { color: var(--text); font: 600 10px/1.25 var(--font-mono); font-variant-numeric: tabular-nums; }
.rot-record-terminal { display: inline-flex; align-items: baseline; gap: 3px; white-space: nowrap; }
.rot-record-terminal small { color: var(--accent); font: 700 8.5px/1 var(--font-sans); letter-spacing: .04em; text-transform: uppercase; }
.rot-record-mark { display: inline-flex; flex-wrap: wrap; justify-content: flex-end; gap: 3px 5px; color: var(--muted-strong); font: 600 9.5px/1.2 var(--font-mono); font-variant-numeric: tabular-nums; text-align: right; }
.rot-record-mark i, .rot-track-mark i { color: var(--muted); font-style: normal; }
.rot-record-row > small { color: var(--muted); font: 400 9.5px/1.35 var(--font-sans); overflow-wrap: anywhere; }
.rot-record-empty { margin: 0; padding: 8px 9px; border: 1px dashed var(--border-strong); border-radius: 8px; color: var(--muted-strong); font: 400 10.5px/1.45 var(--font-sans); }
.rot-record-empty b { color: var(--text-strong); }
.rot-record-method { margin: 0; color: var(--muted); font: 400 9.5px/1.4 var(--font-sans); }
.rot-record-method b { color: var(--text); }
...
.rot-tape-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 7px; }
...
.rot-tape-top { display: flex; align-items: flex-start; justify-content: space-between; gap: 8px; }
.rot-tape-top b { min-width: 0; color: var(--text-strong); font: 700 12px/1.25 var(--font-sans); overflow-wrap: anywhere; }
.rot-tape-top strong { flex: 0 0 auto; padding-top: 1px; font: 750 12px/1 var(--font-mono); font-variant-numeric: tabular-nums; white-space: nowrap; }
...
.rot-score b em { margin-left: 2px; color: var(--muted); font: 700 9px/1 var(--font-mono); font-style: normal; }
...
.rot-tracking { display: flex; flex-wrap: wrap; align-items: baseline; justify-content: space-between; gap: 4px 8px; padding: 6px 7px; border-radius: 7px; font: 550 9.5px/1.3 var(--font-sans); }
.rot-tracking-open { color: var(--muted-strong); background: color-mix(in srgb, var(--accent) 9%, transparent); border: 1px solid color-mix(in srgb, var(--accent) 22%, transparent); }
.rot-tracking-watch { color: var(--muted-strong); background: color-mix(in srgb, var(--warn) 7%, transparent); border: 1px solid color-mix(in srgb, var(--warn) 18%, transparent); }
.rot-tracking-watch b { color: var(--warn); font-weight: 650; }
.rot-track-mark { display: inline-flex; flex-wrap: wrap; gap: 3px 5px; color: var(--muted-strong); font: 650 9.5px/1.2 var(--font-mono); font-variant-numeric: tabular-nums; }
...
.rot-components b em { margin-left: 2px; color: var(--muted); font: 650 8.5px/1 var(--font-mono); font-style: normal; }
...
.rot-spark polyline { stroke-width: 1.5; vector-effect: non-scaling-stroke; }
.rot-spark-stock { stroke: var(--muted-strong); }
.rot-spark-up .rot-spark-stock { stroke: var(--pos); }
.rot-spark-down .rot-spark-stock { stroke: var(--neg); }
.rot-spark-peer { stroke: var(--accent); stroke-width: 1.15 !important; stroke-dasharray: 4 3; opacity: .72; }
...
.rot-spark-caption { display: flex; flex-wrap: wrap; align-items: center; gap: 4px 9px; color: var(--muted); font: 500 9px/1.2 var(--font-sans); }
.rot-spark-caption i { display: inline-flex; align-items: center; gap: 4px; color: var(--muted-strong); font-style: normal; }
.rot-spark-caption i::before { width: 13px; height: 2px; border-radius: 2px; background: var(--muted-strong); content: ""; }
.rot-spark-caption .rot-spark-key-up::before { background: var(--pos); }
.rot-spark-caption .rot-spark-key-down::before { background: var(--neg); }
.rot-spark-caption .rot-spark-key-peer::before { height: 1px; background: repeating-linear-gradient(90deg, var(--accent) 0 4px, transparent 4px 7px); }
.rot-spark-caption b { font: 700 9px/1.2 var(--font-mono); }
.rot-spark-caption em { margin-left: auto; color: var(--muted); font-style: normal; }
...
@media (max-width: 480px) {
  ...
  .rot-record-badge { display: none; }
  .rot-record-stats { grid-template-columns: repeat(2, minmax(0, 1fr)); }
  .rot-record-path { flex-direction: column; align-items: flex-start; }
  .rot-record-mark { justify-content: flex-start; text-align: left; }
  .rot-entry-lab-head { flex-direction: column; }
  .rot-record-stat small, .rot-entry-lab-head small, .rot-entry-facts small { font-size: 10px; line-height: 1.2; }
  .rot-entry-lab-head > em, .rot-entry-cohorts em, .rot-record-terminal small { font-size: 10px; line-height: 1.25; }
  .rot-record-outcome { font-size: 10px; line-height: 1.15; }
  .rot-record-row-top > span, .rot-record-path > span, .rot-record-mark, .rot-track-mark, .rot-record-row > small, .rot-record-method, .rot-tracking { font-size: 10.5px; }
  .rot-record-ledger > summary, .rot-entry-lab > p { font-size: 11px; }
...
.lev-desk-top { display: flex; align-items: flex-start; justify-content: space-between; gap: 12px; flex-wrap: wrap; }
.lev-desk-kicker { display: block; font: 700 9.5px/1 var(--font-mono); text-transform: uppercase; letter-spacing: .08em; color: var(--accent); margin-bottom: 4px; }
.lev-desk h3 { margin: 0; font: 700 15px/1.25 var(--font-sans); color: var(--text-strong); }
.lev-desk-summary { display: flex; gap: 6px; flex-wrap: wrap; }
.lev-desk-stat { min-width: 72px; display: flex; align-items: baseline; gap: 5px; border: 1px solid var(--border); border-radius: 8px; padding: 6px 8px; background: var(--surface); }
.lev-desk-stat b { font: 800 16px/1 var(--font-mono); font-variant-numeric: tabular-nums; }
.lev-desk-stat span { font: 600 9px/1.15 var(--font-sans); text-transform: uppercase; letter-spacing: .03em; color: var(--muted); }
.lev-desk-now b { color: var(--pos); }
.lev-desk-wait b { color: var(--warn, #d99a2b); }
.lev-desk-risk b { color: var(--neg); }
.lev-toolbar { display: flex; align-items: center; gap: 8px; flex-wrap: wrap; }
.lev-filter-group { display: inline-flex; gap: 3px; padding: 3px; border: 1px solid var(--border); border-radius: 8px; background: color-mix(in srgb, var(--border) 22%, transparent); }
.lev-filter-btn { appearance: none; border: 0; border-radius: 5px; padding: 5px 8px; color: var(--muted-strong); background: transparent; font: 600 11px/1 var(--font-sans); cursor: pointer; }
.lev-filter-btn:hover { color: var(--text); background: color-mix(in srgb, var(--border) 45%, transparent); }
.lev-filter-btn.active { color: var(--text-strong); background: var(--surface); box-shadow: 0 0 0 1px var(--border); }
.lev-sort { display: inline-flex; align-items: center; gap: 5px; color: var(--muted); font: 600 10.5px/1 var(--font-sans); }
.lev-sort select { border: 1px solid var(--border); border-radius: 6px; padding: 5px 24px 5px 7px; color: var(--text); background: var(--surface); font: 600 11px/1 var(--font-sans); }
.lev-showing { margin-left: auto; font: 600 10.5px/1 var(--font-mono); color: var(--muted); }
.lev-risk-box { display: flex; align-items: center; gap: 12px; flex-wrap: wrap; border-top: 1px solid var(--border); padding-top: 9px; }
.lev-risk-box > div { display: flex; flex-direction: column; gap: 2px; margin-right: auto; }
.lev-risk-box > div b { font-size: 12px; color: var(--text-strong); }
.lev-risk-box > div span { font-size: 10.5px; color: var(--muted); }
.lev-risk-box label { display: inline-flex; align-items: center; gap: 4px; white-space: nowrap; font: 600 10.5px/1 var(--font-sans); color: var(--muted-strong); }
.lev-risk-box input { width: 82px; border: 1px solid var(--border); border-radius: 6px; padding: 5px 6px; color: var(--text); background: var(--surface); font: 700 11px/1 var(--font-mono); font-variant-numeric: tabular-nums; }
.lev-risk-box [data-lev-risk] { width: 58px; }
...
.lev-plan { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); border: 1px solid var(--border); border-radius: 9px; overflow: hidden; background: var(--surface); }
.lev-plan-cell { min-width: 0; display: flex; flex-direction: column; gap: 4px; padding: 8px 9px; }
.lev-plan-entry { grid-column: 1 / -1; border-bottom: 1px solid var(--border); background: color-mix(in srgb, var(--accent) 6%, transparent); }
.lev-plan-stop { border-right: 1px solid var(--border); }
.lev-plan-label { font: 700 9px/1 var(--font-mono); text-transform: uppercase; letter-spacing: .07em; color: var(--muted); }
.lev-plan-cell b { font: 700 12px/1.25 var(--font-sans); color: var(--text-strong); }
.lev-plan-entry b { color: var(--accent); }
.lev-plan-stop b { color: var(--neg); }
.lev-plan-target b { color: var(--pos); }
.lev-plan-cell small { font: 400 10.5px/1.35 var(--font-sans); color: var(--muted-strong); }
.lev-plan-rr { display: inline-block; margin-left: 4px; color: var(--text-strong); font-weight: 700; }
.lev-size { margin-top: -3px; padding: 5px 8px; border-radius: 6px; color: var(--muted-strong); background: color-mix(in srgb, var(--accent) 8%, transparent); font: 500 10.5px/1.3 var(--font-sans); }
.lev-size b { color: var(--text-strong); font-family: var(--font-mono); font-variant-numeric: tabular-nums; }
...
@media (max-width: 700px) {
  .lev-desk-summary { width: 100%; }
  .lev-desk-stat { flex: 1 1 80px; }
  .lev-filter-group { width: 100%; }
  .lev-filter-btn { flex: 1 1 0; }
  .lev-sort { width: 100%; justify-content: space-between; }
  .lev-sort select { flex: 1 1 auto; }
  .lev-showing { margin-left: 0; }
  .lev-risk-box > div { width: 100%; }
}

/* --- Capital raises (Macro) ------------------------------------------- */
.capital-raises-root { display: flex; flex-direction: column; gap: var(--s-3); }
.cr-desk {
  display: flex;
  flex-direction: column;
  gap: var(--s-3);
...
.cr-desk-risk { border-left-color: var(--neg); }
.cr-desk-positive { border-left-color: var(--pos); }
.cr-desk-review { border-left-color: var(--muted); }
.cr-desk-reference { border-left-color: var(--muted); }
.cr-desk-head { min-width: 0; }
.cr-desk-kicker,
.cr-lead-label {
  display: block;
  font: 700 var(--fs-2xs)/1.2 var(--font-sans);
  color: var(--muted);
...
.cr-desk-source {
  ...
  color: var(--muted);
  font: 500 var(--fs-2xs)/1.35 var(--font-sans);
}
.cr-desk-source b { color: var(--pos); }
.cr-desk-reference .cr-desk-source b { color: var(--warn); }
.cr-desk-source small { flex: 0 0 auto; color: var(--muted); font: 500 10px/1.3 var(--font-mono); }
.cr-mix {
  display: grid;
  grid-template-columns: repeat(3, minmax(0, 1fr));
  gap: var(--s-2);
...
.cr-mix > .cr-mix-risk { border-top-color: var(--neg); }
.cr-mix > .cr-mix-positive { border-top-color: var(--pos); }
.cr-mix small {
  align-self: center;
  font-size: var(--fs-2xs);
  font-weight: 700;
...
.cr-mix b {
  ...
  grid-row: 1 / 3;
  align-self: center;
  font: 800 var(--fs-2xl)/1 var(--font-mono);
  color: var(--text);
}
.cr-mix em {
  overflow: hidden;
  text-overflow: ellipsis;
  white-space: nowrap;
  font: 400 var(--fs-2xs)/1.2 var(--font-mono);
  color: var(--muted);
}
.cr-lead {
  padding: var(--s-3);
...
.cr-lead.cr-tone-risk { border-left-color: var(--neg); }
.cr-lead.cr-tone-positive { border-left-color: var(--pos); }
.cr-lead.cr-tone-review { border-left-color: var(--muted); }
.cr-lead > div {
  display: flex;
  align-items: baseline;
  flex-wrap: wrap;
...
.cr-lead > div > b { font-size: var(--fs-sm); }
.cr-lead > div > strong {
  margin-left: auto;
...
.cr-lead-check span {
  color: var(--muted);
  font: 700 var(--fs-2xs)/1.3 var(--font-sans);
  letter-spacing: var(--ls-caps);
  text-transform: uppercase;
}
.cr-lead-check b { color: var(--text); font-size: var(--fs-xs); font-weight: 600; line-height: var(--lh-snug); }
.cr-lead-meta { display: block; margin-top: 5px; color: var(--muted); font: 400 var(--fs-2xs)/1.2 var(--font-mono); }
.cr-rules {
  display: grid;
  grid-template-columns: repeat(2, minmax(0, 1fr));
  gap: var(--s-2);
...
.cr-rules b { color: var(--text); font-size: var(--fs-xs); font-weight: 600; line-height: var(--lh-snug); }
.cr-actions { display: flex; flex-wrap: wrap; gap: 7px; }
.cr-action {
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
.cr-action:hover,
.cr-action:focus-visible { border-color: var(--accent); color: var(--accent); }
.cr-action-primary { border-color: var(--accent); background: var(--accent); color: var(--surface); }
.cr-action-primary:hover,
.cr-action-primary:focus-visible { border-color: var(--accent); background: color-mix(in srgb, var(--accent) 86%, var(--text-strong)); color: var(--surface); }
.cr-empty-desk {
  display: flex;
  flex-direction: column;
  align-items: flex-start;
...
.cr-empty-desk h3 { margin: 0; color: var(--text-strong); font-size: var(--fs-xl); line-height: var(--lh-tight); }
.cr-empty-desk p { max-width: 78ch; margin: 0; color: var(--muted); font-size: var(--fs-sm); line-height: var(--lh-snug); }
.cr-empty-desk .cr-desk-source { width: 100%; }
.cr-ledger,
.cr-kind-group {
  overflow: clip;
  border: 1px solid var(--border);
...
.cr-ledger > summary::-webkit-details-marker,
.cr-kind-group > summary::-webkit-details-marker { display: none; }
.cr-ledger > summary:hover,
.cr-kind-group > summary:hover { background: color-mix(in srgb, var(--surface-3) 64%, transparent); }
.cr-ledger > summary > span,
.cr-kind-group > summary > span { display: flex; flex-direction: column; gap: 2px; min-width: 0; }
.cr-ledger > summary b,
.cr-kind-group > summary b { font-size: var(--fs-sm); color: var(--text); }
.cr-ledger > summary small,
.cr-kind-group > summary small { font-size: var(--fs-2xs); color: var(--muted); }
.cr-ledger > summary em,
.cr-kind-group > summary em {
  font: 400 var(--fs-2xs)/1.2 var(--font-mono);
  color: var(--muted);
}
.cr-chevron {
...
.cr-ledger[open] > summary .cr-chevron,
.cr-kind-group[open] > summary .cr-chevron { transform: rotate(225deg) translate(-1px, -1px); }
.cr-ledger-body {
  display: flex;
  flex-direction: column;
  gap: var(--s-2);
...
.cr-kind-group { background: var(--surface-1); }
.cr-kind-body { padding: var(--s-2); border-top: 1px solid var(--border); }
.cr-rows { display: flex; flex-direction: column; gap: var(--s-2); }
.cr-row {
  padding: var(--s-3);
  border: 1px solid var(--border);
  border-left: 3px solid var(--warn);
...
.cr-row.cr-tone-risk { border-left-color: var(--neg); }
.cr-row.cr-tone-positive { border-left-color: var(--pos); }
.cr-row.cr-tone-review { border-left-color: var(--muted); }
...
.cr-event-read b { font-size: var(--fs-xs); color: var(--text); }
.cr-event-read span { font-size: var(--fs-xs); color: var(--muted); line-height: var(--lh-snug); }
.cr-scope {
  margin: var(--s-1) 0 0;
  color: var(--muted);
  font-size: var(--fs-2xs);
...
@media (max-width: 720px) {
  .cr-desk { padding: var(--s-3); }
  .cr-desk-head h3 { font-size: var(--fs-lg); }
  .cr-desk-head p { font-size: var(--fs-xs); }
  .cr-desk-source { align-items: flex-start; flex-direction: column; gap: 3px; }
  .cr-desk-source small { flex: none; }
  .cr-mix { gap: 5px; }
  .cr-mix > span {
    display: flex;
    flex-direction: column;
  ...
  .cr-mix b { order: -1; font-size: var(--fs-xl); }
  .cr-mix small { font-size: 9px; }
  .cr-mix em { max-width: 100%; font-size: 9px; }
  .cr-lead > div > strong { margin-left: 0; }
  .cr-lead-check { grid-template-columns: 1fr; gap: 3px; }
  .cr-rules { grid-template-columns: minmax(0, 1fr); }
  .cr-actions { display: grid; grid-template-columns: minmax(0, 1fr); width: 100%; }
  .cr-action { width: 100%; min-height: 42px; }
  .cr-empty-desk { padding: var(--s-3); }
  .cr-empty-desk h3 { font-size: var(--fs-lg); }
  .cr-empty-desk p { font-size: var(--fs-xs); }
  .cr-ledger > summary,
  .cr-kind-group > summary {
  ...
  .cr-ledger > summary > em,
  .cr-kind-group > summary > em { grid-column: 1; grid-row: 2; }
  .cr-ledger > summary .cr-chevron,
  .cr-kind-group > summary .cr-chevron { grid-column: 2; grid-row: 1 / 3; }
  .cr-event-read { grid-template-columns: 1fr; gap: 3px; }
  .cr-amt { margin-left: 0; }
}
...
.ic-decision {
  ...
  border: 1px solid color-mix(in srgb, var(--accent) 30%, var(--border)); border-radius: var(--r-3);
  background: linear-gradient(135deg, color-mix(in srgb, var(--accent) 6%, var(--surface)), var(--surface) 64%);
}
.ic-decision-open { border-top: 3px solid var(--pos); }
.ic-decision-tight { border-top: 3px solid var(--neg); }
.ic-decision-mixed { border-top: 3px solid var(--warn); }
.ic-decision-reference { border-top: 3px solid var(--muted); }
.ic-decision-head { display: flex; align-items: flex-start; justify-content: space-between; gap: 16px; }
.ic-decision-head > div { min-width: 0; }
.ic-decision-kicker { color: var(--accent); font: 700 10px/1 var(--font-mono); letter-spacing: .09em; text-transform: uppercase; }
.ic-decision-head h3 { margin: 4px 0 3px; color: var(--text-strong); font: 750 18px/1.2 var(--font-sans); }
.ic-decision-head p { margin: 0; max-width: 760px; color: var(--muted); font: 500 12px/1.45 var(--font-sans); }
.ic-decision-badge { flex: 0 0 auto; padding: 5px 9px; border: 1px solid var(--border-strong); border-radius: var(--r-pill); color: var(--text-strong); background: var(--surface); font: 750 10px/1 var(--font-mono); letter-spacing: .06em; text-transform: uppercase; }
.ic-decision-open .ic-decision-badge { color: var(--pos); border-color: color-mix(in srgb, var(--pos) 45%, var(--border)); }
.ic-decision-tight .ic-decision-badge { color: var(--neg); border-color: color-mix(in srgb, var(--neg) 45%, var(--border)); }
.ic-decision-mixed .ic-decision-badge { color: var(--warn); border-color: color-mix(in srgb, var(--warn) 45%, var(--border)); }
.ic-decision-reference .ic-decision-badge { color: var(--muted-strong); border-color: var(--border-strong); }
.ic-decision-source {
  ...
  color: var(--muted); font: 500 10.5px/1.35 var(--font-sans);
}
.ic-decision-source b { color: var(--pos); }
.ic-decision-reference .ic-decision-source b { color: var(--warn); }
.ic-decision-source small { flex: 0 0 auto; color: var(--muted); font: 500 10px/1.2 var(--font-mono); }
.ic-posture {
  display: grid; grid-template-columns: 104px minmax(0, 1fr); gap: 10px; padding: 10px 11px;
  border: 1px solid var(--hairline); border-left: 3px solid var(--warn); border-radius: var(--r-2); background: var(--surface);
}
.ic-posture-label { padding-top: 2px; color: var(--warn); font: 750 9px/1.2 var(--font-mono); letter-spacing: .08em; text-transform: uppercase; }
.ic-posture b { display: block; color: var(--text-strong); font: 750 12px/1.25 var(--font-sans); }
.ic-posture p { margin: 3px 0 0; color: var(--muted-strong); font: 500 11px/1.4 var(--font-sans); }
.ic-posture small { display: block; margin-top: 4px; color: var(--muted); font: 500 10px/1.35 var(--font-sans); }
.ic-posture-open { border-left-color: var(--pos); background: color-mix(in srgb, var(--pos) 4%, var(--surface)); }
.ic-posture-open .ic-posture-label { color: var(--pos); }
.ic-posture-tight { border-left-color: var(--neg); background: color-mix(in srgb, var(--neg) 4%, var(--surface)); }
.ic-posture-tight .ic-posture-label { color: var(--neg); }
.ic-posture-reference { border-left-color: var(--muted); }
.ic-posture-reference .ic-posture-label { color: var(--muted-strong); }
.ic-rules,
.ic-trade-map { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 8px; }
.ic-rules > div,
.ic-trade-map > div {
  display: grid; gap: 5px; padding: 10px 11px; border: 1px solid var(--border); border-radius: var(--r-2); background: var(--surface);
}
.ic-rules span,
.ic-trade-map span {
  color: var(--muted); font: 700 9px/1.2 var(--font-mono); letter-spacing: .07em; text-transform: uppercase;
}
.ic-rules b,
.ic-trade-map b { color: var(--text-strong); font: 650 11px/1.4 var(--font-sans); }
.ic-trade-map > div:first-child { border-left: 3px solid var(--pos); }
.ic-trade-map > div:last-child { border-left: 3px solid var(--neg); }
.ic-decision-grid { display: grid; grid-template-columns: repeat(4, minmax(0, 1fr)); gap: 8px; }
.ic-decision-pillar {
  appearance: none; min-width: 0; display: flex; flex-direction: column; align-items: flex-start; gap: 4px;
  padding: 10px; border: 1px solid var(--border); border-left: 3px solid var(--border-strong); border-radius: var(--r-2);
  background: var(--surface-2); color: var(--text); text-align: left; cursor: pointer;
}
.ic-decision-pillar:hover, .ic-decision-pillar:focus-visible { border-color: var(--accent); background: color-mix(in srgb, var(--accent) 5%, var(--surface-2)); }
.ic-decision-positive { border-left-color: var(--pos); }
.ic-decision-negative { border-left-color: var(--neg); }
.ic-decision-watch { border-left-color: var(--warn); }
.ic-decision-pillar > span { color: var(--muted); font: 700 9px/1 var(--font-mono); letter-spacing: .07em; text-transform: uppercase; }
.ic-decision-pillar > b { max-width: 100%; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; color: var(--text-strong); font: 750 17px/1.15 var(--font-mono); }
.ic-decision-pillar > small { min-height: 26px; color: var(--muted-strong); font: 500 10.5px/1.3 var(--font-sans); }
.ic-decision-pillar > em { margin-top: auto; padding-top: 3px; color: var(--accent); font: 700 9px/1 var(--font-mono); font-style: normal; letter-spacing: .04em; text-transform: uppercase; }
.ic-actions { display: flex; flex-wrap: wrap; gap: 7px; }
.ic-action {
  min-height: 36px; padding: 8px 12px; border: 1px solid var(--border-strong); border-radius: var(--r-pill);
  background: var(--surface); color: var(--text-strong); font: 700 11px/1 var(--font-sans); cursor: pointer;
}
.ic-action:hover, .ic-action:focus-visible { border-color: var(--accent); color: var(--accent); }
.ic-action-primary { border-color: var(--accent); background: var(--accent); color: var(--surface); }
.ic-action-primary:hover, .ic-action-primary:focus-visible { background: color-mix(in srgb, var(--accent) 86%, var(--text-strong)); color: var(--surface); }
.ic-decision-note { margin: 0; color: var(--muted); font: 500 10.5px/1.4 var(--font-sans); }
.ic-empty-desk {
  display: flex; flex-direction: column; align-items: flex-start; gap: 8px; padding: 16px;
  border: 1px dashed var(--border-strong); border-radius: var(--r-3); background: var(--surface-2);
}
.ic-empty-desk h3 { margin: 0; color: var(--text-strong); font: 750 18px/1.25 var(--font-sans); }
.ic-empty-desk p { max-width: 78ch; margin: 0; color: var(--muted); font: 500 12px/1.45 var(--font-sans); }
.ic-section { display: block; padding: 0; overflow: clip; }
.ic-section-summary { min-height: 70px; display: flex; align-items: center; gap: 12px; padding: 12px 14px; list-style: none; cursor: pointer; }
.ic-section-summary::-webkit-details-marker,
.ic-subsection > summary::-webkit-details-marker,
.ic-metric-summary::-webkit-details-marker { display: none; }
.ic-section-summary::before { content: "›"; flex: 0 0 auto; color: var(--accent); font: 750 20px/1 var(--font-mono); transition: transform var(--dur-1); }
.ic-section[open] > .ic-section-summary::before { transform: rotate(90deg); }
.ic-section-summary > span:first-of-type { min-width: 0; display: flex; flex-direction: column; gap: 3px; }
.ic-section-summary > span:first-of-type small { color: var(--muted); font: 700 9px/1 var(--font-mono); letter-spacing: .07em; text-transform: uppercase; }
.ic-section-summary > span:first-of-type b { color: var(--text-strong); font: 750 14px/1.2 var(--font-sans); }
.ic-section-signal { min-width: 0; margin-left: auto; display: flex; flex-direction: column; align-items: flex-end; gap: 3px; text-align: right; }
.ic-section-signal b { max-width: 520px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; color: var(--text-strong); font: 700 12px/1.2 var(--font-mono); }
.ic-section-signal small { color: var(--muted); font: 500 10px/1.2 var(--font-sans); }
.ic-section-body { padding: 12px 14px 14px; border-top: 1px solid var(--hairline); }
.ic-section-stack { display: flex; flex-direction: column; gap: 8px; }
.ic-subsection { border: 1px solid var(--border); border-radius: var(--r-2); overflow: clip; background: var(--surface-2); }
.ic-subsection > summary { min-height: 46px; display: flex; align-items: center; gap: 10px; padding: 9px 11px; list-style: none; cursor: pointer; }
.ic-subsection > summary::before { content: "›"; flex: 0 0 auto; color: var(--accent); font: 750 17px/1 var(--font-mono); transition: transform var(--dur-1); }
.ic-subsection[open] > summary::before { transform: rotate(90deg); }
.ic-subsection > summary span { color: var(--text-strong); font: 700 12px/1.2 var(--font-sans); }
.ic-subsection > summary b { margin-left: auto; color: var(--muted-strong); font: 650 11px/1.2 var(--font-mono); text-align: right; }
.ic-subsection-body { display: flex; flex-direction: column; gap: 9px; padding: 11px; border-top: 1px solid var(--hairline); background: var(--surface); }
.ic-metric-card { display: block; }
.ic-metric-summary { display: flex; flex-direction: column; gap: 8px; list-style: none; cursor: pointer; }
.ic-metric-summary::after { content: "+ Details"; margin-left: auto; color: var(--accent); font: 700 9px/1 var(--font-mono); letter-spacing: .04em; text-transform: uppercase; }
.ic-metric-card[open] > .ic-metric-summary::after { content: "− Details"; }
.ic-metric-body { display: flex; flex-direction: column; gap: 8px; margin-top: 9px; padding-top: 9px; border-top: 1px solid var(--hairline); }
...
.ic-card.ic-section { display: block; padding: 0; }
.ic-card.ic-metric-card { display: block; }
...
.ic-upcoming {
  display: flex; flex-direction: column; gap: 10px; margin-bottom: 14px; padding: 12px;
  border: 1px solid color-mix(in srgb, var(--accent) 24%, var(--border)); border-radius: var(--r-2);
  background: color-mix(in srgb, var(--accent) 3%, var(--surface));
}
.ic-upcoming-head { display: flex; align-items: flex-start; justify-content: space-between; gap: 12px; }
.ic-upcoming-head h3, .ic-upcoming-empty h3 { margin: 4px 0 2px; color: var(--text-strong); font: 750 15px/1.2 var(--font-sans); }
.ic-upcoming-head p, .ic-upcoming-empty p { margin: 0; color: var(--muted); font: 500 11px/1.4 var(--font-sans); }
.ic-upcoming-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(260px, 1fr)); gap: 8px; }
.ic-upcoming-card {
  min-width: 0; display: grid; grid-template-columns: auto minmax(0, 1fr); gap: 8px 12px; padding: 10px;
  border: 1px solid var(--border); border-left: 3px solid var(--accent); border-radius: var(--r-2); background: var(--surface);
}
.ic-upcoming-date { display: flex; flex-direction: column; gap: 2px; }
.ic-upcoming-date span { color: var(--text-strong); font: 750 11px/1.2 var(--font-mono); white-space: nowrap; }
.ic-upcoming-date small { color: var(--accent); font: 700 9px/1.2 var(--font-mono); text-transform: uppercase; }
.ic-upcoming-company { min-width: 0; }
.ic-upcoming-company > div { display: flex; align-items: baseline; gap: 7px; min-width: 0; }
.ic-upcoming-company b { flex: 0 0 auto; color: var(--text-strong); font: 800 14px/1.2 var(--font-mono); }
.ic-upcoming-company span { min-width: 0; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; color: var(--text-strong); font: 650 12px/1.2 var(--font-sans); }
.ic-upcoming-company p { margin: 3px 0 0; color: var(--muted); font: 500 10px/1.3 var(--font-sans); }
.ic-upcoming-terms { grid-column: 1 / -1; display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 7px; }
.ic-upcoming-terms > span { display: flex; flex-direction: column; gap: 3px; padding: 8px; border-radius: var(--r-1); background: var(--surface-2); }
.ic-upcoming-terms small { color: var(--muted); font: 700 8.5px/1.1 var(--font-mono); letter-spacing: .06em; text-transform: uppercase; }
.ic-upcoming-terms b { color: var(--text-strong); font: 750 13px/1.2 var(--font-mono); }
.ic-upcoming-terms sup { color: var(--warn); font-size: 8px; text-transform: uppercase; }
.ic-upcoming-meta { grid-column: 1 / -1; display: flex; flex-wrap: wrap; gap: 8px; color: var(--muted); font: 600 9.5px/1.2 var(--font-mono); }
...
@media (max-width: 820px) {
  .ic-decision-grid { grid-template-columns: repeat(2, minmax(0, 1fr)); }
}
@media (max-width: 640px) {
  .ic-decision { padding: 11px; }
  .ic-decision-head { gap: 9px; }
  .ic-decision-head h3 { font-size: 16px; }
  .ic-decision-badge { padding: 4px 7px; font-size: 9px; }
  .ic-decision-source { align-items: flex-start; flex-direction: column; gap: 3px; }
  .ic-decision-source small { flex: none; }
  .ic-rules, .ic-trade-map { grid-template-columns: minmax(0, 1fr); }
  .ic-decision-grid { display: flex; overflow-x: auto; scroll-snap-type: x proximity; scrollbar-width: none; padding-bottom: 3px; }
  .ic-decision-grid::-webkit-scrollbar { display: none; }
  .ic-decision-pillar { flex: 0 0 min(190px, 63vw); scroll-snap-align: start; }
  .ic-posture { grid-template-columns: 1fr; gap: 5px; padding: 9px 10px; }
  .ic-posture-label { padding-top: 0; }
  .ic-actions { display: grid; grid-template-columns: minmax(0, 1fr); width: 100%; }
  .ic-action { width: 100%; min-height: 42px; }
  .ic-empty-desk { padding: 12px; }
  .ic-empty-desk h3 { font-size: 16px; }
  .ic-empty-desk p { font-size: 11px; }
  .ic-section-summary { min-height: 66px; padding: 10px; gap: 7px; align-items: flex-start; }
  .ic-section-signal { max-width: 48%; }
  .ic-section-signal b { max-width: 100%; white-space: normal; font-size: 10.5px; }
  .ic-section-body { padding: 9px; }
  .ic-upcoming { padding: 9px; }
  .ic-upcoming-head { flex-direction: column; gap: 7px; }
  .ic-upcoming-grid { grid-template-columns: minmax(0, 1fr); }
  .ic-upcoming-card { grid-template-columns: minmax(70px, auto) minmax(0, 1fr); padding: 9px; }
  .ic-upcoming-company > div { align-items: flex-start; flex-direction: column; gap: 2px; }
  .ic-upcoming-company span { max-width: 100%; }
  .ic-subsection > summary { align-items: flex-start; gap: 7px; }
  .ic-subsection > summary b { max-width: 48%; font-size: 10px; }
  .ic-grid { grid-template-columns: minmax(0, 1fr); }
}
...
/* First-paint flow decision queue — freshness/executability, ranked focus,
   confirmation, invalidation and the evidence density behind the read. */
.flow-decision {
  --flow-decision-tone: var(--accent);
  position: relative;
  display: grid;
  ...
  overflow: hidden;
  background:
    linear-gradient(135deg, color-mix(in srgb, var(--flow-decision-tone) 8%, transparent), transparent 48%),
    var(--surface-2);
  border: 1px solid color-mix(in srgb, var(--flow-decision-tone) 30%, var(--border));
  border-radius: var(--r-4);
}
.flow-decision::before {
  ...
  inset: 0 auto 0 0;
  width: 3px;
  background: var(--flow-decision-tone);
}
.flow-decision-call { --flow-decision-tone: var(--pos); }
.flow-decision-put { --flow-decision-tone: var(--neg); }
.flow-decision-mixed { --flow-decision-tone: var(--warn); }
.flow-decision-reference { --flow-decision-tone: var(--muted); }
.flow-decision-empty {
  --flow-decision-tone: var(--muted);
  grid-template-columns: minmax(0, 1fr) auto;
  align-items: center;
}
.flow-decision-main,
.flow-decision-side { min-width: 0; }
.flow-decision-head {
  display: flex;
  align-items: center;
  justify-content: space-between;
...
.flow-decision-head > span,
.flow-decision-empty-copy > span {
  color: var(--flow-decision-tone);
  font-family: var(--font-mono);
  font-size: 10px;
  font-weight: 800;
  letter-spacing: .1em;
...
.flow-decision-main > p,
.flow-decision-empty-copy > p {
  margin: var(--s-2) 0 0;
  color: var(--muted);
  font-size: var(--fs-sm);
  line-height: 1.48;
...
.flow-decision-rules span,
.flow-decision-metrics span {
  display: block;
  color: var(--muted);
  font-family: var(--font-mono);
  font-size: 9px;
...
.flow-decision-source > span {
  color: var(--flow-decision-tone);
  font-size: var(--fs-xs);
  font-weight: 750;
}
.flow-decision-source > small {
  color: var(--muted);
  font-size: 10px;
  line-height: 1.3;
  text-align: right;
}
.flow-decision-metrics {
  display: grid;
  grid-template-columns: repeat(2, minmax(0, 1fr));
  gap: 1px;
  overflow: hidden;
...
.flow-decision-metrics > div {
  min-width: 0;
  padding: 8px 9px;
  background: var(--surface);
}
.flow-decision-metrics b {
  display: block;
  margin-top: 3px;
  overflow: hidden;
  color: var(--text-strong);
...
.flow-decision-context {
  margin: 0;
  color: var(--muted);
  font-size: 11px;
  line-height: 1.38;
}
.flow-decision-context b { color: var(--text); }
...
.flow-decision-action:hover {
  color: var(--text-strong);
  background: var(--surface-3);
  border-color: var(--border-strong);
}
.flow-decision-action.is-primary {
  color: var(--surface);
  background: var(--flow-decision-tone);
  border-color: var(--flow-decision-tone);
}
.flow-decision-reference .flow-decision-action.is-primary,
.flow-decision-empty .flow-decision-action.is-primary {
  color: var(--text);
  background: var(--surface-3);
  border-color: var(--border-strong);
}
.flow-decision-action:focus-visible { outline: none; box-shadow: var(--focus-ring); }
.flow-decision-empty-copy h3 { margin-top: 5px; }
...
.flow-ats {
  ...
  gap: 6px;
  padding: 6px 8px;
  border: 1px dashed color-mix(in srgb, var(--violet) 34%, var(--border));
  border-radius: var(--r-2);
  background: color-mix(in srgb, var(--violet) 4%, var(--surface-1));
}
.flow-ats-tag {
  flex: 0 0 auto;
  padding: 3px 7px;
...
.flow-ats-metric b { color: var(--text-strong); font-family: var(--font-mono); font-variant-numeric: tabular-nums; }
.flow-ats-metric small { color: var(--text-3); }
.flow-ats-metric.is-pos b { color: var(--up); }
.flow-ats-metric.is-neg b { color: var(--dn); }
@media (max-width: 640px){
  .flow-gex-label { display: none; }
  .flow-gex { gap: 4px; }
  .flow-gex-metric { padding: 2px 7px; }
  .flow-ats { align-items: stretch; }
  .flow-ats-tag { width: 100%; text-align: center; }
  .flow-ats-metric { flex: 1 1 130px; flex-direction: column; align-items: flex-start; }
}
.flow-contracts {
  display: flex;
  flex-wrap: wrap;
...
.opt-live[hidden], .opt-live-refresh[hidden] { display: none; }
...
.opt-social-stat { font-size: 12px; color: var(--muted); }
.opt-social-stale {
  display: inline-flex;
  margin-left: 5px;
  padding: 2px 6px;
...
.opt-social-history {
  ...
  background:
    linear-gradient(to bottom,
      color-mix(in srgb, var(--pos) 5%, transparent) 0 50%,
      color-mix(in srgb, var(--neg) 5%, transparent) 50% 100%);
}
.opt-social-history-head,
.opt-social-history-axis {
  display: flex;
  justify-content: space-between;
  gap: 8px;
  color: var(--muted);
...
.opt-social-history-head span:last-child { color: var(--text); }
.opt-social-history.bullish .opt-social-history-head span:last-child { color: var(--pos); }
.opt-social-history.bearish .opt-social-history-head span:last-child { color: var(--neg); }
.opt-social-history svg {
  display: block;
  width: 100%;
  height: 96px;
  margin: 2px 0;
...
.opt-social-history.bullish .opt-social-history-line { stroke: var(--pos); }
.opt-social-history.bearish .opt-social-history-line { stroke: var(--neg); }
.opt-social-history-axis span:nth-child(2) { margin-left: auto; margin-right: auto; }
.opt-social-collecting {
  padding: 9px 10px;
...
.opt-social-sources { font-size: 12px; color: var(--muted); }
.opt-social-source-grid {
  display: grid;
...
.opt-social-source-name a { color: inherit; text-decoration: none; }
.opt-social-source-name a:hover { color: var(--accent); }
...
.opt-social-feed > summary::-webkit-details-marker { display: none; }
.opt-social-feed > summary::after {
  content: "⌄";
  color: var(--muted);
  transition: transform .16s var(--ease-out);
}
.opt-social-feed:not([open]) > summary::after { transform: rotate(-90deg); }
.opt-social-feed > summary span {
  margin-left: auto;
  color: var(--muted);
...
.opt-social-example.bullish { border-left-color: color-mix(in srgb, var(--pos) 55%, transparent); }
.opt-social-example.bearish { border-left-color: color-mix(in srgb, var(--neg) 55%, transparent); }
...
.opt-social-example > a.opt-social-ex-body { color: var(--text); text-decoration: none; }
.opt-social-example > a.opt-social-ex-body:hover { color: var(--accent); text-decoration: underline; }
.opt-social-ex-meta {
...
@media (max-width: 600px) {
  .opt-social { padding: 10px; }
  .opt-social-head { display: grid; gap: 3px; }
  .opt-social-stat { line-height: 1.4; }
  .opt-social-read { align-items: flex-start; gap: 6px 9px; }
  .opt-social-read > span:last-child { width: 100%; }
  .opt-social-history svg { height: 82px; }
  .opt-social-source-grid { grid-template-columns: 1fr; }
  .opt-social-source-head { display: grid; gap: 5px; }
  .opt-social-example {
...
.opt-exec-next {
  ...
  background: var(--accent-soft);
  color: var(--accent);
  font: 750 11px/1.2 var(--font-sans);
  cursor: pointer;
}
.opt-exec-next:hover { border-color: var(--accent); background: color-mix(in srgb, var(--accent) 16%, transparent); }
.opt-exec-next:focus-visible { outline: none; box-shadow: var(--elev-focus); }
...
.opt-exec-explainer summary::-webkit-details-marker { display: none; }
.opt-exec-explainer summary::after { content: '+'; float: right; color: var(--muted); font-size: 15px; line-height: 1; }
.opt-exec-explainer[open] summary::after { content: '−'; color: var(--accent); }
.opt-exec-explainer-body { padding: 0 11px 10px; }
...
.tip:hover::after, .tip:focus-visible::after, .tip.is-open::after { display: block; opacity: 1; visibility: visible; }
...
.cal-detail { scroll-margin-top: 74px; }
.cal-detail .cal-day { border-top: none; padding-top: 0; }
.cal-focus {
  padding: 12px 14px;
  border: 1px solid color-mix(in srgb, var(--accent) 24%, var(--border));
  border-radius: var(--r-3);
  background: linear-gradient(135deg, color-mix(in srgb, var(--accent) 5%, var(--surface-2)), var(--surface-2) 55%);
}
.cal-focus-head {
  display: flex;
  align-items: baseline;
...
.cal-focus-head small { font: 500 11px/1.2 var(--font-sans); color: var(--muted); }
.cal-focus .cal-day { grid-template-columns: 112px minmax(0, 1fr); padding-bottom: 0; }
.cal-focus .cal-detail-empty { padding: var(--s-2); }
.cal-detail-empty {
  padding: var(--s-4);
  border: 1px dashed var(--border);
  border-radius: var(--r-2);
...
.fomc-vote-head h3 { margin: 0; font: 700 14px/1.25 var(--font-serif); color: var(--text-strong); }
.fomc-vote-head-counts, .fomc-vote-mini-counts {
  display: flex;
  align-items: center;
  flex-wrap: wrap;
  gap: 5px;
...
.fomc-vote-count b { font: inherit; }
.fomc-vote-count.is-hawk { color: var(--neg); background: color-mix(in srgb, var(--neg) 8%, var(--surface)); }
.fomc-vote-count.is-hold { color: var(--warn); background: color-mix(in srgb, var(--warn) 8%, var(--surface)); }
.fomc-vote-count.is-dove { color: var(--pos); background: color-mix(in srgb, var(--pos) 8%, var(--surface)); }
.fomc-vote-history {
  margin-top: 10px;
  border-top: 1px solid var(--hairline);
  padding-top: 7px;
}
.fomc-vote-history > summary {
  min-height: 38px;
  display: flex;
  align-items: center;
  justify-content: space-between;
...
.fomc-vote-history > summary::-webkit-details-marker,
.fomc-vote-meeting > summary::-webkit-details-marker { display: none; }
.fomc-vote-history > summary > span:first-child {
  display: flex;
  flex-direction: column;
  gap: 2px;
  min-width: 0;
}
.fomc-vote-history > summary b { font: 700 12px/1.2 var(--font-sans); color: var(--text); }
.fomc-vote-history > summary small { font: 500 11px/1.3 var(--font-sans); color: var(--muted); }
.fomc-vote-history > summary > span:last-child {
  flex: none;
  font: 700 10px/1 var(--font-mono);
  letter-spacing: .05em;
  text-transform: uppercase;
...
.fomc-vote-history-body { display: grid; gap: 7px; padding-top: 7px; }
.fomc-vote-meeting {
  border: 1px solid var(--hairline);
  border-radius: var(--r-2);
  background: var(--surface-2);
}
.fomc-vote-meeting > summary {
  min-height: 44px;
  display: flex;
  align-items: center;
  gap: 8px;
...
.fomc-vote-meeting-main b { font: 700 12px/1.2 var(--font-sans); color: var(--text); }
.fomc-vote-meeting-main small { font: 600 10px/1.2 var(--font-mono); color: var(--muted); text-transform: uppercase; letter-spacing: .04em; }
.fomc-vote-mini-counts .fomc-vote-count { padding: 3px 6px; font-size: 10px; }
.fomc-vote-switch-badge {
  flex: none;
  padding: 3px 6px;
  border-radius: var(--r-pill);
  background: color-mix(in srgb, var(--accent) 10%, transparent);
...
.fomc-vote-group { display: grid; grid-template-columns: 82px minmax(0, 1fr); gap: 8px; align-items: start; }
.fomc-vote-group-label {
  padding-top: 3px;
...
.fomc-vote-group.is-hawk .fomc-vote-group-label { color: var(--neg); }
.fomc-vote-group.is-hold .fomc-vote-group-label { color: var(--warn); }
.fomc-vote-group.is-dove .fomc-vote-group-label { color: var(--pos); }
.fomc-vote-names { display: flex; flex-wrap: wrap; gap: 4px; min-width: 0; }
.fomc-voter-name {
  padding: 3px 6px;
  border: 1px solid var(--hairline);
  border-radius: var(--r-pill);
...
.fomc-voter-name.is-dissent { border-style: dashed; font-weight: 650; }
.fomc-voter-name.is-pending { color: var(--muted); font-style: italic; }
.fomc-vote-switches { display: flex; flex-wrap: wrap; gap: 5px; padding-top: 7px; border-top: 1px solid var(--hairline); }
.fomc-vote-switches > b { width: 100%; font: 700 10px/1 var(--font-mono); letter-spacing: .05em; text-transform: uppercase; color: var(--muted); }
.fomc-vote-switch {
  padding: 4px 7px;
  border-radius: var(--r-pill);
...
.fomc-vote-no-switch, .fomc-vote-pending { margin: 0; font-size: 11px; line-height: 1.4; color: var(--muted); }
.fomc-vote-source { width: max-content; max-width: 100%; color: var(--accent-strong); font: 600 11px/1.3 var(--font-sans); text-decoration: none; }
.fomc-vote-source:hover { text-decoration: underline; }
.fomc-vote-method { margin: 9px 0 0; font-size: 11px; line-height: 1.45; color: var(--muted); }
.fomc-vote-method b { color: var(--text); }
.fomc-details {
  border-top: 1px solid var(--hairline);
  padding-top: var(--s-2);
}
.fomc-details > summary {
  min-height: 42px;
  display: flex;
  align-items: center;
  justify-content: space-between;
...
.fomc-details > summary::-webkit-details-marker { display: none; }
.fomc-details > summary > span:first-child { display: flex; flex-direction: column; gap: 3px; min-width: 0; }
.fomc-details > summary b { font: 700 13px/1.2 var(--font-sans); color: var(--text-strong); }
.fomc-details > summary small { font: 500 11px/1.35 var(--font-sans); color: var(--muted); }
.fomc-details-action {
  display: inline-flex;
  align-items: center;
  gap: 6px;
...
.fomc-details-action::after { content: '›'; font-size: 17px; line-height: .8; transition: transform var(--dur-1); }
.fomc-details[open] .fomc-details-action::after { transform: rotate(90deg); }
.fomc-details[open] .fomc-details-action { color: var(--text); }
.fomc-details-body { padding-top: var(--s-3); }
...
.f13-source.is-partial {
  border-color: color-mix(in srgb, var(--warn) 36%, var(--border));
  background: color-mix(in srgb, var(--warn-soft) 40%, var(--surface-2));
}
.f13-source p { margin: 0; line-height: 1.45; }
.f13-source-status {
  flex: 0 0 auto;
  padding: 3px 7px;
  border: 1px solid color-mix(in srgb, var(--pos) 35%, var(--border));
  border-radius: var(--r-pill);
  color: var(--pos);
  background: var(--pos-soft);
...
.f13-source.is-partial .f13-source-status {
  color: var(--warn);
...
.f13-desk {
  ...
  border: 1px solid color-mix(in srgb, var(--accent) 30%, var(--border));
  border-radius: var(--r-3);
  background: linear-gradient(135deg, color-mix(in srgb, var(--accent) 6%, var(--surface)), var(--surface) 58%);
}
.f13-desk-head { display: flex; align-items: flex-start; justify-content: space-between; gap: 18px; }
.f13-desk-head > div { min-width: 0; max-width: 760px; }
...
.f13-coverage b { font: 800 18px/1 var(--font-mono); color: var(--text-strong); }
.f13-coverage small { font: 650 9px/1.25 var(--font-sans); letter-spacing: .05em; text-transform: uppercase; color: var(--muted); }
.f13-signal-grid { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 10px; }
.f13-signal-card {
  display: flex;
  min-width: 0;
  flex-direction: column;
...
.f13-signal-buy { border-left-color: var(--pos); background: color-mix(in srgb, var(--pos-soft) 44%, var(--surface-2)); }
.f13-signal-sell { border-left-color: var(--neg); background: color-mix(in srgb, var(--neg-soft) 44%, var(--surface-2)); }
.f13-signal-card header { display: flex; align-items: center; justify-content: space-between; gap: 10px; }
.f13-signal-card header span { color: var(--muted); font: 750 9px/1.2 var(--font-mono); letter-spacing: .07em; text-transform: uppercase; }
.f13-signal-card header b {
  flex: 0 0 auto;
  padding: 3px 7px;
  border: 1px solid var(--border);
  border-radius: var(--r-pill);
...
.f13-signal-main { display: flex; align-items: baseline; gap: 9px; min-width: 0; }
.f13-signal-symbol { flex: 0 0 auto; color: var(--text-strong); font: 800 19px/1 var(--font-mono); }
.f13-signal-issuer { min-width: 0; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; color: var(--muted-strong); font: 550 12px/1.25 var(--font-sans); }
.f13-signal-metrics { display: flex; align-items: baseline; flex-wrap: wrap; gap: 5px 12px; }
.f13-signal-metrics strong { font: 750 13px/1.2 var(--font-mono); }
.f13-signal-metrics span { color: var(--muted); font: 600 11px/1.2 var(--font-mono); }
.f13-signal-buy .f13-signal-metrics strong { color: var(--pos); }
...
.f13-desk-sell { border-left: 3px solid var(--neg); }
.f13-desk-side-head { display: flex; align-items: center; justify-content: space-between; gap: 8px; padding: 8px 10px; border-bottom: 1px solid var(--hairline); }
.f13-desk-side-head span { font: 750 10px/1 var(--font-mono); letter-spacing: .08em; text-transform: uppercase; color: var(--text-strong); }
.f13-desk-side-head small { font: 600 9px/1 var(--font-sans); text-transform: uppercase; letter-spacing: .05em; color: var(--muted); }
.f13-desk-row {
  display: grid;
...
.f13-desk-row:last-child { border-bottom: 0; }
.f13-desk-symbol { font: 750 13px/1 var(--font-mono); color: var(--text-strong); }
.f13-desk-issuer { min-width: 0; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; font: 500 12px/1.2 var(--font-sans); color: var(--muted-strong); }
.f13-desk-row b { font: 700 12px/1 var(--font-mono); color: var(--text-strong); font-variant-numeric: tabular-nums; }
.f13-desk-row small { min-width: 42px; text-align: right; font: 600 10px/1 var(--font-mono); color: var(--muted); }
.f13-desk-buy .f13-desk-row b { color: var(--pos); }
.f13-desk-sell .f13-desk-row b { color: var(--neg); }
.f13-lag-note { margin: 0; font: 500 11px/1.45 var(--font-sans); color: var(--muted); }
.f13-lag-note strong { color: var(--warn); }
.f13-disclosure {
  border: 1px solid var(--border);
  border-radius: var(--r-2);
  background: var(--surface-2);
...
.f13-disclosure[open] { border-color: color-mix(in srgb, var(--accent) 30%, var(--border)); }
.f13-disclosure > summary {
  min-height: 48px;
  display: flex;
  align-items: center;
  justify-content: space-between;
...
.f13-disclosure > summary::-webkit-details-marker { display: none; }
.f13-disclosure > summary::before { content: '›'; flex: 0 0 auto; color: var(--accent); font-size: 18px; line-height: 1; transition: transform var(--dur-1); }
.f13-disclosure[open] > summary::before { transform: rotate(90deg); }
.f13-disclosure > summary > span:first-of-type { display: flex; flex-direction: column; gap: 3px; min-width: 0; flex: 1; }
.f13-disclosure > summary b { font: 700 13px/1.2 var(--font-sans); color: var(--text-strong); }
.f13-disclosure > summary small { font: 500 11px/1.3 var(--font-sans); color: var(--muted); }
.f13-disclosure-count { flex: 0 0 auto; padding: 3px 7px; border: 1px solid var(--border); border-radius: 999px; font: 650 10px/1 var(--font-mono); color: var(--muted-strong); white-space: nowrap; }
.f13-disclosure-body { display: flex; flex-direction: column; gap: var(--s-2); padding: 10px 12px 12px; border-top: 1px solid var(--hairline); background: var(--surface); }
.f13-block {
  display: flex;
  flex-direction: column;
  gap: var(--s-2);
...
@media (max-width: 640px) {
  ...
  .f13-desk-row b { justify-self: end; }
  .f13-disclosure > summary { align-items: flex-start; gap: 8px; padding: 9px 10px; }
  .f13-disclosure-count { margin-top: 1px; }
  .f13-disclosure-body { padding: 9px; }
}
...
.f4-desk {
  ...
  border-radius: var(--r-3);
  background: linear-gradient(145deg, color-mix(in srgb, var(--violet) 5%, var(--surface)), var(--surface));
}
.f4-head { display: flex; align-items: flex-start; justify-content: space-between; gap: 14px; }
.f4-head h3 { margin: 3px 0 5px; color: var(--text-strong); font-size: 20px; }
.f4-head p { margin: 0; max-width: 780px; color: var(--text-2); font-size: 13px; line-height: 1.5; }
.f4-grid { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 10px; }
.f4-side {
  min-width: 0;
  overflow: hidden;
  border: 1px solid var(--border);
...
.f4-side > header small { color: var(--muted); font-size: 10px; font-weight: 600; text-transform: uppercase; letter-spacing: .04em; }
.f4-side-buy > header { box-shadow: inset 3px 0 0 var(--up); }
.f4-side-sell > header { box-shadow: inset 3px 0 0 var(--dn); }
.f4-row { display: flex; flex-direction: column; gap: 5px; padding: 9px 10px; border-top: 1px solid var(--hairline); }
.f4-side > header + .f4-row { border-top: 0; }
.f4-row-top { display: grid; grid-template-columns: auto minmax(0, 1fr) auto; align-items: baseline; gap: 8px; }
.f4-row-top b { overflow: hidden; color: var(--text-strong); text-overflow: ellipsis; white-space: nowrap; }
.f4-row-top time { color: var(--muted); font: 600 11px/1 var(--font-mono); }
.f4-row-metrics { display: flex; flex-wrap: wrap; gap: 6px 10px; color: var(--text-2); font: 600 12px/1.25 var(--font-mono); }
.f4-buy .f4-row-metrics strong { color: var(--up); }
.f4-sell .f4-row-metrics strong { color: var(--dn); }
.f4-row > small { color: var(--muted); font-size: 10px; line-height: 1.3; }
.f4-none { margin: 0; padding: 16px 10px; color: var(--muted); font-size: 12px; }
.f4-all { border-top: 1px solid var(--hairline); padding-top: 10px; }
.f4-all > summary { cursor: pointer; color: var(--text-strong); font-weight: 700; }
.f4-all > summary span { margin-left: 5px; color: var(--muted); font-family: var(--font-mono); }
.f4-table { margin-top: 10px; min-width: 760px; }
.f4-table a { color: var(--accent-strong); text-decoration: underline; text-underline-offset: 2px; }
.f4-other-row { color: var(--muted); }
@media (max-width: 760px){
  .f4-head { flex-direction: column; }
  .f4-grid { grid-template-columns: minmax(0, 1fr); }
}
@media (max-width: 480px){
  .f4-desk { padding: 10px; }
  .f4-row-top { grid-template-columns: auto minmax(0, 1fr); }
  .f4-row-top time { grid-column: 2; }
}
...
.market-action { margin: 0 0 var(--s-4); }
.market-action[hidden] { display: none; }
.market-action-card {
  overflow: hidden;
  border: 1px solid var(--border);
  border-left: 3px solid var(--border-strong);
  border-radius: var(--r-4);
  background: linear-gradient(145deg, color-mix(in srgb, var(--text) 3%, var(--surface)), var(--surface-2));
  box-shadow: var(--elev-1);
}
.market-action-on { border-left-color: var(--pos); }
.market-action-off { border-left-color: var(--neg); }
.market-action-warn { border-left-color: var(--warn); }
.market-action-head {
  display: flex;
  align-items: flex-start;
  justify-content: space-between;
...
.market-action-kicker,
.market-action-grid small,
.market-action-why small {
  display: block;
  color: var(--muted);
...
.market-action-head h3 {
  margin: 5px 0 6px;
  color: var(--text-strong);
  font-size: var(--fs-xl);
  line-height: var(--lh-tight);
}
.market-action-on .market-action-head h3 { color: var(--pos); }
.market-action-off .market-action-head h3 { color: var(--neg); }
.market-action-warn .market-action-head h3 { color: var(--warn); }
.market-action-head p {
  max-width: 88ch;
  margin: 0;
  color: var(--text);
  font-size: var(--fs-sm);
...
.market-action-head p b { color: var(--text-strong); }
...
.market-action-source.is-live { color: var(--pos); border-color: color-mix(in srgb, var(--pos) 40%, var(--border)); }
.market-action-grid {
  display: grid;
  grid-template-columns: repeat(4, minmax(0, 1fr));
  border-bottom: 1px solid var(--border);
}
.market-action-grid > span {
  min-width: 0;
  padding: var(--s-3) var(--s-4);
  border-right: 1px solid var(--border);
}
.market-action-grid > span:last-child { border-right: 0; }
.market-action-grid b {
  display: block;
  margin-top: 5px;
  color: var(--text-strong);
  font-size: var(--fs-sm);
...
.market-action-grid b.picks-summary-call { color: var(--pos); }
.market-action-grid b.picks-summary-put { color: var(--neg); }
.market-action-grid b.picks-summary-warn { color: var(--warn); }
.market-action-why {
  display: grid;
  grid-template-columns: repeat(2, minmax(0, 1fr));
  gap: var(--s-3);
...
.market-action-why span b,
.market-action-why span i { color: var(--text); }
.market-action-foot {
  display: flex;
  align-items: center;
  justify-content: space-between;
...
.market-action-foot > span { color: var(--muted); font-size: var(--fs-xs); line-height: var(--lh-snug); }
.market-action-foot > span b { color: var(--text-strong); }
.market-action-foot > div { display: flex; flex-wrap: wrap; justify-content: flex-end; gap: var(--s-2); }
.market-action-foot button {
  padding: 8px 11px;
  border: 1px solid var(--border-strong);
  border-radius: var(--r-2);
  background: var(--surface);
  color: var(--text);
  font: 700 var(--fs-2xs)/1 var(--font-sans);
  cursor: pointer;
  white-space: nowrap;
}
.market-action-foot button:first-child { border-color: var(--accent); background: var(--accent-tint-1); }
.market-action-foot button:hover,
.market-action-foot button:focus-visible { border-color: var(--accent); background: var(--accent-tint-2); outline: none; }
@media (max-width: 760px) {
  .market-action-head { padding: var(--s-3); flex-direction: column; gap: var(--s-2); }
  .market-action-source { align-self: flex-start; }
  .market-action-grid { grid-template-columns: repeat(2, minmax(0, 1fr)); }
  .market-action-grid > span:nth-child(2) { border-right: 0; }
  .market-action-grid > span:nth-child(-n+2) { border-bottom: 1px solid var(--border); }
  .market-action-why { grid-template-columns: 1fr; padding: var(--s-3); }
  .market-action-foot { align-items: stretch; flex-direction: column; padding: var(--s-3); }
  .market-action-foot > div { display: grid; grid-template-columns: repeat(3, minmax(0, 1fr)); justify-content: stretch; }
  .market-action-foot button { min-width: 0; white-space: normal; }
}
@media (max-width: 430px) {
  .market-action-head h3 { font-size: var(--fs-lg); }
  .market-action-head p { font-size: var(--fs-xs); }
  .market-action-grid > span { padding: 9px; }
  .market-action-grid b { font-size: var(--fs-xs); }
  .market-action-foot > div { grid-template-columns: 1fr; }
}

/* --- Forward scenario + sensitivity engine ----------------------------- */
.market-scenario-engine { margin: 0 0 var(--s-4); min-width: 0; }
.market-scenario-engine[hidden] { display: none; }
.scenario-shell {
  min-width: 0; overflow: hidden;
  border: 1px solid var(--border); border-left: 3px solid var(--accent);
  border-radius: var(--r-3);
  background: linear-gradient(150deg, color-mix(in srgb, var(--accent) 4%, var(--surface)), var(--surface-2));
  box-shadow: var(--elev-1);
}
.market-scenario-engine.is-fragile .scenario-shell { border-left-color: var(--neg); }
.market-scenario-engine.is-watch .scenario-shell { border-left-color: var(--warn); }
.scenario-head {
...
.scenario-kicker,
.scenario-section > header small,
.scenario-driver > header small,
.scenario-path summary small,
.scenario-transition small,
.scenario-shocks small,
.scenario-controls label > span,
.scenario-basket header small,
.scenario-basket-result small {
  display: block; color: var(--muted);
  font: 700 var(--fs-2xs)/1.2 var(--font-mono);
  letter-spacing: var(--ls-caps); text-transform: uppercase;
}
.scenario-head h3 { margin: 6px 0; color: var(--text-strong); font-size: var(--fs-xl); line-height: var(--lh-tight); }
.scenario-head p { max-width: 85ch; margin: 0; color: var(--muted-strong); font-size: var(--fs-sm); line-height: var(--lh-snug); }
.scenario-head > em { flex: none; color: var(--muted); font: 600 var(--fs-2xs)/1.2 var(--font-mono); font-style: normal; white-space: nowrap; }
.scenario-transition { display: grid; grid-template-columns: repeat(4, minmax(0, 1fr)); border-bottom: 1px solid var(--border); }
.scenario-transition > span { min-width: 0; padding: var(--s-3) var(--s-4); border-right: 1px solid var(--border); }
.scenario-transition > span:last-child { border-right: 0; }
.scenario-transition b { display: block; margin-top: 7px; color: var(--text-strong); font: 800 var(--fs-xl)/1 var(--font-mono); }
.scenario-transition em { display: block; margin-top: 5px; color: var(--muted); font-size: var(--fs-2xs); font-style: normal; }
.scenario-transition b.pos { color: var(--pos); }
.scenario-transition b.neg { color: var(--neg); }
.scenario-warnings {
...
.scenario-warnings > header { grid-column: 1 / -1; display: flex; align-items: center; justify-content: space-between; gap: var(--s-3); }
.scenario-warnings > header b { color: var(--text-strong); font-size: var(--fs-sm); }
.scenario-warnings > header span { color: var(--muted); font: 600 var(--fs-2xs)/1 var(--font-mono); }
.scenario-warnings > span {
  min-width: 0; display: flex; align-items: flex-start; gap: 7px; padding: 8px 9px;
  border: 1px solid var(--border); border-radius: var(--r-2); background: var(--surface);
  color: var(--muted-strong); font-size: var(--fs-xs); line-height: 1.35; overflow-wrap: anywhere;
}
.scenario-warnings i { flex: 0 0 7px; width: 7px; height: 7px; margin-top: 4px; border-radius: 50%; background: var(--muted); }
.scenario-warnings > span.is-warning { color: var(--text); border-color: color-mix(in srgb, var(--warn) 40%, var(--border)); }
.scenario-warnings > span.is-warning i { background: var(--warn); box-shadow: 0 0 0 3px color-mix(in srgb, var(--warn) 15%, transparent); }
.scenario-axis-velocity {
  display: grid; grid-template-columns: repeat(8, minmax(0, 1fr)); gap: 5px;
  padding: var(--s-3) var(--s-4); border-bottom: 1px solid var(--border);
}
.scenario-axis-velocity > header {
  grid-column: 1 / -1; display: flex; align-items: center; justify-content: space-between; gap: var(--s-3);
  margin-bottom: 2px;
}
.scenario-axis-velocity > header b { color: var(--text-strong); font-size: var(--fs-sm); }
.scenario-axis-velocity > header span { color: var(--muted); font: 600 var(--fs-2xs)/1 var(--font-mono); }
.scenario-axis-velocity > span {
  min-width: 0; padding: 7px; border: 1px solid var(--border); border-radius: var(--r-1); background: var(--surface);
}
.scenario-axis-velocity small { display: block; color: var(--muted); font-size: 9px; line-height: 1.2; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
.scenario-axis-velocity b { display: block; margin-top: 5px; color: var(--text-strong); font: 800 var(--fs-xs)/1 var(--font-mono); }
.scenario-axis-velocity em { display: block; margin-top: 4px; color: var(--muted); font: 600 9px/1.2 var(--font-mono); font-style: normal; white-space: nowrap; }
.scenario-axis-velocity > span.is-deteriorating { border-color: color-mix(in srgb, var(--neg) 38%, var(--border)); }
.scenario-axis-velocity > span.is-deteriorating b { color: var(--neg); }
.scenario-axis-velocity > span.is-improving { border-color: color-mix(in srgb, var(--pos) 38%, var(--border)); }
.scenario-axis-velocity > span.is-improving b { color: var(--pos); }
.scenario-section { min-width: 0; padding: var(--s-4); border-bottom: 1px solid var(--border); }
.scenario-section > header,
.scenario-basket > header { display: flex; align-items: flex-end; justify-content: space-between; gap: var(--s-3); margin-bottom: var(--s-3); }
.scenario-section > header h4,
.scenario-basket header h4 { margin: 4px 0 0; color: var(--text-strong); font-size: var(--fs-base); line-height: var(--lh-tight); }
.scenario-section > header > span,
.scenario-basket > header > span { color: var(--muted); font-size: var(--fs-2xs); text-align: right; }
.scenario-catalysts { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 8px; }
.scenario-catalyst {
  min-width: 0; padding: 10px 11px; border: 1px solid var(--border);
  border-left: 3px solid var(--border-strong); border-radius: var(--r-2); background: var(--surface);
}
.scenario-catalyst.is-i5 { border-left-color: var(--neg); }
.scenario-catalyst.is-i4 { border-left-color: var(--warn); }
.scenario-catalyst > header { display: flex; align-items: center; justify-content: space-between; gap: 8px; }
.scenario-catalyst time { color: var(--text-strong); font: 700 var(--fs-xs)/1 var(--font-mono); }
.scenario-catalyst header span { color: var(--muted); font: 600 var(--fs-2xs)/1 var(--font-mono); }
.scenario-catalyst h4 { margin: 7px 0 4px; color: var(--text-strong); font-size: var(--fs-sm); line-height: 1.3; overflow-wrap: anywhere; }
.scenario-catalyst h4 button,
.scenario-exposures button,
.scenario-sens-row { appearance: none; border: 0; background: transparent; color: inherit; font: inherit; cursor: pointer; }
.scenario-catalyst h4 button { padding: 0; color: var(--accent); font-family: var(--font-mono); font-weight: 800; }
.scenario-catalyst p { margin: 0; color: var(--muted); font-size: var(--fs-xs); line-height: 1.35; }
.scenario-catalyst > small { display: block; margin-top: 7px; color: var(--muted); font-size: var(--fs-2xs); line-height: 1.4; }
.scenario-catalyst > small b { color: var(--muted-strong); }
.scenario-tabs {
  display: flex; gap: 6px; margin-bottom: var(--s-3); padding-bottom: 3px;
  overflow-x: auto; overscroll-behavior-inline: contain; scrollbar-width: thin;
}
.scenario-tab {
  appearance: none; flex: 0 0 min(240px, 72vw); min-width: 0;
  display: flex; align-items: flex-start; justify-content: space-between; gap: 9px;
  padding: 9px 10px; border: 1px solid var(--border); border-radius: var(--r-2);
  background: var(--surface); color: var(--muted-strong); text-align: left; cursor: pointer;
}
.scenario-tab:hover,
.scenario-tab:focus-visible,
.scenario-tab.active { border-color: var(--accent); background: var(--accent-tint-1); outline: none; }
.scenario-tab.active { color: var(--text-strong); box-shadow: inset 0 0 0 1px color-mix(in srgb, var(--accent) 24%, transparent); }
.scenario-tab span { min-width: 0; font-size: var(--fs-xs); font-weight: 700; line-height: 1.3; }
.scenario-tab b { flex: none; color: var(--accent); font: 700 var(--fs-2xs)/1.2 var(--font-mono); white-space: nowrap; }
.scenario-driver { min-width: 0; padding: var(--s-3); border: 1px solid var(--border); border-radius: var(--r-3); background: color-mix(in srgb, var(--surface) 86%, transparent); }
.scenario-driver > header { display: flex; align-items: flex-start; justify-content: space-between; gap: var(--s-4); }
.scenario-driver > header h4 { margin: 5px 0; color: var(--text-strong); font-size: var(--fs-lg); line-height: 1.25; }
.scenario-driver > header p { margin: 0; color: var(--muted); font-size: var(--fs-xs); }
.scenario-driver > header strong { flex: none; color: var(--accent); font: 800 var(--fs-lg)/1 var(--font-mono); text-align: right; }
.scenario-driver > header strong small { display: block; margin-top: 5px; color: var(--muted); font: 600 var(--fs-2xs)/1 var(--font-mono); }
.scenario-analog { margin: var(--s-3) 0; padding: 9px 10px; border-radius: var(--r-2); background: var(--surface-2); color: var(--muted); font-size: var(--fs-xs); line-height: 1.45; }
.scenario-analog b { color: var(--text-strong); }
.scenario-paths { display: grid; gap: 7px; }
.scenario-path { min-width: 0; overflow: hidden; border: 1px solid var(--border); border-radius: var(--r-2); background: var(--surface); }
.scenario-path summary { display: flex; align-items: center; justify-content: space-between; gap: var(--s-3); padding: 10px 11px; cursor: pointer; list-style: none; }
.scenario-path summary::-webkit-details-marker { display: none; }
.scenario-path summary b { display: block; margin-top: 4px; color: var(--text-strong); font-size: var(--fs-sm); }
.scenario-path summary em { flex: none; color: var(--accent); font: 750 var(--fs-xs)/1.1 var(--font-mono); font-style: normal; text-align: right; }
.scenario-path summary em small { display: block; margin-top: 4px; color: var(--muted); font: 600 var(--fs-2xs)/1 var(--font-mono); }
.scenario-path-body { padding: 0 11px 11px; border-top: 1px solid var(--border); }
.scenario-path-body p { margin: 10px 0 7px; color: var(--muted-strong); font-size: var(--fs-xs); line-height: 1.45; }
.scenario-path-body p b { color: var(--text-strong); }
.scenario-path-body ul { margin: 0 0 9px; padding-left: 18px; color: var(--muted); font-size: var(--fs-xs); line-height: 1.45; }
.scenario-shocks { display: flex; flex-wrap: wrap; gap: 5px; }
.scenario-shocks span { padding: 6px 7px; border: 1px solid var(--border); border-radius: var(--r-1); background: var(--surface-2); }
.scenario-shocks b { display: block; margin-top: 3px; color: var(--text); font: 700 var(--fs-2xs)/1 var(--font-mono); }
.scenario-exposures { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 8px; margin-top: var(--s-3); }
.scenario-exposures section { min-width: 0; padding: 9px; border: 1px solid var(--border); border-radius: var(--r-2); background: var(--surface-2); }
.scenario-exposures section > header { display: flex; align-items: center; justify-content: space-between; gap: 8px; margin-bottom: 5px; }
.scenario-exposures header b { color: var(--text-strong); font-size: var(--fs-xs); }
.scenario-exposures header span { color: var(--muted); font-size: var(--fs-2xs); }
.scenario-exposures button { width: 100%; display: flex; align-items: center; justify-content: space-between; gap: 8px; padding: 6px; border-radius: var(--r-1); text-align: left; }
.scenario-exposures button:hover { background: var(--accent-tint-1); }
.scenario-exposures button span { min-width: 0; display: flex; align-items: baseline; gap: 7px; }
.scenario-exposures button b { color: var(--text-strong); font: 750 var(--fs-xs)/1 var(--font-mono); }
.scenario-exposures button small { min-width: 0; color: var(--muted); font-size: var(--fs-2xs); overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
.scenario-exposures button em { flex: none; font: 750 var(--fs-xs)/1 var(--font-mono); font-style: normal; }
.scenario-exposures button em.pos { color: var(--pos); }
.scenario-exposures button em.neg { color: var(--neg); }
.scenario-controls { display: grid; grid-template-columns: 2fr 1fr 1fr; gap: 8px; margin-bottom: var(--s-3); }
.scenario-controls label { min-width: 0; }
.scenario-controls select,
.scenario-controls input,
.scenario-basket input {
  width: 100%; min-width: 0; margin-top: 5px; padding: 8px 9px;
  border: 1px solid var(--border); border-radius: var(--r-2);
  background: var(--surface); color: var(--text); font: 600 var(--fs-xs)/1.2 var(--font-sans);
}
.scenario-sens-cols,
.scenario-sens-row { display: grid; grid-template-columns: .75fr 1.05fr 1.35fr 1.2fr; gap: 10px; align-items: center; }
.scenario-sens-cols { padding: 6px 9px; color: var(--muted); font: 700 var(--fs-2xs)/1 var(--font-mono); letter-spacing: var(--ls-caps); text-transform: uppercase; }
.scenario-sens-list { display: grid; gap: 5px; }
.scenario-sens-row { width: 100%; min-width: 0; padding: 9px; border: 1px solid var(--border); border-radius: var(--r-2); background: var(--surface); text-align: left; }
.scenario-sens-row:hover,
.scenario-sens-row:focus-visible { border-color: var(--accent); background: var(--accent-tint-1); outline: none; }
.scenario-sens-row > span { min-width: 0; }
.scenario-sens-row b { color: var(--text-strong); font-size: var(--fs-xs); line-height: 1.3; overflow-wrap: anywhere; }
.scenario-sens-row small { display: block; margin-top: 4px; color: var(--muted); font-size: var(--fs-2xs); line-height: 1.35; overflow-wrap: anywhere; }
.scenario-sens-name > b { color: var(--accent); font: 800 var(--fs-sm)/1 var(--font-mono); }
.scenario-sens-impact > b { font-family: var(--font-mono); }
.scenario-sens-impact > b.pos { color: var(--pos); }
.scenario-sens-impact > b.neg { color: var(--neg); }
.scenario-sens-decision > b { display: inline-flex; padding: 3px 6px; border-radius: 999px; background: var(--surface-2); text-transform: capitalize; }
.scenario-sens-decision > b.is-supportive { color: var(--pos); background: color-mix(in srgb, var(--pos) 12%, transparent); }
.scenario-sens-decision > b.is-adverse { color: var(--neg); background: color-mix(in srgb, var(--neg) 12%, transparent); }
.scenario-show-all {
  display: block; margin: 9px auto 0; padding: 7px 11px;
  border: 1px solid var(--border-strong); border-radius: var(--r-2);
  background: var(--surface); color: var(--text); font: 700 var(--fs-xs)/1 var(--font-sans); cursor: pointer;
}
.scenario-basket { margin-top: var(--s-4); padding: var(--s-3); border: 1px solid var(--border); border-radius: var(--r-3); background: var(--surface-2); }
.scenario-basket > div:not(#scenario-basket-result) { display: grid; grid-template-columns: minmax(0, 1fr) auto; gap: 7px; }
.scenario-basket input { margin: 0; }
.scenario-basket button { padding: 8px 12px; border: 1px solid var(--accent); border-radius: var(--r-2); background: var(--accent); color: #fff; font-weight: 750; cursor: pointer; }
#scenario-basket-result > p { margin: 9px 0 0; color: var(--muted); font-size: var(--fs-xs); }
.scenario-basket-result { display: grid; grid-template-columns: repeat(4, minmax(0, 1fr)); gap: 7px; margin-top: 9px; }
.scenario-basket-result > span { min-width: 0; padding: 8px; border: 1px solid var(--border); border-radius: var(--r-2); background: var(--surface); }
.scenario-basket-result b { display: block; margin-top: 5px; color: var(--text-strong); font-size: var(--fs-xs); line-height: 1.3; overflow-wrap: anywhere; }
.scenario-basket-result b.pos { color: var(--pos); }
.scenario-basket-result b.neg { color: var(--neg); }
.scenario-basket-result p { grid-column: 1 / -1; margin: 0; color: var(--muted); font-size: var(--fs-2xs); line-height: 1.4; }
.scenario-foot { padding: var(--s-3) var(--s-4); color: var(--muted); font-size: var(--fs-xs); line-height: 1.5; }
.scenario-foot b { color: var(--text-strong); }
.scenario-empty { grid-column: 1 / -1; margin: 0; padding: var(--s-4); color: var(--muted); text-align: center; }
.pick-scenario-overlay {
  display: grid; grid-template-columns: minmax(0, 1fr) auto; gap: 7px 12px;
  margin: 0 0 var(--s-3); padding: 9px 10px; border: 1px solid var(--border);
  border-left: 3px solid var(--warn); border-radius: var(--r-2); background: var(--surface-2);
}
.pick-scenario-overlay.is-supportive { border-left-color: var(--pos); }
.pick-scenario-overlay.is-adverse { border-left-color: var(--neg); }
.pick-scenario-overlay span { min-width: 0; }
.pick-scenario-overlay b { color: var(--text-strong); font-size: var(--fs-xs); text-transform: capitalize; }
.pick-scenario-overlay small { display: block; margin-top: 4px; color: var(--muted); font: 600 var(--fs-2xs)/1.3 var(--font-mono); }
.pick-scenario-overlay em { color: var(--text); font: 700 var(--fs-2xs)/1.3 var(--font-mono); font-style: normal; text-align: right; }
.pick-scenario-overlay p { grid-column: 1 / -1; margin: 0; color: var(--muted); font-size: var(--fs-xs); line-height: 1.4; }
.ptc-scenario {
  display: block; padding: 5px 7px; border: 1px solid var(--border); border-radius: var(--r-1);
  background: var(--surface-2); color: var(--warn); font: 700 var(--fs-2xs)/1.2 var(--font-sans); text-transform: capitalize;
}
.ptc-scenario.is-supportive { color: var(--pos); border-color: color-mix(in srgb, var(--pos) 35%, var(--border)); }
.ptc-scenario.is-adverse { color: var(--neg); border-color: color-mix(in srgb, var(--neg) 35%, var(--border)); }
@media (max-width: 760px) {
  .scenario-head { flex-direction: column; padding: var(--s-3); }
  .scenario-head > em { white-space: normal; }
  .scenario-transition { grid-template-columns: repeat(2, minmax(0, 1fr)); }
  .scenario-transition > span { padding: var(--s-3); }
  .scenario-transition > span:nth-child(2) { border-right: 0; }
  .scenario-transition > span:nth-child(-n+2) { border-bottom: 1px solid var(--border); }
  .scenario-warnings { grid-template-columns: minmax(0, 1fr); padding: var(--s-3); }
  .scenario-axis-velocity { grid-template-columns: repeat(4, minmax(0, 1fr)); padding: var(--s-3); }
  .scenario-section { padding: var(--s-3); }
  .scenario-section > header { align-items: flex-start; }
  .scenario-catalysts { grid-template-columns: minmax(0, 1fr); }
  .scenario-driver > header { flex-direction: column; }
  .scenario-driver > header strong { text-align: left; }
  .scenario-exposures { grid-template-columns: minmax(0, 1fr); }
  .scenario-controls { grid-template-columns: minmax(0, 1fr); }
  .scenario-sens-cols { display: none; }
  .scenario-sens-row { grid-template-columns: minmax(0, 1fr) minmax(0, 1fr); gap: 8px; }
  .scenario-sens-factors,
  .scenario-sens-decision { padding-top: 7px; border-top: 1px solid var(--border); }
  .scenario-basket-result { grid-template-columns: repeat(2, minmax(0, 1fr)); }
  .pick-scenario-overlay { grid-template-columns: minmax(0, 1fr); }
  .pick-scenario-overlay em { text-align: left; }
}
@media (max-width: 430px) {
  .scenario-section > header,
  .scenario-basket > header { align-items: flex-start; flex-direction: column; }
  .scenario-axis-velocity { grid-template-columns: repeat(2, minmax(0, 1fr)); }
  .scenario-section > header > span,
  .scenario-basket > header > span { text-align: left; }
  .scenario-path summary { align-items: flex-start; }
  .scenario-path summary em { max-width: 90px; white-space: normal; }
  .scenario-basket > div:not(#scenario-basket-result) { grid-template-columns: minmax(0, 1fr); }
}

.market-movers { margin: 0 0 var(--s-4); }
.market-movers[hidden] { display: none; }
.market-movers-card {
  overflow: hidden;
  border: 1px solid var(--border);
  border-left: 3px solid var(--border-strong);
...
.market-movers-risk-on { --market-mover-tone: var(--pos); }
.market-movers-risk-off { --market-mover-tone: var(--neg); }
.market-movers-selective,
.market-movers-dip-buying { --market-mover-tone: var(--warn); }
.market-movers-pending,
.market-movers-mixed,
.market-movers-stale { --market-mover-tone: var(--accent); }
.market-movers-card { border-left-color: var(--market-mover-tone, var(--border-strong)); }
.market-movers-head {
  display: flex;
  align-items: flex-start;
  justify-content: space-between;
  ...
  padding: var(--s-4);
  border-bottom: 1px solid var(--border);
  background: linear-gradient(135deg, color-mix(in srgb, var(--market-mover-tone, var(--accent)) 6%, var(--surface)), var(--surface));
}
.market-movers-kicker,
.market-movers-axes small,
.market-mover-basket header small,
.market-mover-row small {
  display: block;
  color: var(--muted);
  font: 700 var(--fs-2xs)/1 var(--font-mono);
  letter-spacing: var(--ls-caps);
...
.market-movers-head h3 {
  margin: 5px 0 6px;
  color: var(--market-mover-tone, var(--text-strong));
  font-size: var(--fs-xl);
  line-height: var(--lh-tight);
}
...
.market-movers-head > em {
  flex: none;
  padding: 5px 8px;
  border: 1px solid color-mix(in srgb, var(--market-mover-tone, var(--border-strong)) 45%, var(--border));
  border-radius: var(--r-pill);
  color: var(--market-mover-tone, var(--muted));
  font: 700 var(--fs-2xs)/1 var(--font-mono);
  font-style: normal;
  text-transform: uppercase;
  white-space: nowrap;
...
.market-movers-axes > span { padding: var(--s-3) var(--s-4); }
.market-movers-axes > span:first-child { border-right: 1px solid var(--border); }
.market-movers-axes b { display: block; margin-top: 5px; color: var(--text-strong); font-size: var(--fs-md); }
.market-movers-axes em { display: block; margin-top: 3px; color: var(--muted); font: 500 var(--fs-xs)/1.25 var(--font-sans); font-style: normal; }
.market-movers-action { margin: 0; padding: var(--s-3) var(--s-4); border-bottom: 1px solid var(--border); color: var(--text); font-size: var(--fs-sm); line-height: var(--lh-snug); }
.market-movers-action b { color: var(--text-strong); }
.market-movers-baskets {
  display: grid;
  grid-template-columns: repeat(2, minmax(0, 1fr));
  gap: var(--s-3);
  padding: var(--s-3);
}
.market-mover-basket { min-width: 0; overflow: hidden; border: 1px solid var(--border); border-radius: var(--r-3); background: var(--surface-2); }
.market-mover-basket header { display: flex; align-items: center; justify-content: space-between; gap: var(--s-2); padding: var(--s-3); border-bottom: 1px solid var(--border); }
.market-mover-basket header b { display: block; margin-top: 4px; color: var(--text-strong); font-size: var(--fs-sm); }
.market-mover-basket header > em { color: var(--muted); font: 600 var(--fs-2xs)/1 var(--font-mono); font-style: normal; }
.market-mover-columns,
.market-mover-row {
  display: grid;
  grid-template-columns: minmax(72px, 1.25fr) repeat(3, minmax(54px, .8fr)) minmax(70px, 1fr);
  gap: 6px;
  align-items: center;
}
.market-mover-columns { padding: 7px var(--s-3); color: var(--muted); font: 700 8px/1 var(--font-mono); letter-spacing: .05em; text-transform: uppercase; }
.market-mover-columns span:not(:first-child) { text-align: right; }
.market-mover-row {
  width: 100%;
  min-height: 47px;
  padding: 8px var(--s-3);
...
.market-mover-row:focus-visible { background: var(--accent-tint-1); outline: none; }
.market-mover-row > span:not(:first-child) { text-align: right; }
.market-mover-row > span > b { display: block; margin-top: 3px; color: var(--text-strong); font: 700 var(--fs-xs)/1 var(--font-mono); font-variant-numeric: tabular-nums; }
.market-mover-symbol b { color: var(--text-strong); font: 800 var(--fs-sm)/1 var(--font-mono); }
.market-mover-symbol small { margin-top: 5px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; text-transform: none; letter-spacing: 0; }
.market-mover-row b.pos { color: var(--pos); }
.market-mover-row b.neg { color: var(--neg); }
.market-mover-row b.zero { color: var(--muted); }
.market-mover-status { justify-self: end; padding: 4px 6px; border: 1px solid var(--border); border-radius: var(--r-pill); color: var(--muted); font: 700 8px/1 var(--font-mono); font-style: normal; text-transform: uppercase; white-space: nowrap; }
.market-mover-status.is-soared,
.market-mover-status.is-held,
.market-mover-status.is-recovered { color: var(--pos); border-color: color-mix(in srgb, var(--pos) 40%, var(--border)); background: color-mix(in srgb, var(--pos) 7%, transparent); }
.market-mover-status.is-faded,
.market-mover-status.is-reversed,
.market-mover-status.is-worsened { color: var(--neg); border-color: color-mix(in srgb, var(--neg) 40%, var(--border)); background: color-mix(in srgb, var(--neg) 7%, transparent); }
.market-mover-status.is-still-down { color: var(--warn); border-color: color-mix(in srgb, var(--warn) 40%, var(--border)); }
.market-movers-foot { margin: 0; padding: 0 var(--s-4) var(--s-3); color: var(--muted); font-size: var(--fs-2xs); line-height: var(--lh-snug); }
@media (max-width: 900px) {
  .market-movers-baskets { grid-template-columns: minmax(0, 1fr); }
}
@media (max-width: 600px) {
  .market-movers-head { flex-direction: column; padding: var(--s-3); }
  .market-movers-head > em { align-self: flex-start; }
  .market-movers-head h3 { font-size: var(--fs-lg); }
  .market-movers-axes { grid-template-columns: minmax(0, 1fr); }
  .market-movers-axes > span:first-child { border-right: 0; border-bottom: 1px solid var(--border); }
  .market-mover-columns { display: none; }
  .market-mover-row { grid-template-columns: minmax(78px, 1.1fr) repeat(2, minmax(52px, .7fr)) minmax(76px, .9fr); }
  .market-mover-row > span:nth-child(4) { display: none; }
  .market-movers-baskets { padding: 8px; }
}
...
.acc-audit { --acc-audit-tone: var(--info); display: flex; flex-direction: column; gap: 10px; margin: 0 0 16px; padding: 13px 14px; border: 1px solid color-mix(in srgb, var(--acc-audit-tone) 38%, var(--border)); border-left: 3px solid var(--acc-audit-tone); border-radius: 10px; background: linear-gradient(135deg, color-mix(in srgb, var(--acc-audit-tone) 5%, var(--surface)), var(--surface) 62%); }
.acc-audit-thesis, .acc-audit-exit { --acc-audit-tone: var(--neg); }
.acc-audit-entry, .acc-audit-vehicle { --acc-audit-tone: var(--warn); }
.acc-audit-balanced { --acc-audit-tone: var(--pos); }
.acc-audit-head { display: flex; align-items: flex-start; justify-content: space-between; gap: 12px; }
.acc-audit-head > div { min-width: 0; }
.acc-audit-kicker { display: block; margin-bottom: 4px; color: var(--acc-audit-tone); font: 700 9px/1 var(--font-mono); letter-spacing: .08em; text-transform: uppercase; }
.acc-audit h3 { margin: 0; color: var(--text-strong); font: 760 16px/1.25 var(--font-sans); }
.acc-audit-n { flex: 0 0 auto; padding: 4px 7px; border: 1px solid color-mix(in srgb, var(--acc-audit-tone) 38%, var(--border)); border-radius: 999px; background: var(--surface); color: var(--acc-audit-tone); font: 700 9px/1 var(--font-mono); white-space: nowrap; }
.acc-audit-read { margin: 0; color: var(--muted-strong); font: 500 11.5px/1.5 var(--font-sans); }
.acc-audit-grid { display: grid; grid-template-columns: repeat(4, minmax(0, 1fr)); overflow: hidden; border: 1px solid var(--border); border-radius: 8px; background: var(--surface); }
.acc-audit-metric { display: flex; flex-direction: column; gap: 4px; min-width: 0; padding: 9px 10px; border-right: 1px solid var(--border); }
.acc-audit-metric:last-child { border-right: 0; }
.acc-audit-metric small, .acc-audit-cohorts small { color: var(--muted); font: 700 8px/1 var(--font-mono); letter-spacing: .06em; text-transform: uppercase; }
.acc-audit-metric b { color: var(--text-strong); font: 760 16px/1.1 var(--font-mono); font-variant-numeric: tabular-nums; }
.acc-audit-metric b.sig-pos, .acc-audit-cohorts b.sig-pos { color: var(--pos); }
.acc-audit-metric b.sig-neg, .acc-audit-cohorts b.sig-neg { color: var(--neg); }
.acc-audit-metric span { color: var(--muted); font: 500 9.5px/1.3 var(--font-sans); overflow-wrap: anywhere; }
.acc-audit-cohorts { display: grid; grid-template-columns: minmax(110px, .8fr) repeat(2, minmax(0, 1fr)); align-items: stretch; overflow: hidden; border: 1px solid var(--border); border-radius: 8px; background: var(--surface-2); }
.acc-audit-cohorts > strong, .acc-audit-cohorts > span { display: flex; flex-direction: column; justify-content: center; gap: 3px; min-width: 0; padding: 8px 10px; border-right: 1px solid var(--border); }
.acc-audit-cohorts > span:last-child { border-right: 0; }
.acc-audit-cohorts > strong { color: var(--muted-strong); font: 700 10px/1.25 var(--font-sans); }
.acc-audit-cohorts b { color: var(--text-strong); font: 730 12px/1.15 var(--font-mono); }
.acc-audit-cohorts em { color: var(--muted); font: 500 9.5px/1.25 var(--font-sans); font-style: normal; }
.acc-audit-method { margin: 0; color: var(--muted); font: 500 10px/1.45 var(--font-sans); }
.acc-audit-method b { color: var(--muted-strong); }
.acc-audit-actions { display: flex; flex-wrap: wrap; gap: 6px; }
...
@media (max-width: 760px) {
  .acc-audit-grid { grid-template-columns: repeat(2, minmax(0, 1fr)); }
  .acc-audit-metric { border-bottom: 1px solid var(--border); }
  .acc-audit-metric:nth-child(2n) { border-right: 0; }
  .acc-audit-metric:nth-last-child(-n+2) { border-bottom: 0; }
}
@media (max-width: 480px) {
  .acc-audit { padding: 11px; }
  .acc-audit-head { flex-direction: column; }
  .acc-audit-cohorts { grid-template-columns: minmax(0, 1fr); }
  .acc-audit-cohorts > strong, .acc-audit-cohorts > span { border-right: 0; border-bottom: 1px solid var(--border); }
  .acc-audit-cohorts > span:last-child { border-bottom: 0; }
  .acc-audit-actions { display: grid; grid-template-columns: minmax(0, 1fr); }
  .acc-audit-actions .flow-decision-action { width: 100%; min-height: 42px; justify-content: center; }
}
...
.ticker-grade[hidden] { display: none; }
.ticker-grade b {
  font: 700 9.5px/1 var(--font-mono);
  letter-spacing: .035em;
  text-transform: uppercase;
...
.ticker-grade.is-call { color: var(--pos); background: var(--pos-soft); border-color: color-mix(in srgb, var(--pos) 32%, var(--hairline)); }
.ticker-grade.is-put { color: var(--neg); background: var(--neg-soft); border-color: color-mix(in srgb, var(--neg) 32%, var(--hairline)); }
.ticker-grade.is-neutral { color: var(--muted); }
.ticker-grade.is-ready { box-shadow: inset 0 0 0 1px color-mix(in srgb, currentColor 28%, transparent); }
.ticker-sector {
  font-size: var(--fs-xs);
  color: var(--muted);
  line-height: var(--lh-snug);
...
.tickers-model-summary[hidden] { display: none; }
.tickers-model-summary > button {
  appearance: none;
  display: flex;
  align-items: baseline;
  gap: 7px;
...
.tickers-model-summary > button:hover:not(:disabled) { background: color-mix(in srgb, var(--accent) 7%, var(--surface-2)); }
.tickers-model-summary > button:focus-visible { position: relative; z-index: 1; outline: none; box-shadow: inset 0 0 0 2px var(--accent); }
.tickers-model-summary > button.is-active { background: var(--accent-soft); }
.tickers-model-summary > button.is-active b,
.tickers-model-summary > button.is-active span { color: var(--accent); }
.tickers-model-summary > button:disabled { cursor: not-allowed; opacity: .5; }
.tickers-model-summary b { font: 700 1rem/1 var(--font-mono); color: var(--text-strong); font-variant-numeric: tabular-nums; }
.tickers-model-summary span { font: 700 9px/1.2 var(--font-mono); color: var(--muted); text-transform: uppercase; letter-spacing: .06em; }
.tickers-decision {
  --flow-decision-tone: var(--text-strong);
  margin: var(--s-3) 0;
  padding: 14px;
...
.tickers-decision[hidden] { display: none; }
.tickers-decision.is-reference {
  border-color: color-mix(in srgb, var(--warn) 34%, var(--border));
  background: linear-gradient(135deg, color-mix(in srgb, var(--warn) 7%, var(--surface-2)), var(--surface));
}
.tickers-decision-head {
  display: flex;
  align-items: flex-start;
  justify-content: space-between;
  gap: var(--s-4);
}
.tickers-decision-kicker {
  display: block;
  margin-bottom: 5px;
  color: var(--accent);
  font: 700 9px/1 var(--font-mono);
...
.tickers-decision.is-reference .tickers-decision-status {
  border-color: color-mix(in srgb, var(--warn) 40%, var(--border));
  color: var(--warn);
}
.tickers-decision-read {
  margin: 8px 0 0;
  max-width: 82ch;
  color: var(--muted-strong);
  font-size: var(--fs-sm);
...
.tickers-decision-rules {
  display: grid;
  grid-template-columns: repeat(2, minmax(0, 1fr));
  gap: 8px;
  margin-top: 11px;
}
.tickers-decision-rules > div {
  min-width: 0;
  padding: 9px 10px;
  border: 1px solid var(--hairline);
  border-radius: var(--r-2);
...
.tickers-decision-rules b {
  display: block;
  color: var(--text);
  font-size: var(--fs-xs);
  line-height: var(--lh-snug);
}
.tickers-decision-actions {
  display: flex;
  flex-wrap: wrap;
  gap: 7px;
  margin-top: 11px;
}
.tickers-decision-actions a { text-decoration: none; }
.tickers-controls {
  display: grid;
  grid-template-columns: minmax(260px, 1fr) minmax(170px, .6fr) minmax(170px, .55fr) auto;
  gap: 8px;
  align-items: end;
  margin: var(--s-2) 0;
}
.tickers-field { display: flex; flex-direction: column; gap: 5px; min-width: 0; }
.tickers-field-label {
  font: 700 10px/1 var(--font-mono);
  color: var(--muted);
  text-transform: uppercase;
...
.tickers-search:focus,
.tickers-select:focus { outline: none; border-color: var(--accent); box-shadow: var(--focus-ring); }
.tickers-ready {
  height: 40px;
  padding: 0 13px;
  border: 1px solid var(--border);
...
.tickers-ready:hover:not(:disabled) { border-color: var(--border-strong); color: var(--text); }
.tickers-ready:focus-visible { outline: none; box-shadow: var(--focus-ring); }
.tickers-ready.is-active { color: var(--accent); border-color: color-mix(in srgb, var(--accent) 48%, var(--border)); background: var(--accent-soft); }
.tickers-ready:disabled { opacity: .48; cursor: progress; }
.tickers-model-note {
  min-height: 16px;
  margin: 5px 0 0;
  color: var(--muted);
...
@media (max-width: 720px) {
  .tickers-controls { grid-template-columns: minmax(0, 1fr) minmax(0, 1fr); }
  .tickers-search-wrap { grid-column: 1 / -1; }
  .tickers-ready { grid-column: 1 / -1; align-self: end; }
  .ticker-card-head { align-items: flex-start; flex-wrap: wrap; }
  .tickers-decision-head { display: block; }
  .tickers-decision-status { display: inline-flex; margin-top: 9px; white-space: normal; }
  .tickers-decision-rules { grid-template-columns: 1fr; }
  .tickers-decision-actions .flow-decision-action { flex: 1 1 145px; justify-content: center; }
}
@media (max-width: 440px) {
  .tickers-model-summary { grid-template-columns: repeat(2, minmax(0, 1fr)); }
  .tickers-model-summary > button { padding: 9px 10px; }
  .tickers-decision { padding: 12px; }
  .tickers-decision-actions .flow-decision-action { flex-basis: 100%; }
}
...
@media (max-width: 640px) {
  ...
  .cal-overview::-webkit-scrollbar { display: none; }
  .cal-ov-card { min-width: min(248px, 76vw); scroll-snap-align: start; }
  ...
  .calendar-type-filter::-webkit-scrollbar { display: none; }
  .calendar-pill { min-height: 36px; padding: 6px 12px; flex: 0 0 auto; }
  .cal-focus { padding: 10px; }
  .cal-focus-head { align-items: flex-start; flex-direction: column; gap: 4px; }
  .cal-focus .cal-day { grid-template-columns: minmax(0, 1fr); }
  .fomc-widget { padding: 10px; gap: var(--s-2); }
  .fomc-vote-panel { padding: 10px; }
  .fomc-vote-head { align-items: flex-start; }
  .fomc-vote-head-counts { width: 100%; }
  .fomc-vote-meeting > summary { align-items: flex-start; flex-wrap: wrap; }
  .fomc-vote-meeting-main { width: 100%; }
  .fomc-vote-mini-counts { flex: 1 1 auto; }
  .fomc-vote-group { grid-template-columns: minmax(0, 1fr); gap: 4px; }
  .fomc-details > summary small { max-width: 240px; }
  ...
  .flow-decision-empty { grid-template-columns: minmax(0, 1fr); }
  .flow-decision-side {
    padding: var(--s-3) 0 0;
    border-top: 1px solid var(--hairline);
    border-left: 0;
  }
  .flow-decision-source { align-items: flex-start; }
  ...
  .narr-sector-overview { padding: var(--s-3); }
  .narr-posture { grid-template-columns: 1fr; gap: 5px; padding: 9px 10px; }
  .narr-posture-label { padding-top: 0; }
  .narr-analytics { grid-template-columns: 1fr; align-items: start; }
  .narr-analytics .narr-lifecycle { flex-wrap: wrap; }
  .narr-hype-badge { justify-self: start; }
  .narr-research > summary,
  .narr-sector-detail > summary { align-items: flex-start; }
  .narr-life-outlook-row { grid-template-columns: 54px minmax(0, 1fr); }
  .narr-scenario { grid-template-columns: 36px minmax(0, 1fr); }
...
@media (max-width: 480px) {
  .flow-decision { padding: 11px; }
  .flow-decision-head { align-items: flex-start; flex-direction: column; gap: 4px; }
  .flow-decision-head > em { max-width: none; text-align: left; }
  .flow-decision-rules { grid-template-columns: minmax(0, 1fr); }
  .flow-decision-source { flex-direction: column; gap: 3px; }
  .flow-decision-source > small { text-align: left; }
  .flow-decision-actions { display: grid; grid-template-columns: minmax(0, 1fr); }
  .flow-decision-action { width: 100%; min-height: 42px; }
...
.bonds-monitor-notes > summary::-webkit-details-marker,
.bonds-card-summary::-webkit-details-marker { display: none; }
.bonds-monitor-notes > summary::after,
.bonds-card-summary::after {
  content: "+";
  flex: 0 0 auto;
  color: var(--accent);
  font: 700 18px/1 var(--font-mono);
}
.bonds-monitor-notes[open] > summary::after,
.bonds-scale-card[open] > .bonds-card-summary::after { content: "−"; }
.bonds-monitor-notes-hint {
  margin-left: auto;
  color: var(--muted);
  font-weight: 500;
  font-size: 12px;
}
.bonds-monitor-notes-body { padding-top: var(--s-2); }
.bonds-monitor-notes-body .bonds-curve { max-width: 560px; }
.bonds-scale-card { padding: 0; overflow: clip; }
.bonds-card-summary {
  cursor: pointer;
  list-style: none;
  display: flex;
...
.bonds-card-summary > span:first-child {
  min-width: 0;
  display: flex;
  flex-direction: column;
  gap: 3px;
}
.bonds-card-summary-title { color: var(--text-strong); font-weight: 750; }
.bonds-card-summary-copy { color: var(--muted); font-size: 13px; }
.bonds-card-summary-action {
  margin-left: auto;
  color: var(--accent);
  font: 700 11px/1 var(--font-mono);
  letter-spacing: .05em;
...
.bonds-scale-body { padding: 0 var(--s-4) var(--s-4); border-top: 1px solid var(--border); }
.bonds-scale-scroll { overflow-x: auto; -webkit-overflow-scrolling: touch; }
...
.bonds-ctx-posture b { display: block; color: var(--text-strong); font-size: 13.5px; line-height: 1.35; }
.bonds-ctx-posture p { margin: 3px 0 0; color: var(--text); font-size: 12.5px; line-height: 1.45; }
.bonds-ctx-posture small { display: block; margin-top: 5px; color: var(--muted); font-size: 11.5px; line-height: 1.4; }
.bonds-ctx-posture-ready { border-left-color: var(--pos); background: color-mix(in srgb, var(--pos-soft) 48%, var(--surface-2)); }
...
.bonds-ctx-equity-copy { display: flex; flex-direction: column; gap: 3px; color: var(--text); font-size: 13px; line-height: 1.45; }
.bonds-ctx-equity-copy strong { color: var(--text-strong); font-size: 14px; }
.bonds-ctx-equity-check {
  color: var(--muted);
...
@media (max-width: 640px) {
  ...
  .bonds-ctx-tag { margin-left: 16px; }
  .bonds-monitor-notes > summary { align-items: center; }
  .bonds-monitor-notes-hint { display: none; }
  .bonds-card-summary-action { display: none; }
...
.fng-decision {
  --fng-decision-tone: var(--fng-neutral);
  --flow-decision-tone: var(--fng-decision-tone);
  display: flex;
  flex-direction: column;
  gap: var(--s-3);
  padding: var(--s-4);
  border: 1px solid var(--border);
  border-left: 3px solid var(--fng-decision-tone);
  border-radius: var(--r-4);
  background:
    linear-gradient(135deg, color-mix(in srgb, var(--fng-decision-tone) 7%, transparent), transparent 58%),
    var(--surface-2);
}
.fng-decision.fng-band-extreme-fear { --fng-decision-tone: var(--fng-extreme-fear); }
.fng-decision.fng-band-fear { --fng-decision-tone: var(--fng-fear); }
.fng-decision.fng-band-greed { --fng-decision-tone: var(--fng-greed); }
.fng-decision.fng-band-extreme-greed { --fng-decision-tone: var(--fng-extreme-greed); }
.fng-decision.is-reference { --fng-decision-tone: var(--muted); }
.fng-decision-lead {
  display: grid;
...
.fng-score-value {
  ...
  line-height: .95;
  letter-spacing: var(--ls-num);
  color: var(--fng-neutral);
}
.fng-band-extreme-fear .fng-score-value { color: var(--fng-extreme-fear); }
.fng-band-fear .fng-score-value { color: var(--fng-fear); }
.fng-band-greed .fng-score-value { color: var(--fng-greed); }
.fng-band-extreme-greed .fng-score-value { color: var(--fng-extreme-greed); }
.fng-score-band {
  margin-top: 4px;
  font-size: var(--fs-2xs);
  font-weight: 700;
...
.fng-decision-copy { min-width: 0; }
.fng-decision-eyebrow,
.fng-read-label {
  display: block;
  font-size: var(--fs-2xs);
  font-weight: 700;
...
.fng-decision-freshness {
  color: var(--fng-decision-tone);
  font-family: var(--font-mono);
  font-size: var(--fs-2xs);
  font-weight: 700;
  letter-spacing: var(--ls-caps);
...
.fng-decision-source b {
  color: var(--fng-decision-tone);
  font-size: var(--fs-xs);
}
.fng-decision-source span {
  color: var(--muted);
  font-size: var(--fs-2xs);
}
.fng-trade-plan {
...
.fng-decision-actions {
  display: flex;
  flex-wrap: wrap;
  gap: var(--s-2);
}
.fng-decision.is-reference .flow-decision-action.is-primary {
  color: var(--text);
  background: var(--surface-3);
  border-color: var(--border-strong);
}
...
.fng-read-card {
  ...
  padding: var(--s-2) var(--s-3);
  border: 1px solid var(--border);
  border-top: 2px solid var(--fng-neutral);
  border-radius: var(--r-3);
  background: color-mix(in srgb, var(--surface-3) 78%, transparent);
}
.fng-read-card.fng-band-extreme-fear { border-top-color: var(--fng-extreme-fear); }
.fng-read-card.fng-band-fear { border-top-color: var(--fng-fear); }
.fng-read-card.fng-band-greed { border-top-color: var(--fng-greed); }
.fng-read-card.fng-band-extreme-greed { border-top-color: var(--fng-extreme-greed); }
.fng-read-card strong {
  overflow: hidden;
  text-overflow: ellipsis;
  white-space: nowrap;
  font-size: var(--fs-sm);
...
.fng-change-strip > span:first-child { border-left: 0; }
.fng-change-strip small {
  font-size: var(--fs-2xs);
  color: var(--muted);
  letter-spacing: var(--ls-caps);
  text-transform: uppercase;
}
.fng-change-strip strong {
  font-family: var(--font-mono);
  font-size: var(--fs-sm);
  font-variant-numeric: tabular-nums;
}
...
.fng-disclosure > summary,
.fng-card > summary {
  list-style: none;
  cursor: pointer;
}
.fng-disclosure > summary::-webkit-details-marker,
.fng-card > summary::-webkit-details-marker { display: none; }
.fng-disclosure > summary {
  display: grid;
  grid-template-columns: minmax(0, 1fr) auto 14px;
  gap: var(--s-3);
...
.fng-disclosure > summary:hover,
.fng-card > summary:hover { background: color-mix(in srgb, var(--surface-3) 64%, transparent); }
.fng-disclosure-title {
  font-size: var(--fs-sm);
  font-weight: 700;
  color: var(--text);
}
...
.fng-disclosure[open] > summary .fng-disclosure-chevron,
.fng-card[open] > summary .fng-disclosure-chevron { transform: rotate(225deg) translate(-1px, -1px); }
.fng-disclosure > .fng-disclosure-body {
  display: flex;
  flex-direction: column;
  gap: var(--s-3);
  padding: var(--s-3);
...
.fng-gauge { width: 100%; max-width: 210px; height: auto; display: block; margin: 0 auto; }
.fng-arc {
  fill: none;
  stroke-width: 14;
  stroke-linecap: round;
...
.fng-card-summary {
  display: grid;
  grid-template-columns: minmax(160px, .8fr) minmax(170px, 1fr) auto 14px;
  gap: var(--s-3);
  align-items: center;
  min-height: 48px;
  padding: var(--s-2) var(--s-3);
}
.fng-card-meter { min-width: 0; }
.fng-card-missing {
  grid-column: 2 / 4;
  font-size: var(--fs-xs);
  color: var(--muted);
...
@media (max-width: 720px) {
  .fng-decision { padding: var(--s-3); }
  .fng-decision-lead { grid-template-columns: 82px minmax(0, 1fr); gap: var(--s-3); }
  .fng-decision-kicker { align-items: flex-start; flex-direction: column; gap: 3px; }
  .fng-score-lockup { padding-right: var(--s-3); }
  .fng-score-value { font-size: 36px; }
  .fng-decision-copy h3 { font-size: var(--fs-lg); }
  .fng-decision-copy p { font-size: var(--fs-xs); }
  .fng-trade-plan { grid-template-columns: minmax(0, 1fr); }
  .fng-decision-actions { display: grid; grid-template-columns: minmax(0, 1fr); }
  .fng-decision-actions .flow-decision-action { width: 100%; min-height: 42px; }
  .fng-decision-grid { gap: 5px; }
  .fng-read-card { padding: 7px; }
  .fng-read-card strong {
    overflow: visible;
    white-space: normal;
    font-size: var(--fs-xs);
  ...
  .fng-read-card > span:last-child { display: none; }
  .fng-change-strip small { font-size: 9px; }
  .fng-change-strip > span { flex-direction: column; align-items: center; gap: 0; }
  .fng-strip {
    display: flex;
    gap: 6px;
    overflow-x: auto;
  ...
  .fng-chip { flex: 0 0 88px; scroll-snap-align: start; }
  .fng-disclosure > summary {
    grid-template-columns: minmax(0, 1fr) 14px;
    gap: 2px var(--s-2);
  }
  .fng-disclosure-meta { grid-column: 1; grid-row: 2; }
  .fng-disclosure > summary .fng-disclosure-chevron { grid-column: 2; grid-row: 1 / 3; }
  .fng-headline { grid-template-columns: 1fr; gap: var(--s-3); }
  .fng-gauge { max-width: 180px; }
  .fng-headline-meta { align-items: center; text-align: center; }
  .fng-card-summary {
    grid-template-columns: minmax(0, 1fr) auto 14px;
    gap: 4px var(--s-2);
    padding: var(--s-2);
  }
  .fng-card-title { font-size: var(--fs-sm); }
  .fng-card-meter { grid-column: 1 / 3; grid-row: 2; }
  .fng-card-rating { grid-column: 2; grid-row: 1; }
  .fng-card-summary .fng-disclosure-chevron { grid-column: 3; grid-row: 1 / 3; }
  .fng-card-missing { grid-column: 2; }
}
...
.strat-starter {
  ...
  border: 1px solid color-mix(in srgb, var(--accent) 30%, var(--border));
  border-radius: var(--r-4);
  background: linear-gradient(145deg, color-mix(in srgb, var(--accent) 6%, var(--surface)), var(--surface) 58%);
}
.strat-starter[hidden] { display: none; }
.strat-starter-head {
  display: flex;
  align-items: flex-start;
  justify-content: space-between;
...
.strat-starter-head h3 {
  margin: 0;
  color: var(--text-strong);
  font-size: var(--fs-lg);
}
.strat-starter-head p {
  max-width: 760px;
  margin: 6px 0 0;
  color: var(--text-2);
  font-size: var(--fs-sm);
...
.strat-start-card:hover {
  transform: translateY(-1px);
  border-color: var(--accent);
  background: var(--accent-tint-1);
}
.strat-start-card.is-selected {
  border-color: var(--accent);
  background: var(--accent-tint-1);
  box-shadow: 0 0 0 1px color-mix(in srgb, var(--accent) 28%, transparent);
}
.strat-start-card span,
.strat-start-card b,
.strat-start-card small { display: block; }
.strat-start-card span {
  margin-bottom: var(--s-3);
  color: var(--text-3);
...
.strat-start-card small {
  margin-top: 5px;
  color: var(--text-3);
  font-size: 0.75rem;
  line-height: 1.3;
}
.strat-start-bull { border-top-color: var(--pos); }
.strat-start-bear { border-top-color: var(--neg); }
.strat-start-move { border-top-color: var(--accent); }
.strat-start-range { border-top-color: var(--warn); }
.strat-start-next {
  display: flex;
  align-items: center;
  justify-content: space-between;
...
.strat-start-next > div {
  display: flex;
  align-items: center;
  gap: var(--s-2);
}
.strat-start-next > div > span {
  color: var(--text-3);
  font: 650 0.72rem/1 var(--font-mono);
  white-space: nowrap;
}
.strat-quick-symbols { display: flex; flex-wrap: wrap; gap: 5px; }
.strat-quick-symbols button {
  appearance: none;
  min-height: 32px;
  padding: 5px 9px;
  border: 1px solid var(--border-strong);
...
.strat-quick-symbols button:hover {
  border-color: var(--accent);
  color: var(--accent);
}
.strat-start-next p {
...
.strat-start-rule b { color: var(--warn); }
.strat-btn-ghost {
  appearance: none;
  background: transparent;
  border: 1px solid var(--border-strong);
...
.strat-guidance { margin-bottom: var(--s-3); }
.strat-guide {
  display: flex;
  flex-direction: column;
  gap: var(--s-3);
...
.strat-guide-bull { border-left-color: var(--pos); }
.strat-guide-bear { border-left-color: var(--neg); }
.strat-guide-wait { border-left-color: var(--warn); }
.strat-guide-avoid { border-left-color: var(--neg); }
.strat-guide-kicker,
.strat-guide-grid small,
.strat-guide-start small,
.strat-verdict-head > span,
.strat-verdict-grid small {
  display: block;
  font-size: var(--fs-2xs);
  font-weight: 700;
  color: var(--muted);
...
.strat-guide-bull .strat-guide-grid > span:first-child { border-top-color: var(--pos); }
.strat-guide-bear .strat-guide-grid > span:first-child { border-top-color: var(--neg); }
.strat-guide-grid > span.is-risk { border-top-color: var(--neg); }
.strat-guide-timing-ready { border-top-color: var(--pos) !important; }
.strat-guide-timing-watch,
.strat-guide-timing-wait { border-top-color: var(--warn) !important; }
.strat-guide-timing-avoid { border-top-color: var(--neg) !important; }
.strat-guide-grid b { font-size: var(--fs-sm); color: var(--text); }
.strat-guide-grid em {
  overflow: hidden;
  text-overflow: ellipsis;
  white-space: nowrap;
...
.strat-guide-start > span { display: flex; flex-direction: column; gap: 2px; }
.strat-guide-start > span b { font-size: var(--fs-xs); color: var(--text); }
.strat-guide-start > div { display: flex; flex-wrap: wrap; justify-content: flex-end; gap: var(--s-2); }
.strat-rec {
  display: flex;
  flex-direction: column;
  gap: 2px;
...
.strat-rec:hover { background: var(--accent-tint-2); }
.strat-rec span { font-size: var(--fs-sm); font-weight: 700; }
.strat-rec small { color: var(--muted); font-size: var(--fs-2xs); }
.strat-guide-avoid {
  margin: 0;
  color: var(--muted);
  font-size: var(--fs-xs);
...
.strat-guide-avoid b { color: var(--warn); }
.strat-disclosure {
  overflow: clip;
  border: 1px solid var(--border);
  border-radius: var(--r-3);
...
.strat-disclosure > summary::-webkit-details-marker { display: none; }
.strat-disclosure > summary:hover { background: color-mix(in srgb, var(--surface-3) 64%, transparent); }
.strat-disclosure-summary > span { display: flex; flex-direction: column; gap: 2px; min-width: 0; }
.strat-disclosure-summary b { font-size: var(--fs-sm); color: var(--text); }
.strat-disclosure-summary small { font-size: var(--fs-2xs); color: var(--muted); }
.strat-disclosure-summary em {
  font: 400 var(--fs-2xs)/1.2 var(--font-mono);
  color: var(--muted);
}
.strat-chevron {
...
.strat-disclosure[open] > summary .strat-chevron { transform: rotate(225deg) translate(-1px, -1px); }
.strat-disclosure-body { padding: var(--s-3); border-top: 1px solid var(--border); }
...
.strat-legs-body > .strat-legs-actions { justify-content: flex-end; margin-bottom: var(--s-2); }
.strat-legs-list {
  display: flex;
  flex-direction: column;
  gap: var(--s-2);
...
.strat-verdict { margin-bottom: var(--s-3); }
.strat-verdict-card {
  display: flex;
  flex-direction: column;
  gap: var(--s-3);
...
.strat-verdict-ready { border-left-color: var(--pos); }
.strat-verdict-wait { border-left-color: var(--warn); }
.strat-verdict-pass { border-left-color: var(--neg); }
.strat-verdict-head h4 {
  margin: 3px 0 4px;
  font-size: var(--fs-lg);
  line-height: var(--lh-tight);
  color: var(--text);
}
.strat-verdict-head p {
  margin: 0;
  color: var(--muted);
  font-size: var(--fs-xs);
  line-height: var(--lh-snug);
...
.strat-verdict-timing-ready b { color: var(--pos); }
.strat-verdict-timing-watch b,
.strat-verdict-timing-wait b { color: var(--warn); }
.strat-verdict-timing-avoid b { color: var(--neg); }
.strat-risk-controls {
  display: flex;
  flex-wrap: wrap;
  gap: var(--s-3);
...
.strat-risk-controls label:last-child input { width: 64px; }
.strat-verdict-note {
  margin: 0;
  padding-top: var(--s-2);
  border-top: 1px solid var(--border);
...
.strat-verdict-note b { color: var(--text); }
.strat-verdict-note.is-risk b { color: var(--neg); }
...
.strat-analysis { margin-top: var(--s-3); }
.strat-summary-cell {
  background: var(--surface-2);
  border: 1px solid var(--hairline);
  border-radius: var(--r-3);
...
@media (max-width: 720px) {
  .strat-card { padding: var(--s-3); }
  .strat-starter { padding: var(--s-3); }
  .strat-starter-head { flex-direction: column; gap: var(--s-2); }
  .strat-start-grid { grid-template-columns: repeat(2, minmax(0, 1fr)); }
  .strat-start-next { align-items: flex-start; flex-direction: column; }
  .strat-start-next p { text-align: left; }
  .strat-guide { padding: var(--s-3); }
  .strat-guide-head h3 { font-size: var(--fs-lg); }
  .strat-guide-head p { font-size: var(--fs-xs); }
  .strat-guide-grid { grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 5px; }
  .strat-guide-grid > span { padding: 7px; }
  .strat-guide-grid b { font-size: var(--fs-xs); line-height: var(--lh-tight); }
  .strat-guide-grid em { display: none; }
  .strat-guide-start { align-items: stretch; flex-direction: column; padding: var(--s-2); }
  .strat-guide-start > div { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); }
  .strat-rec { min-width: 0; padding: 7px; }
  .strat-rec span { font-size: var(--fs-xs); }
  .strat-disclosure > summary {
    grid-template-columns: minmax(0, 1fr) 14px;
    gap: 3px var(--s-2);
  }
  .strat-disclosure-summary > em { grid-column: 1; grid-row: 2; }
  .strat-disclosure-summary .strat-chevron { grid-column: 2; grid-row: 1 / 3; }
  .strat-results-head { align-items: flex-start; }
  .strat-results-head-left { flex-direction: column; align-items: flex-start; gap: 5px; }
  .strat-verdict-card { padding: var(--s-2); }
  .strat-verdict-grid { grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 5px; }
  .strat-verdict-grid > span { padding: 7px; }
  .strat-verdict-grid b { font-size: var(--fs-xs); overflow: visible; white-space: normal; }
  .strat-risk-controls { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: var(--s-2); }
  .strat-risk-controls label { flex-direction: column; align-items: flex-start; gap: 4px; }
  .strat-risk-controls input,
  .strat-risk-controls label:last-child input { width: 100%; }
  .strat-summary-grid { grid-template-columns: repeat(2, minmax(0, 1fr)); }
  .strat-summary-cell { padding: var(--s-2); }
}
@media (max-width: 480px) {
  .strat-starter { padding: var(--s-2); }
  .strat-start-card { min-height: 140px; padding: var(--s-2); }
  .strat-start-card span { margin-bottom: var(--s-2); }
  .strat-quick-symbols button { min-height: 40px; padding-inline: 11px; }
}
...
.heatmap-decision {
  ...
  border-radius: 11px;
  background: linear-gradient(135deg, color-mix(in srgb, var(--info) 5%, var(--surface)), var(--surface) 55%);
  min-width: 0;
}
.heatmap-decision:empty { display: none; }
.heatmap-decision-risk-on { border-color: color-mix(in srgb, var(--pos) 38%, var(--border)); border-left-color: var(--pos); background: linear-gradient(135deg, color-mix(in srgb, var(--pos) 5%, var(--surface)), var(--surface) 55%); }
.heatmap-decision-risk-off { border-color: color-mix(in srgb, var(--neg) 38%, var(--border)); border-left-color: var(--neg); background: linear-gradient(135deg, color-mix(in srgb, var(--neg) 5%, var(--surface)), var(--surface) 55%); }
.heatmap-decision-narrow { border-color: color-mix(in srgb, var(--warn) 38%, var(--border)); border-left-color: var(--warn); background: linear-gradient(135deg, color-mix(in srgb, var(--warn) 5%, var(--surface)), var(--surface) 55%); }
.heatmap-decision-stale { border-color: color-mix(in srgb, var(--warn) 45%, var(--border)); border-left-color: var(--warn); background: linear-gradient(135deg, color-mix(in srgb, var(--warn) 7%, var(--surface)), var(--surface) 55%); }
.heatmap-decision-empty { grid-template-columns: minmax(0, 1fr); border-style: dashed; }
.heatmap-decision-empty b { color: var(--text-strong); font: 700 12px/1.3 var(--font-sans); }
.heatmap-decision-empty span { color: var(--muted-strong); font: 400 11px/1.4 var(--font-sans); }
.heatmap-decision-read,
.heatmap-decision-side { display: flex; flex-direction: column; gap: 8px; min-width: 0; }
.heatmap-decision-head { display: flex; align-items: flex-start; justify-content: space-between; gap: 10px; min-width: 0; }
.heatmap-decision-head > span { display: flex; flex-direction: column; gap: 4px; min-width: 0; }
.heatmap-decision-head small,
.heatmap-decision-metrics small,
.heatmap-decision-rules small {
  color: var(--muted);
  font: 700 8.5px/1.1 var(--font-mono);
  letter-spacing: .065em;
  text-transform: uppercase;
}
.heatmap-decision-head b { color: var(--text-strong); font: 780 18px/1.15 var(--font-sans); }
.heatmap-decision-head em { flex: 0 0 auto; padding: 4px 7px; border-radius: var(--r-pill); background: var(--surface-2); color: var(--muted-strong); font: 650 8.5px/1 var(--font-mono); font-style: normal; text-transform: uppercase; letter-spacing: .04em; }
.heatmap-decision-stale .heatmap-decision-head em { color: var(--warn); background: var(--warn-soft); }
.heatmap-decision-read h3 { margin: 0; color: var(--text); font: 700 12.5px/1.35 var(--font-sans); }
.heatmap-decision-read > p { margin: 0; color: var(--muted-strong); font: 400 11px/1.45 var(--font-sans); }
.heatmap-decision-rules { display: grid; grid-template-columns: 1fr 1fr; gap: 6px; margin-top: auto; }
.heatmap-decision-rules > span { display: flex; flex-direction: column; gap: 4px; min-width: 0; padding: 7px 8px; border: 1px solid var(--border); border-radius: 7px; background: color-mix(in srgb, var(--surface-2) 78%, transparent); }
.heatmap-decision-rules b { color: var(--text); font: 570 10px/1.35 var(--font-sans); }
.heatmap-decision-metrics { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 6px; }
.heatmap-decision-metrics > div { display: flex; flex-direction: column; gap: 3px; min-width: 0; padding: 7px 8px; border: 1px solid var(--border); border-radius: 7px; background: var(--surface-2); }
.heatmap-decision-metrics b { color: var(--text-strong); font: 730 12px/1.15 var(--font-mono); font-variant-numeric: tabular-nums; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
.heatmap-decision-metrics b.pos { color: var(--pos); }
.heatmap-decision-metrics b.neg { color: var(--neg); }
.heatmap-decision-metrics b.zero { color: var(--muted-strong); }
.heatmap-decision-metrics span { color: var(--muted); font: 520 9px/1.25 var(--font-sans); overflow-wrap: anywhere; }
.heatmap-decision-actions { display: flex; flex-wrap: wrap; gap: 6px; margin-top: auto; }
.heatmap-decision-actions button { appearance: none; min-height: 34px; flex: 1 1 145px; padding: 7px 9px; border: 1px solid var(--border-strong); border-radius: 7px; background: var(--surface); color: var(--text); font: 700 10px/1.2 var(--font-sans); cursor: pointer; }
.heatmap-decision-actions button:first-child { border-color: color-mix(in srgb, var(--accent) 46%, var(--border)); background: var(--accent-soft); color: var(--accent); }
.heatmap-decision-actions button:hover { border-color: var(--accent); color: var(--accent); }
@media (max-width: 760px) {
  .heatmap-decision { grid-template-columns: minmax(0, 1fr); }
}
@media (max-width: 480px) {
  .heatmap-decision { padding: 10px; }
  .heatmap-decision-head { flex-direction: column; }
  .heatmap-decision-rules { grid-template-columns: minmax(0, 1fr); }
  .heatmap-decision-actions button { min-height: 42px; flex-basis: 100%; }
}
.heatmap-controls {
  display: grid;
...
.heatmap-streaks[hidden] { display: none; }
.heatmap-streak-top {
  display: flex;
  align-items: center;
  justify-content: space-between;
...
.heatmap-streak-icon { color: var(--accent); font: 800 1rem/1 var(--font-mono); }
.heatmap-streak-title {
...
.heatmap-streak-read { display: flex; flex-wrap: wrap; align-items: baseline; gap: 4px 8px; }
.heatmap-streak-read b { color: var(--text-strong); font: 700 12px/1.3 var(--font-sans); }
.heatmap-streak-read span { color: var(--text); font: 400 11.5px/1.4 var(--font-sans); }
.heatmap-streak-list {
  display: flex;
  flex-wrap: wrap;
  gap: 6px;
...
.heatmap-streak-chip.is-green {
  border-color: color-mix(in srgb, var(--up) 45%, var(--border));
  background: color-mix(in srgb, var(--up) 12%, var(--surface-2));
}
.heatmap-streak-chip.is-red {
  border-color: color-mix(in srgb, var(--dn) 45%, var(--border));
  background: color-mix(in srgb, var(--dn) 12%, var(--surface-2));
}
.heatmap-streak-chip.is-green .heatmap-streak-arrow { color: var(--up); }
.heatmap-streak-chip.is-red .heatmap-streak-arrow { color: var(--dn); }
.heatmap-streak-sector { color: var(--text-strong); font-weight: 700; }
.heatmap-streak-detail { color: var(--muted-strong); }
@media (max-width: 640px) {
  .heatmap-streak-top { align-items: flex-start; }
  .heatmap-streak-head { flex-wrap: wrap; row-gap: 4px; }
  .heatmap-streak-sub { flex-basis: 100%; padding-left: 22px; }
  .heatmap-streak-scope { font-size: 7.5px; }
  .heatmap-streak-list { display: grid; grid-template-columns: minmax(0, 1fr); }
  .heatmap-streak-chip { white-space: normal; line-height: 1.25; }
}
...
.heatmap-eod-rank-leaders { border-left: 3px solid var(--pos); }
.heatmap-eod-rank-laggards { border-left: 3px solid var(--neg); }
.heatmap-eod-rank-label {
  display: block;
  margin-bottom: 8px;
  color: var(--muted);
  font: 700 10px/1 var(--font-mono);
...
.heatmap-eod-rank-list { display: flex; flex-wrap: wrap; gap: 6px; }
.heatmap-eod-group-chip {
  display: inline-flex;
  align-items: center;
  gap: 7px;
  min-height: 30px;
...
.heatmap-eod-group-chip:hover { border-color: var(--border-strong); background: var(--surface-3); }
.heatmap-eod-group-chip:focus-visible { outline: none; box-shadow: var(--focus-ring); }
.heatmap-eod-group-chip span { overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
.heatmap-eod-group-chip b { font-variant-numeric: tabular-nums; }
.heatmap-eod-group-chip.pos b { color: var(--pos); }
.heatmap-eod-group-chip.neg b { color: var(--neg); }
.heatmap-eod-details {
  border: 1px solid var(--border);
  border-radius: var(--r-2);
  background: var(--surface-1);
...
.heatmap-eod-details > summary::-webkit-details-marker { display: none; }
.heatmap-eod-details > summary::before {
  content: "›";
  color: var(--accent);
  font: 700 1rem/1 var(--font-mono);
...
.heatmap-eod-details[open] > summary::before { transform: rotate(90deg); }
.heatmap-eod-details > summary:hover { background: var(--surface-2); }
.heatmap-eod-details > summary small {
  margin-left: auto;
  color: var(--muted);
  font: 600 10px/1 var(--font-mono);
  text-transform: uppercase;
...
.brief-decision { display: flex; flex-direction: column; gap: 10px; padding: 12px 13px; border: 1px solid color-mix(in srgb, var(--accent) 28%, var(--border)); border-left: 3px solid var(--accent); border-radius: 10px; background: color-mix(in srgb, var(--accent) 4%, var(--surface)); }
.brief-decision-press { border-left-color: var(--pos); background: color-mix(in srgb, var(--pos) 4%, var(--surface)); }
.brief-decision-protect { border-left-color: var(--neg); background: color-mix(in srgb, var(--neg) 4%, var(--surface)); }
.brief-decision-selective { border-left-color: var(--warn); background: color-mix(in srgb, var(--warn) 4%, var(--surface)); }
.brief-decision > header { display: flex; align-items: flex-start; justify-content: space-between; gap: 12px; }
.brief-decision > header > div { min-width: 0; }
.brief-decision-kicker { display: block; margin-bottom: 4px; color: var(--accent); font: 700 9px/1 var(--font-mono); letter-spacing: .08em; text-transform: uppercase; }
.brief-decision-press .brief-decision-kicker { color: var(--pos); }
.brief-decision-protect .brief-decision-kicker { color: var(--neg); }
.brief-decision-selective .brief-decision-kicker { color: var(--warn); }
.brief-decision h4 { margin: 0; color: var(--text-strong); font: 750 15px/1.25 var(--font-sans); }
.brief-decision > header p { margin: 4px 0 0; color: var(--muted); font: 500 10px/1.35 var(--font-sans); }
.brief-decision-score { flex: 0 0 auto; padding: 5px 7px; border: 1px solid var(--border); border-radius: 999px; background: var(--surface-2); color: var(--muted-strong); font: 700 9px/1 var(--font-mono); }
.brief-decision-grid { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); border: 1px solid var(--border); border-radius: 8px; overflow: hidden; background: var(--surface); }
.brief-decision-grid > span { display: flex; flex-direction: column; gap: 3px; min-width: 0; padding: 8px 9px; border-right: 1px solid var(--border); border-bottom: 1px solid var(--border); }
.brief-decision-grid > span:nth-child(2n) { border-right: 0; }
.brief-decision-grid > span:nth-last-child(-n+2) { border-bottom: 0; }
.brief-decision-grid small { color: var(--muted); font: 700 8px/1 var(--font-mono); letter-spacing: .06em; text-transform: uppercase; }
.brief-decision-grid b { color: var(--text-strong); font: 650 10.5px/1.35 var(--font-sans); overflow-wrap: anywhere; }
.brief-decision-grid em { color: var(--muted); font: 500 9.5px/1.3 var(--font-sans); font-style: normal; overflow-wrap: anywhere; }
.brief-decision-actions { display: flex; flex-wrap: wrap; gap: 6px; }
.brief-decision-actions button { min-height: 34px; padding: 6px 9px; border: 1px solid var(--border); border-radius: 7px; background: var(--surface); color: var(--text); font: 650 10.5px/1.15 var(--font-sans); cursor: pointer; }
.brief-decision-actions button:hover, .brief-decision-actions button:focus-visible { border-color: var(--accent); color: var(--accent); background: var(--accent-soft); }
...
.brief-evidence { border: 1px solid var(--border); border-radius: 9px; background: var(--surface); overflow: hidden; }
.brief-evidence > summary { display: flex; align-items: center; gap: 7px; min-height: 42px; padding: 0 11px; list-style: none; color: var(--text-strong); font: 650 11px/1.25 var(--font-sans); cursor: pointer; }
.brief-evidence > summary::-webkit-details-marker { display: none; }
.brief-evidence > summary::before { content: '▸'; color: var(--accent); font-size: 12px; }
.brief-evidence[open] > summary::before { content: '▾'; }
.brief-evidence > summary span { margin-left: auto; color: var(--muted); font: 600 9px/1 var(--font-mono); text-transform: uppercase; }
.brief-evidence .brief-blocks { margin: 0; padding: 13px 11px 11px; }
...
@media (max-width: 760px) {
  .brief-card { padding: 15px; }
  .brief-decision-grid { grid-template-columns: minmax(0, 1fr); }
  .brief-decision-grid > span, .brief-decision-grid > span:nth-child(2n), .brief-decision-grid > span:nth-last-child(-n+2) { border-right: 0; border-bottom: 1px solid var(--border); }
  .brief-decision-grid > span:last-child { border-bottom: 0; }
...
.news-feed-summary:empty { display: none; }
.news-posture-unresolved { border-left-color: var(--warn); }
.news-posture-favorable { border-left-color: var(--pos); }
.news-posture-adverse { border-left-color: var(--neg); }
.news-posture-mixed { border-left-color: var(--info); }
.news-posture-quiet { border-left-color: var(--muted); }
.news-posture-head { display: flex; align-items: center; justify-content: space-between; gap: 10px; }
.news-posture-kicker,
.news-posture-state { color: var(--muted); font: 700 9px/1 var(--font-mono); text-transform: uppercase; letter-spacing: .08em; }
.news-posture-state { padding: 4px 7px; border-radius: var(--r-pill); background: var(--surface-3); }
.news-posture-unresolved .news-posture-state { color: var(--warn); background: var(--warn-soft); }
.news-posture-favorable .news-posture-state { color: var(--pos); background: var(--pos-soft); }
.news-posture-adverse .news-posture-state { color: var(--neg); background: var(--neg-soft); }
.news-posture-mixed .news-posture-state { color: var(--info); background: var(--info-soft); }
.news-feed-summary h3 { margin: 8px 0 5px; color: var(--text-strong); font: 750 1.08rem/1.25 var(--font-sans); }
.news-feed-summary > p { max-width: 920px; margin: 0; color: var(--text); font: 400 12.5px/1.5 var(--font-sans); }
.news-posture-metrics {
  display: grid; grid-template-columns: repeat(4, minmax(0, 1fr));
  gap: 1px; margin-top: 13px; overflow: hidden;
  border: 1px solid var(--border); border-radius: var(--r-2); background: var(--border);
}
.news-posture-metrics > div { min-width: 0; padding: 10px 11px; background: var(--surface); }
.news-posture-metrics b { display: block; color: var(--text-strong); font: 700 1rem/1 var(--font-mono); font-variant-numeric: tabular-nums; }
.news-posture-metrics span,
.news-posture-metrics small { display: block; margin-top: 5px; color: var(--muted); font: 700 8.5px/1.2 var(--font-mono); text-transform: uppercase; letter-spacing: .055em; }
.news-posture-metrics small { margin-top: 3px; font-weight: 500; text-transform: none; letter-spacing: 0; }
.news-posture-triggers { display: grid; grid-template-columns: 1fr 1fr; gap: 8px; margin-top: 9px; }
.news-posture-triggers > div { padding: 9px 10px; border: 1px solid var(--border); border-radius: var(--r-1); background: color-mix(in srgb, var(--surface-2) 78%, transparent); }
.news-posture-triggers span { display: block; margin-bottom: 4px; color: var(--muted); font: 700 8.5px/1 var(--font-mono); text-transform: uppercase; letter-spacing: .07em; }
.news-posture-triggers b { color: var(--text); font: 600 11px/1.4 var(--font-sans); }
.news-posture-match { margin-top: 9px; color: var(--muted); font: 600 9.5px/1.2 var(--font-mono); }
@media (max-width: 640px) {
  .news-feed-summary { padding: 13px 12px; }
  .news-posture-metrics { grid-template-columns: 1fr 1fr; }
  .news-posture-triggers { grid-template-columns: 1fr; }
}
.news-feed-toolbar {
  display: grid;
...
.news-feed-search-wrap { min-width: 0; }
.news-feed-search,
.news-feed-select-wrap select,
.news-more-grid select {
...
.news-feed-search { padding: 9px 12px; }
.news-feed-search::placeholder { color: var(--muted); }
.news-feed-search:focus,
.news-feed-select-wrap select:focus,
.news-more-grid select:focus { outline: none; border-color: var(--accent); box-shadow: var(--focus-ring); }
.news-impact-filter {
  display: inline-flex; align-items: center; gap: 3px;
...
.news-filter-chip {
  ...
  font: 700 0.66rem/1 var(--font-mono); white-space: nowrap;
}
.news-filter-chip:hover { color: var(--text-strong); background: var(--surface-3); }
.news-filter-chip.is-active { color: var(--accent-fg); background: var(--accent); }
.news-feed-select-wrap { display: flex; align-items: center; gap: 7px; }
.news-feed-select-wrap > span,
.news-more-grid label > span { font: 700 0.6rem/1 var(--font-mono); color: var(--muted); text-transform: uppercase; letter-spacing: .06em; white-space: nowrap; }
.news-feed-select-wrap select { width: auto; min-width: 130px; padding: 7px 28px 7px 9px; }
.news-more-filters {
  margin: 0 0 var(--s-3);
  border: 1px solid var(--border); border-radius: var(--r-2);
  background: var(--surface);
}
.news-more-filters > summary {
  display: flex; align-items: center; gap: 7px;
  min-height: 38px; padding: 7px 11px;
  cursor: pointer; list-style: none;
  font: 700 0.68rem/1.2 var(--font-mono); color: var(--muted-strong);
}
.news-more-filters > summary::-webkit-details-marker { display: none; }
.news-more-filters > summary::after { content: '▾'; margin-left: auto; transition: transform var(--dur-1) var(--ease-out); }
.news-more-filters[open] > summary::after { transform: rotate(180deg); }
.news-filter-count {
  display: inline-flex; align-items: center; justify-content: center;
...
.news-more-grid {
  display: grid; grid-template-columns: repeat(5, minmax(120px, 1fr)); gap: var(--s-2);
  padding: var(--s-3); border-top: 1px solid var(--border);
}
.news-more-grid label { display: flex; flex-direction: column; gap: 5px; min-width: 0; }
.news-more-grid select { padding: 7px 26px 7px 9px; }
.news-feed-root { display: flex; flex-direction: column; gap: 7px; min-width: 0; }
.news-feed-item {
...
.news-feed-item.impact-high { border-left-color: var(--violet); }
.news-feed-item.impact-notable { border-left-color: var(--info); }
.news-feed-item-top { display: flex; flex-wrap: wrap; align-items: center; gap: 5px; margin-bottom: 7px; }
.news-feed-item-top time {
  margin-left: auto;
  font: 600 0.64rem/1 var(--font-mono); color: var(--muted); font-variant-numeric: tabular-nums;
}
.news-impact-badge,
...
.news-carried {
  display: inline-flex; align-items: center;
  min-height: 20px; padding: 3px 7px; border-radius: var(--r-pill);
  font: 700 0.58rem/1 var(--font-mono); text-transform: uppercase; letter-spacing: .055em;
}
.impact-high .news-impact-badge { color: var(--violet); background: var(--violet-soft); }
.impact-notable .news-impact-badge { color: var(--info); background: var(--info-soft); }
.impact-context .news-impact-badge { color: var(--muted-strong); background: var(--surface-3); }
.direction-positive .news-direction-badge { color: var(--pos); background: var(--pos-soft); }
.direction-negative .news-direction-badge { color: var(--neg); background: var(--neg-soft); }
.direction-mixed .news-direction-badge { color: var(--warn); background: var(--warn-soft); }
.direction-unclear .news-direction-badge { color: var(--muted); border: 1px solid var(--border); }
.news-macro-read { color: var(--info); background: var(--info-soft); text-transform: none; letter-spacing: 0; }
.news-macro-read.surprise-above { color: var(--warn); background: var(--warn-soft); }
.news-macro-read.surprise-inline { color: var(--muted-strong); background: var(--surface-3); }
.news-unconfirmed { color: var(--warn); border: 1px solid color-mix(in srgb, var(--warn) 32%, var(--border)); }
.news-carried { color: var(--muted); background: var(--surface); }
.news-feed-headline {
  display: block; min-width: 0; margin: 0 0 7px;
  color: var(--text-strong); text-decoration: none;
  font: 650 1rem/1.38 var(--font-sans); letter-spacing: -.01em;
  overflow-wrap: anywhere;
}
a.news-feed-headline:hover { color: var(--accent-strong); text-decoration: underline; text-underline-offset: 3px; }
a.news-feed-headline:focus-visible,
.news-feed-sym:focus-visible,
.news-filter-chip:focus-visible,
.news-feed-more:focus-visible { outline: 2px solid var(--accent); outline-offset: 2px; }
.news-feed-byline {
  display: flex; flex-wrap: wrap; align-items: center; gap: 5px 9px;
  color: var(--muted); font: 600 0.65rem/1.3 var(--font-mono);
  min-width: 0;
}
.news-feed-byline > span:not(.news-feed-market):not(.news-feed-macro):not(.news-feed-related) { overflow-wrap: anywhere; }
.news-feed-sym,
.news-feed-market,
.news-feed-macro {
  display: inline-flex; align-items: center; min-height: 23px; padding: 3px 7px;
  border: 1px solid var(--border-strong); border-radius: var(--r-pill);
  background: var(--surface); color: var(--text-strong); text-decoration: none;
  font: 700 0.65rem/1 var(--font-mono);
}
.news-feed-sym:hover { border-color: var(--accent); color: var(--accent-strong); }
.news-feed-market { color: var(--info); border-color: color-mix(in srgb, var(--info) 32%, var(--border)); }
.news-feed-macro { color: var(--violet); border-color: color-mix(in srgb, var(--violet) 35%, var(--border)); }
.news-feed-related { color: var(--muted-strong); font-size: .61rem; }
.news-feed-why {
  ...
  color: var(--muted-strong); font: 400 0.76rem/1.45 var(--font-sans);
}
.news-feed-why b { color: var(--text); font-weight: 700; }
.news-feed-reaction {
  display: inline-flex; align-items: center;
  padding: 3px 7px; border-radius: var(--r-pill); background: var(--surface);
  color: var(--muted-strong); font: 700 0.62rem/1 var(--font-mono); font-variant-numeric: tabular-nums;
}
.news-feed-reaction.pos { color: var(--pos); background: var(--pos-soft); }
.news-feed-reaction.neg { color: var(--neg); background: var(--neg-soft); }
.news-feed-status,
.news-feed-empty { margin: 10px 0; color: var(--muted); font: 500 0.86rem/1.5 var(--font-sans); }
.news-feed-error { color: var(--neg); }
.news-feed-more {
  display: block; width: 100%; min-height: 42px; margin-top: var(--s-3);
  border: 1px solid var(--border); border-radius: var(--r-2);
  background: var(--surface-2); color: var(--text);
  cursor: pointer; font: 700 0.72rem/1 var(--font-mono);
}
.news-feed-more:hover { border-color: var(--border-strong); background: var(--surface-3); }
.news-filter-count[hidden],
.news-feed-more[hidden],
.news-feed-empty[hidden] { display: none !important; }

@media (max-width: 760px) {
  .news-feed-toolbar { grid-template-columns: 1fr; }
  .news-impact-filter { justify-self: start; max-width: 100%; overflow-x: auto; }
  .news-feed-select-wrap { width: 100%; }
  .news-feed-select-wrap select { flex: 1 1 auto; width: 100%; }
  .news-more-grid { grid-template-columns: repeat(2, minmax(0, 1fr)); }
}
@media (max-width: 480px) {
  .news-feed-summary { grid-template-columns: repeat(3, minmax(0, 1fr)); }
  .news-feed-summary > div { flex-direction: column; align-items: flex-start; gap: 4px; padding: 9px 8px; }
  .news-feed-summary span { font-size: .56rem; }
  .news-feed-summary p { grid-column: 1 / -1; }
  .news-more-grid { grid-template-columns: 1fr; }
  .news-feed-search,
  .news-feed-select-wrap select,
  .news-more-grid select { min-height: 44px; }
  .news-filter-chip { min-height: 38px; }
  .news-feed-item { padding: 12px 12px 12px 14px; }
  .news-feed-headline { font-size: .94rem; }
  .news-feed-item-top time { flex-basis: auto; }
}
...
@media (max-width: 640px) {
  ...
  .heatmap-control select,
  .heatmap-search-input { min-height: 44px; }
  .heatmap-live-state { justify-self: start; }
  .heatmap-root {
    height: 60vh;
    min-height: 380px;
  }
  .heatmap-legend-bar { flex-basis: 140px; }
  .heatmap-eod-decision { grid-template-columns: 1fr; }
  .heatmap-eod-group-chip { flex: 1 1 calc(50% - 3px); justify-content: space-between; }
  .heatmap-eod-details > summary small { font-size: 9px; }
...
.oi-short {
  ...
  background: color-mix(in srgb, var(--violet) 7%, var(--surface-3));
}
.oi-wall-call {
  color: var(--up);
...
@media (hover: none) {
  .landing-quick-card:hover { border-color: var(--border); background: var(--surface); transform: none; }
  .landing-quick-card:hover > em { color: var(--muted); transform: translateY(-50%); }
  .landing-card:hover {
    transform: none;
    box-shadow: var(--elev-1);
    border-color: var(--border);
...
@media (max-width: 560px) {
  ...
  .landing-hero-sub { font-size: 11px; }
  .landing-quick { gap: 6px; }
  .landing-quick-card { padding: 9px 28px 9px 10px; }
  .landing-quick-card > b { font-size: 11px; }
  .landing-quick-card > small { font-size: 8.5px; }
  .landing-quick-card > em { right: 9px; }
  .landing-pulse { flex-wrap: nowrap; margin-inline: calc(var(--s-3) * -1); padding-inline: var(--s-3); overflow-x: auto; overscroll-behavior-inline: contain; scrollbar-width: none; }
  .landing-pulse::-webkit-scrollbar { display: none; }
  .pulse-item { flex: 0 0 auto; scroll-snap-align: start; }
  ...
  .landing-card-eyebrow { font-size: 10.5px; letter-spacing: .06em; }
  .landing-card-arrow { font-size: 14px; }
  .landing-card-stat { font-size: 24px; overflow-wrap: anywhere; }
  .landing-card-sub { font-size: 8px; line-height: 1.25; letter-spacing: .07em; }
  .landing-card-desc { display: none; }
  .landing-card-head { margin-bottom: 0; }
  .landing-card::after { left: 10px; right: 10px; bottom: 8px; }
...
@media (max-width: 340px) {
  .landing-quick, .landing-grid { grid-template-columns: minmax(0, 1fr); }
}
...
.overnight-decision{margin-top:.25rem;}
...
.ovn-desk{display:flex;flex-direction:column;gap:.65rem;margin-bottom:.8rem;padding:.8rem;border:1px solid color-mix(in srgb,var(--accent) 28%,var(--border));border-radius:12px;background:linear-gradient(135deg,color-mix(in srgb,var(--accent) 5%,var(--surface)),var(--surface) 60%);}
.ovn-desk-head{display:flex;align-items:flex-end;justify-content:space-between;gap:1rem;}
.ovn-desk-head>div{min-width:0;}
.ovn-desk-kicker{font:700 .62rem/1 var(--font-mono);letter-spacing:.1em;text-transform:uppercase;color:var(--accent-strong);}
.ovn-desk-head h3{margin:.2rem 0 0;font:750 1rem/1.25 var(--font-sans);color:var(--text-strong);}
.ovn-desk-head>small{font:.68rem/1.3 var(--font-sans);color:var(--muted);text-align:right;}
.ovn-desk-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(210px,1fr));gap:.5rem;}
.ovn-driver{display:flex;flex-direction:column;gap:.35rem;min-width:0;padding:.65rem;border:1px solid var(--border);border-left:3px solid var(--border-strong);border-radius:9px;background:var(--surface-2);}
.ovn-driver.ovn-up{border-left-color:var(--pos);}
.ovn-driver.ovn-dn{border-left-color:var(--neg);}
.ovn-driver-top{display:flex;align-items:center;justify-content:space-between;gap:.4rem;font:700 .62rem/1 var(--font-mono);letter-spacing:.07em;text-transform:uppercase;color:var(--muted);}
.ovn-driver-main{display:flex;align-items:baseline;justify-content:space-between;gap:.6rem;}
.ovn-driver-main b{min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font:700 .84rem/1.25 var(--font-sans);color:var(--text-strong);}
.ovn-driver-main strong{flex:none;font:750 .83rem/1 var(--font-mono);font-variant-numeric:tabular-nums;}
.ovn-driver.ovn-up .ovn-driver-main strong{color:var(--pos);}
.ovn-driver.ovn-dn .ovn-driver-main strong{color:var(--neg);}
.ovn-driver-type-rate{border-left-color:var(--warn) !important;}
.ovn-driver-type-rate .ovn-driver-main strong{color:var(--warn) !important;}
.ovn-driver-type-vol.ovn-up{border-left-color:var(--neg) !important;}
.ovn-driver-type-vol.ovn-up .ovn-driver-main strong{color:var(--neg) !important;}
.ovn-driver-meta{display:flex;flex-wrap:wrap;gap:.25rem .55rem;font:.68rem/1.3 var(--font-sans);color:var(--muted-strong);}
.ovn-driver-watch{display:flex;align-items:center;flex-wrap:wrap;gap:.28rem;margin-top:auto;padding-top:.25rem;border-top:1px solid var(--hairline);}
.ovn-driver-watch>span{font:700 .56rem/1 var(--font-mono);letter-spacing:.07em;text-transform:uppercase;color:var(--muted);}
.ovn-driver-watch button{appearance:none;border:1px solid var(--border-strong);border-radius:999px;background:var(--surface);padding:.14rem .38rem;font:700 .64rem/1 var(--font-mono);color:var(--text);cursor:pointer;}
.ovn-driver-watch button:hover,.ovn-driver-watch button:focus-visible{border-color:var(--accent);color:var(--accent);}
.ovn-driver-context{opacity:.72;}
.ovn-region-list{display:flex;flex-direction:column;gap:.5rem;}
.ovn-region{border:1px solid var(--border);border-radius:10px;background:var(--surface-2);overflow:clip;}
.ovn-region[open]{border-color:color-mix(in srgb,var(--accent) 28%,var(--border));}
.ovn-region>summary{min-height:48px;display:flex;align-items:center;justify-content:space-between;gap:.8rem;padding:.5rem .7rem;list-style:none;cursor:pointer;}
.ovn-region>summary::-webkit-details-marker{display:none;}
.ovn-region>summary::before{content:'›';flex:none;color:var(--accent);font-size:1.05rem;line-height:1;transition:transform var(--dur-1);}
.ovn-region[open]>summary::before{transform:rotate(90deg);}
.ovn-region>summary>span:first-of-type{display:flex;flex-direction:column;gap:.15rem;min-width:0;flex:1;}
.ovn-region>summary b{font:700 .76rem/1.15 var(--font-mono);letter-spacing:.06em;text-transform:uppercase;color:var(--text-strong);}
.ovn-region>summary small{font:.66rem/1.2 var(--font-sans);color:var(--muted);}
.ovn-region-lead{display:flex;align-items:baseline;justify-content:flex-end;gap:.45rem;min-width:0;}
.ovn-region-lead em{max-width:180px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font:500 .72rem/1.2 var(--font-sans);font-style:normal;color:var(--muted-strong);}
.ovn-region-lead strong{flex:none;font:700 .74rem/1 var(--font-mono);font-variant-numeric:tabular-nums;color:var(--muted-strong);}
.ovn-region-lead strong.ovn-up{color:var(--pos);}
.ovn-region-lead strong.ovn-dn{color:var(--neg);}
.ovn-region-body{padding:.6rem;border-top:1px solid var(--hairline);background:var(--surface);}
...
@media (max-width: 640px){
  .overnight-broad{flex-wrap:nowrap;overflow-x:auto;scrollbar-width:none;padding-bottom:.15rem;margin-bottom:.7rem;}
  .overnight-broad::-webkit-scrollbar{display:none;}
  .ovn-keylvl-lbl,.ovn-chip{flex:0 0 auto;}
  .ovn-desk{padding:.65rem;}
  .ovn-desk-head{align-items:flex-start;}
  .ovn-desk-head>small{max-width:118px;}
  .ovn-desk-grid{display:flex;overflow-x:auto;scroll-snap-type:x proximity;scrollbar-width:none;padding-bottom:.15rem;}
  .ovn-desk-grid::-webkit-scrollbar{display:none;}
  .ovn-driver{flex:0 0 min(252px,78vw);scroll-snap-align:start;}
  .ovn-region>summary{align-items:flex-start;gap:.45rem;padding:.55rem .6rem;}
  .ovn-region-lead{max-width:47%;flex-direction:column;align-items:flex-end;gap:.2rem;}
  .ovn-region-lead em{max-width:145px;}
...
[data-cr]{ cursor: crosshair; touch-action: pan-y; }
.is-range-comparing .opt-pc-hover,
.is-range-comparing .opt-pc-tip,
.is-range-comparing .opt-fund-eh-cross,
.is-range-comparing .opt-fund-eh-crossdot,
.is-range-comparing .opt-fund-eh-readout,
.is-range-comparing .fng-spark-cursor,
.is-range-comparing .fng-spark-dot,
.is-range-comparing .fng-spark-tip,
.is-range-comparing .cmp-chart-cross,
.is-range-comparing .cmp-chart-dot { display: none !important; }
.ch-line{
...
.ch-range-band[hidden], .ch-range-tip[hidden] { display: none; }
.ch-range-tip {
  position: fixed;
  z-index: 963;
  min-width: 220px;
...
.ch-range-head span:last-child { text-align: right; }
.ch-range-head i { color: var(--muted); font-style: normal; font-weight: 500; }
.ch-range-guide { color: var(--muted-strong); font-family: var(--font-sans); font-weight: 600; }
.ch-range-row {
  display: grid;
...
.ch-range-row b { overflow: hidden; color: var(--text-strong); text-overflow: ellipsis; white-space: nowrap; }
.ch-range-row span { color: var(--muted); text-align: right; white-space: nowrap; }
.ch-range-row strong { min-width: 58px; text-align: right; }
.ch-range-row strong.is-up { color: var(--pos); }
.ch-range-row strong.is-down { color: var(--neg); }
.ch-range-row strong.is-flat { color: var(--muted); }
@media (max-width: 640px) {
  .ch-range-tip { max-height: 44vh; overflow: hidden; }
