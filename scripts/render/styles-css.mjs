...
.fng-decision {
  ...
  padding: var(--s-4);
  border: 1px solid var(--border);
  border-left: 3px solid var(--fng-neutral);
  border-radius: var(--r-4);
  background:
    linear-gradient(135deg, color-mix(in srgb, var(--fng-neutral) 7%, transparent), transparent 58%),
    var(--surface-2);
}
.fng-decision.fng-band-extreme-fear { border-left-color: var(--fng-extreme-fear); }
.fng-decision.fng-band-fear { border-left-color: var(--fng-fear); }
.fng-decision.fng-band-greed { border-left-color: var(--fng-greed); }
.fng-decision.fng-band-extreme-greed { border-left-color: var(--fng-extreme-greed); }
.fng-decision-lead {
  display: grid;
