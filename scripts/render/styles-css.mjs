...
.ers-chip-warn { color: var(--warn, #d97706); background: color-mix(in srgb, var(--warn, #d97706) 14%, transparent); }
.ers-ai {
...
.ecl-chip-warn { color: var(--warn, #d97706); background: color-mix(in srgb, var(--warn, #d97706) 14%, transparent); }
.ecl-sym {
