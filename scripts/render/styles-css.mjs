...
:root {
  /* "Midnight desk" — a deep, slightly cool ink that reads warm next to
     the parchment-amber accent. Drops the trader-charcoal + neon-mint
     pairing for something that feels closer to a printed financial weekly
     read late at night than a SaaS template. */
  --bg:#0b0e14;
  --surface:#141821;
  --surface-2:#1c212c;
  --surface-3:#252b38;
  ...
  --muted:#7c8294;
  --muted-strong:#9ba0b0;
  /* Brand accent — warm parchment amber. Used for active states, focus
     rings, eyebrows and chrome highlights. P&L stays green/red below
     (see --pos / --neg) so traders read direction at a glance. */
  --accent:#c89968;
  --accent-soft:rgba(200,153,104,0.10);
  --accent-strong:#deb37e;
  --accent-glow:rgba(200,153,104,0.28);
  --accent-glow-soft:rgba(200,153,104,0.14);
  --accent-tint-1:rgba(200,153,104,0.06);
  --accent-tint-2:rgba(200,153,104,0.12);
  --pos:#1ec773;
  ...
  /* Editorial serif — used for card titles, hero headlines and the big
     numbers on the landing cards. The whole point is a typographic voice
     that breaks the SaaS-default Inter-everywhere look without sacrificing
     legibility on data screens. */
  --font-serif:"Fraunces", "Iowan Old Style", "Source Serif Pro", Georgia, "Times New Roman", serif;
...
:root[data-theme="light"] {
  /* "Morning desk" — a warm off-white that pairs with the same parchment
     amber as the dark theme. P&L colors keep their green/red so directional
     signal stays unmistakable. */
  --bg:#f4f1ea;
  --surface:#fbf9f4;
  --surface-2:#ece8de;
  --surface-3:#ddd7c7;
  ...
  --muted-strong:#4d4839;
  --accent:#a26a2a;
  --accent-soft:rgba(162,106,42,0.10);
  --accent-strong:#8a571f;
  --accent-glow:rgba(162,106,42,0.22);
  --accent-glow-soft:rgba(162,106,42,0.10);
  --accent-tint-1:rgba(162,106,42,0.05);
  --accent-tint-2:rgba(162,106,42,0.10);
  --pos:#0f9d58;
...
.strat-leg-side button.is-on[data-leg-val="buy"]  { background: var(--pos); color: #0b0d12; }
.strat-leg-side button.is-on[data-leg-val="sell"] { background: var(--neg); color: #fff; }
.strat-leg-type button.is-on { background: var(--accent); color: #0b0d12; }
.strat-leg-field {
  display: flex;
  flex-direction: column;
  gap: 4px;
