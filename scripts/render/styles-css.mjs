...
.cx-desk-lens > div { min-width: 0; display: flex; align-items: center; gap: 8px; padding: 8px 10px; border: 1px solid var(--hairline); border-radius: var(--r-2); background: var(--surface); }
.cx-desk-lens > div > span { flex: 1 1 auto; color: var(--muted); font: 650 10px/1.2 var(--font-sans); }
.cx-desk-lens b { display: flex; flex-wrap: wrap; justify-content: flex-end; gap: 4px; }
