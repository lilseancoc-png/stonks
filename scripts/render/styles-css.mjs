...
.oi-cell-strike { font-weight: 500; }
.oi-cell-delta.is-up { color: var(--up); }
.oi-cell-delta.is-dn { color: var(--dn); }
.oi-delta-abs { color: var(--text-3); font-size: 0.9em; }
.oi-dte { color: var(--text-3); font-size: 0.85em; }
