...
// serve to anyone; a handful of premium tabs (Top Picks, Briefs, Trending IV,
// Streaks, Unusual Flow, Volume, Gamma Exposure) are gated behind a valid
// session and so are the data files that back them.
...
//   briefs, iv-trending, streaks, unusual*, volume-flags/-history,
