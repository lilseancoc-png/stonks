...
// Rotation, Briefs, Earnings Tracker, Trending IV, Streaks, Unusual Flow,
// Volume, Gamma Exposure) are gated behind a valid session and so are the data
...
const ROLE_RESTRICTED_KEYS = new Map([
  ...
  ["day-trading.json", ["tr", "tp"]],
  ["day-trading-history.json", ["tr", "tp"]],
]);
